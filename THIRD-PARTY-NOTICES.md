...
| [`bzip2`](https://crates.io/crates/bzip2) (+ vendored libbz2) | multi-stream bzip2 decode of the CEF `.tar.bz2` (C source vendored + compiled; no system lib) | MIT OR Apache-2.0 (wrapper) / bzip2 license (BSD-style, libbz2) |
