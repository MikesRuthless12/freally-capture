...
if (!uiOnly && hasRust) {
  ...
  // cargo-audit runs in CI with two justified RustSec ignores (see deny.toml).
  if (have("cargo audit --version")) {
    step("rust: cargo-audit", "cargo audit --ignore RUSTSEC-2026-0194 --ignore RUSTSEC-2026-0195", repoRoot);
  } else {
