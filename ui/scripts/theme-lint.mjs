 ...
 *
 * The studio is drawn with translucent *white* over near-black — `bg-white/10`,
 ...
 *      at a glance.
 *
 * Modelled on `i18n-lint.mjs`: plain Node, no dependencies, run in CI.
 */
 ...
 */
const ON_DARK = {
  "bg-white/80": "the peak-hold tick, drawn over the meter's own bg-black/50 track",
};
