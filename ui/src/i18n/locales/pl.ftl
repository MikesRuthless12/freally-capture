...
hotkeys-timer-toggle-placeholder = np. Ctrl+Shift+T
hotkeys-timer-reset = Reset wszystkich minutników
hotkeys-timer-reset-placeholder = np. Ctrl+Shift+0
...
controls-automation = Automatyzacja
...
hotkeys-split-placeholder = np. Numpad1
...
hotkeys-playlist-placeholder = np. Ctrl+Alt+Right
...
hotkeys-replay-roll-placeholder = np. Ctrl+Shift+I
