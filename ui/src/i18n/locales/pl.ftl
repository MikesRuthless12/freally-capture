...
sources-add-background-music = Muzyka w tle…
sources-background-music-note = Odtwarza w pętli, słyszalne w podglądzie i nagrywane/streamowane. Aby użyć muzyki zamiast dźwięku wideo, wycisz ścieżkę Backdrop wideo w mikserze.
sources-background-music-count = { $n } ścieżek
sources-background-music-shuffle = Losowo
...
sources-stream-hide = Ukryj w streamie
sources-stream-show = Pokaż w streamie
sources-stream-hide-item = Ukryj { $name } w streamie
sources-stream-show-item = Pokaż { $name } w streamie
sources-record-hide = Ukryj w nagraniu
sources-record-show = Pokaż w nagraniu
sources-record-hide-item = Ukryj { $name } w nagraniu
sources-record-show-item = Pokaż { $name } w nagraniu
...
sources-game-accept = Zaakceptuj ryzyko i wybierz grę
sources-game-pick = Wybierz okno gry do przechwycenia. Pozostaje podpięte tylko podczas grania.
...
stats-rehearsal-note = Próba — cele publikują tylko do lokalnego odbiornika
stats-timeline-open = Oś czasu
timeline-title = Oś czasu sesji
timeline-empty = Jeszcze nic nie zapisano — oś czasu rejestruje podczas streamu lub nagrywania.
timeline-live = NA ŻYWO — wciąż nagrywa
timeline-fit = Dopasuj
timeline-legend-fps = fps
timeline-legend-behind = kolejka enkodera (klatki opóźnienia)
...
scenes-recent-title = Ostatnie
scenes-recent-clear = Wyczyść
scenes-recent-clear-confirm = Wyczyścić listę ostatnich scen?
...
livebutton-rehearse = Próba
livebutton-rehearse-record-confirm = Nagrać tę próbę również do pliku wideo?
livebutton-rehearse-title = Przećwicz cały pokaz na lokalnym odbiorniku — nic nie jest wysyłane
livebutton-end-rehearsal = Zakończ próbę
livebutton-title-rehearsing = Trwa próba — nic nie opuszcza tego komputera
livebutton-badge-rehearsal = PRÓBA
livebutton-aria-rehearsal = Trwa próba
livebutton-rehearsal-banner = Próba — nic nie opuszcza tego komputera
...
properties-timer-clock = Odliczanie do godziny
...
filters-name-perspective = Perspektywa
filters-name-fade-loop = Pętla zanikania
...
filters-tilt = Pochylenie
filters-far-fade = Zanik dalekiej krawędzi
filters-fade-in-s = Pojawianie (s)
filters-visible-s = Widoczny (s)
filters-fade-out-s = Zanikanie (s)
filters-hidden-s = Ukryty (s)
...
bench-open = Uruchom benchmark enkoderów…
bench-title = Benchmark enkoderów
bench-intro = Uruchamia krótkie mierzone drabinki kodowania (każdy wykryty enkoder × preset × rozdzielczość) na tej maszynie — około minuty, całkowicie offline, nic nie opuszcza komputera. Niepowodzenia są wypisane, nigdy ukrywane. Najpierw zatrzymaj stream lub nagrywanie.
bench-start = Rozpocznij benchmark
bench-rerun = Uruchom ponownie
bench-running = Pomiar… { $done } / { $total }
bench-cancel = Anuluj
bench-col-encoder = Enkoder
bench-col-preset = Preset
bench-col-rung = Szczebel
bench-col-achieved = fps
bench-col-headroom = Zapas
bench-failed = niepowodzenie
bench-rec-title = Rekomendacja (zmierzona)
bench-rec-body = { $encoder } z { $preset }, { $width }×{ $height } @ { $fps } fps — zmierzono { $headroom }× czasu rzeczywistego. Sugerowany bitrate streamu: { $bitrate } kbps.
bench-rec-none = Nic nie utrzymuje czasu rzeczywistego na tej maszynie — obniż rozdzielczość canvasa lub fps i zmierz ponownie.
bench-apply = Zastosuj do ustawień nagrywania
bench-applied = Zastosowano ✓
...
stream-session-report = Po zakończeniu zapisz raport sesji (HTML + Markdown) obok nagrania
stream-simulator-title = Symulator sieci (próby)
stream-simulator-note = Kształtuje tylko lokalne odbiorniki próby — ćwiczy reconnecty i słabe łącza. Prawdziwe Go Live nigdy nie jest degradowane.
stream-simulator-profile = Profil
stream-simulator-off = Wyłączony
stream-simulator-hotel-wifi = Hotelowe Wi-Fi
stream-simulator-mobile-hotspot = Mobilny hotspot
stream-simulator-custom = Własny
stream-simulator-bandwidth = Przepustowość (kbps, 0 = bez limitu)
stream-simulator-latency = Opóźnienie (ms)
stream-simulator-jitter = Jitter (± ms)
stream-simulator-outage-every = Awaria co (s, 0 = nigdy)
stream-simulator-outage-len = Długość awarii (s)
...
workspace-pack-title = Pakiet kolekcji scen
workspace-pack-export = Eksportuj pakiet…
workspace-pack-exporting = Eksportowanie…
workspace-pack-import = Importuj pakiet…
workspace-pack-importing = Importowanie…
workspace-pack-hint = Plik .fcappack pakuje aktywną kolekcję wraz z jej lokalnymi zasobami w jeden przenośny plik — udostępnij cały układ, bez serwera. Import wczytuje go jako nową kolekcję i przełącza się na nią.
workspace-pack-exported = Wyeksportowano „{ $name }” — spakowano zasoby: { $bundled }, zewnętrzne: { $external }.
workspace-pack-imported = Zaimportowano „{ $name }” — sceny: { $scenes }, ponownie połączone zasoby: { $relinked }, zewnętrzne: { $external }.
workspace-compare = Porównaj i scal…
compare-title = Porównaj i scal
compare-intro = Porównaj aktywną kolekcję z inną i pobierz tylko wybrane zmiany. Nic nie opuszcza tego komputera.
compare-target-label = Porównaj z
compare-target-none = Wybierz kolekcję…
compare-target-pack = Z pliku pakietu…
compare-against = vs { $name }
compare-comparing = Porównywanie…
compare-no-diff = Brak różnic — kolekcje są zgodne.
compare-select-all = Zaznacz wszystko
compare-clear = Wyczyść
compare-merge-hint = Wybranie sceny pobiera też używane przez nią źródła.
compare-sources-title = Źródła
compare-scenes-title = Sceny
compare-kind-added = Dodano
compare-kind-removed = Usunięto
compare-kind-modified = Zmieniono
compare-renamed = było „{ $from }”
compare-reordered = zmieniono kolejność
compare-apply = Zastosuj { $count }
compare-apply-none = Wybierz zmiany do zastosowania
compare-applying = Stosowanie…
compare-aspect-source = źródło
compare-aspect-transform = pozycja
compare-aspect-visibility = widoczność
compare-aspect-outputs = wyjścia
compare-aspect-filters = filtry
compare-aspect-lock = blokada
compare-aspect-blend = mieszanie
compare-aspect-scaling = skalowanie
compare-aspect-backdrop = tło
compare-aspect-reveal = odsłonięcie
compare-aspect-name = nazwa
compare-aspect-settings = ustawienia
compare-aspect-audio = dźwięk
workspace-snapshots = Migawki…
snapshots-title = Migawki
snapshots-intro = Nazwane punkty kontrolne tej kolekcji, do których możesz wrócić — zachowywane celowo, poza autozapisem i cofaniem. Przechowywane lokalnie.
snapshots-name-placeholder = Nazwij ten punkt kontrolny…
snapshots-create = Zapisz migawkę
snapshots-empty = Brak migawek — zapisz jedną, aby zachować nazwany punkt kontrolny, do którego możesz wrócić.
snapshots-usage = { $count } z { $cap } zachowanych · { $size }
snapshots-scenes = sceny: { $scenes } · źródła: { $sources }
snapshots-restore = Przywróć
snapshots-compare = Porównaj
snapshots-delete = Usuń migawkę
snapshots-delete-aria = Usuń migawkę „{ $name }"
snapshots-restore-confirm = Przywrócić tę migawkę? Bieżący układ zostanie najpierw zapisany jako migawka.

# --- Phase 8 (backup / theme editor / dock presets / settings search / quick actions) ---
workspace-backup = Kopia zapasowa i przywracanie…
backup-title = Kopia zapasowa i przywracanie
backup-intro = Zapisz całe swoje studio — ustawienia, profile, kolekcje scen — do jednego pliku i przywróć je tutaj lub na nowym komputerze.
backup-export = Eksportuj kopię zapasową…
backup-exporting = Eksportowanie…
backup-exported = Utworzono kopię { $collections } kolekcji i { $profiles } profili ({ $size }).
backup-restore = Przywróć z kopii zapasowej…
backup-secrets-note = Klucze transmisji i hasła nigdy nie są zawarte w kopii zapasowej — wprowadź je ponownie po przywróceniu.
backup-restore-from = Kopia zapasowa utworzona { $created } (v{ $version })
backup-restore-settings = Ustawienia
backup-restore-collections = Kolekcje scen ({ $count })
backup-restore-profiles = Profile ({ $count })
backup-restore-apply = Przywróć wybrane
backup-restoring = Przywracanie…
backup-restored = Przywrócono.
backup-restart-note = Uruchom ponownie Freally Capture, aby wczytać przywrócone kolekcje i profile.
backup-cancel = Anuluj
theme-editor-title = Paleta niestandardowa
theme-color-bg = Tło
theme-color-panel = Panel
theme-color-text = Tekst
theme-color-muted = Przygaszony
theme-color-accent = Akcent
theme-color-accent2 = Akcent 2
theme-contrast-text-bg = Tekst na tle
theme-contrast-text-panel = Tekst na panelu
theme-contrast-muted-bg = Przygaszony na tle
theme-contrast-accent-bg = Akcent na tle
theme-contrast-low = (celuj w ≥ { $min }:1)
theme-reset = Przywróć ciemny
theme-export = Eksportuj .fctheme…
theme-import = Importuj .fctheme…
workspace-dock-presets = Układy doków
workspace-dock-preset-placeholder = Zapisz bieżący układ jako…
workspace-dock-preset-save = Zapisz
workspace-dock-preset-apply = Przełącz na „{ $name }”
workspace-dock-preset-delete = Usuń układ „{ $name }”
workspace-dock-presets-hint = Układ zapamiętuje dok statystyk i orientację miksera. Kliknij dowolny, aby się na niego przełączyć.
...
menu-tools-quick-actions = Szybkie akcje…
menu-tools-featured-chat = Wyróżniona wiadomość czatu…
quick-actions-title = Szybkie akcje
quick-actions-empty = Brak przycisków — kliknij Edytuj, aby dodać.
quick-actions-edit = Edytuj
quick-actions-done = Gotowe
quick-actions-add-page = Strona
quick-actions-label = Etykieta przycisku
quick-actions-color = Kolor przycisku
quick-actions-add = Dodaj przycisk
quick-actions-remove = Usuń „{ $name }”
quick-actions-delete-page = Usuń „{ $name }”
quick-actions-hint = Przyciski wyzwalają te same polecenia studia co skróty klawiszowe i panel LAN — także sceny, makra i pady soundboardu. Przyciski poleceń są też widoczne na panelu LAN.
quick-actions-cmd-transition = Przejście
quick-actions-cmd-startStream = Rozpocznij transmisję
quick-actions-cmd-stopStream = Zakończ transmisję
quick-actions-cmd-startRecording = Rozpocznij nagrywanie
quick-actions-cmd-stopRecording = Zatrzymaj nagrywanie
quick-actions-cmd-pauseRecording = Wstrzymaj nagrywanie
quick-actions-cmd-addMarker = Dodaj znacznik
quick-actions-cmd-armReplay = Uzbrój powtórkę
quick-actions-cmd-saveReplay = Zapisz powtórkę
quick-actions-cmd-setStudioMode = Przełącz tryb studyjny
quick-actions-cmd-scene = Przełącz na scenę…
quick-actions-cmd-macro = Uruchom makro…
quick-actions-cmd-soundboard = Pad soundboardu…
quick-actions-value-scene = Nazwa sceny
quick-actions-value-macro = Nazwa makra
quick-actions-value-soundboard = Identyfikator padu
teleprompter-stop = Zatrzymaj
about-portable-on = Tryb przenośny: włączony — wszystkie dane aplikacji są przechowywane obok aplikacji.
about-portable-off = Tryb przenośny: wyłączony. Dodaj plik „{ $marker }" obok aplikacji, aby uruchamiać ją w pełni samodzielnie (tryb pendrive'a USB).
about-portable-data = Folder danych: { $path }
...
history-toggleOutputVisibility = Przełącz widoczność wyjścia
...
palette-featured-chat = Wyróżniona wiadomość czatu…
featured-chat-title = Wyróżniona wiadomość czatu
featured-chat-intro = Przypnij dowolną niedawną wiadomość czatu jako baner na dole programu — widzowie streamu i nagrania go zobaczą. Przypięcie znika po restarcie; kolory zostają.
featured-chat-empty = Jeszcze brak czatu — dodaj źródło nakładki czatu i wskaż swój kanał; wiersze pojawią się tutaj po nadejściu.
featured-chat-pinned = W programie:
featured-chat-pin = Wyróżnij
featured-chat-clear = Usuń
featured-chat-bg = Kolor banera
featured-chat-text = Kolor tekstu
featured-chat-note = Baner znajduje się na dole pośrodku, ponad każdą sceną — usuń go, aby zdjąć z anteny.
...
sources-visualizer-classic = Klasyczne kolory
...
menu-collection-clear = Wyczyść historię…
menu-collection-clear-confirm = Trwale usunąć te kolekcje scen i ich pliki? { $names } — aktywna kolekcja „{ $active }" zostaje zachowana. Tej operacji nie można cofnąć.
...
telestrator-draw = Rysuj
telestrator-tool-pen = Pióro
telestrator-tool-highlight = Zakreślacz
telestrator-tool-arrow = Strzałka
telestrator-tool-ellipse = Elipsa
telestrator-color = Kolor
telestrator-width = Grubość
telestrator-whiteboard = Tryb tablicy
telestrator-persist = Zachowaj
telestrator-fade = Zanikanie
telestrator-undo = Cofnij ostatni znak
telestrator-clear = Wyczyść znaki
hotkeys-telestrator-clear = Telestrator: wyczyść znaki

# --- Teleprompter (CAP-N58) ---
teleprompter-title = Teleprompter
teleprompter-loading = Ładowanie…
teleprompter-empty = Brak scenariusza — dodaj go w panelu telepromptera.
teleprompter-script = Scenariusz
teleprompter-script-placeholder = Wpisz lub wklej scenariusz…
teleprompter-top = Początek
teleprompter-slower = Wolniej
teleprompter-play = Odtwórz
teleprompter-pause = Pauza
teleprompter-faster = Szybciej
teleprompter-step-back = Krok wstecz
teleprompter-step-forward = Krok naprzód
teleprompter-est-time = Czas czytania
teleprompter-caesura-hint = Wpisz --, aby dodać pauzę
teleprompter-caesura-pause = Pauza cezury — Wpisz --, aby dodać pauzę
teleprompter-countdown = Rozpocznij odliczanie
teleprompter-countdown-secs = Odliczanie (sekundy)
teleprompter-speed = Prędkość (znaki/s)
teleprompter-speed-bpm = Prędkość (BPM)
teleprompter-bpm-mode = Tryb BPM (śpiew)
teleprompter-font = Rozmiar czcionki
teleprompter-mirror = Lustro (szkło)
teleprompter-open-projector = Otwórz projektor
teleprompter-preview = Podgląd
teleprompter-remote-hint = Steruj przewijaniem skrótem, MIDI lub panelem LAN, gdy to okno jest zamknięte.
teleprompter-read-aloud = Czytaj na głos, używając syntezy mowy systemu
menu-tools-teleprompter = Teleprompter
hotkeys-teleprompter-toggle = Teleprompter: odtwórz / pauza

# --- Remote guests: green room / cues / QoS / auto-grid (CAP-N54–N56, N59) ---
remote-hosting-count = Hostowanie { $count } gościa/gości
remote-green-room-default = Poczekalnia
remote-green-room-default-title = Nowi goście czekają w poczekalni, aż ich posadzisz
remote-auto-grid = Auto-siatka
remote-auto-grid-title = Utrzymuj gości w siatce, gdy dołączają i wychodzą
remote-arrange-grid = Ułóż siatkę
remote-arrange-grid-title = Ułóż teraz posadzonych gości w siatkę
remote-green-room-monitor = Podgląd poczekalni
remote-tech-cam-ok = Kamera ✓
remote-tech-cam-no = Brak kamery
remote-tech-mic-ok = Mikrofon ✓
remote-tech-mic-no = Brak mikrofonu
remote-seat-on-air = Na antenę
remote-cues-label = Sygnały
remote-cue = Sygnał
remote-cue-thirty = 30 sekund
remote-cue-wrap = Kończ
remote-cue-next = Zaraz twoja kolej
remote-cue-speak = Mów głośniej
remote-qos-good = Połączenie dobre
remote-qos-fair = Połączenie średnie
remote-qos-poor = Połączenie słabe
remote-green-room-guest = Jesteś w poczekalni — gospodarz zaraz wpuści cię na antenę.

# --- Hotkey audit — Phase 7 actions ---
hotkey-audit-action-telestrator-clear = Telestrator: wyczyść znaki
hotkey-audit-action-teleprompter-toggle = Teleprompter: odtwórz / pauza
...
sources-add-starting-soon = Wkrótce zaczynamy…
sources-starting-soon-title = Wkrótce zaczynamy
sources-starting-soon-default = Wkrótce zaczynamy
sources-starting-soon-message = Wiadomość
sources-starting-soon-minutes = Minuty
sources-starting-soon-hours = Godziny
sources-starting-soon-start-at = Start o
sources-starting-soon-music = Muzyka w tle…
sources-starting-soon-music-name = Muzyka w tle
sources-starting-soon-background = Tło
sources-starting-soon-note = Pełnoekranowe odliczanie, które po dojściu do zera miga na czerwono i zatrzymuje się — wyczyść je i ręcznie przełącz na scenę na żywo, gdy będziesz gotowy.
sources-starting-soon-add = Dodaj
sources-slate-solid = Kolor jednolity
sources-slate-gradient = Gradient
sources-slate-transparent = Przezroczysty
sources-slate-image = Obraz
sources-slate-file = Obraz / Wideo / GIF
sources-slate-browse = Przeglądaj…
sources-starting-soon-choose-image = Wybierz obraz…
sources-slate-media-note = Obrazy statyczne są osadzane tutaj. Aby użyć zapętlonego wideo lub GIF-a jako tła, wybierz „Przezroczysty" i ustaw tło sceny (🖼 na pasku scen) — odliczanie jest na wierzchu.
properties-timer-slate = Plansza „Wkrótce zaczynamy”
properties-timer-slate-off = Wył. (tekst w wierszu)
properties-timer-message = Wiadomość
properties-timer-slate-color = Kolor planszy
properties-timer-slate-from = Od
properties-timer-slate-to = Do
properties-timer-slate-note = Przezroczystość pozwala prześwitywać obrazowi, wideo lub tłu sceny pod planszą.
...
sources-browser-component-missing = Wymaga komponentu Browser Runtime — zainstaluj go w Narzędzia → Komponenty.
