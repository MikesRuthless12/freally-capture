...
hotkeys-panic-placeholder = z. B. Ctrl+Shift+F12
hotkeys-timer-toggle = Alle Timer starten/pausieren
hotkeys-timer-toggle-placeholder = z. B. Ctrl+Shift+T
hotkeys-timer-reset = Alle Timer zurücksetzen
hotkeys-timer-reset-placeholder = z. B. Ctrl+Shift+0
...
controls-automation = Automatisierung
...
hotkeys-split-placeholder = z. B. Numpad1
...
hotkeys-playlist-placeholder = z. B. Ctrl+Alt+Right
...
hotkeys-replay-roll-placeholder = z. B. Ctrl+Shift+I
