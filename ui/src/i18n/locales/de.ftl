...
sources-add-background-music = Hintergrundmusik …
sources-background-music-note = Läuft in Schleife, in der Vorschau hörbar und in Aufnahme/Stream. Um Musik statt Videoton zu nutzen, schalte den Backdrop-Kanal des Videos stumm.
sources-background-music-count = { $n } Titel
sources-background-music-shuffle = Zufällig
...
sources-stream-hide = Im Stream ausblenden
sources-stream-show = Im Stream einblenden
sources-stream-hide-item = { $name } im Stream ausblenden
sources-stream-show-item = { $name } im Stream einblenden
sources-record-hide = In der Aufnahme ausblenden
sources-record-show = In der Aufnahme einblenden
sources-record-hide-item = { $name } in der Aufnahme ausblenden
sources-record-show-item = { $name } in der Aufnahme einblenden
...
controls-iso-lanes = ISO-Spuren, die neben dem Programm aufnehmen: { $count }
...
ltc-intro = Erzeuge linearen SMPTE-Timecode auf einer Spur und lies eingehenden LTC von jedem Audioeingang — klassischer Audio-Timecode zur Synchronisation externer Recorder und Kameras in der Post. Vollständig offline.
ltc-generate = LTC auf eine Spur erzeugen
ltc-track = Timecode-Spur
ltc-track-option = Spur { $track }
ltc-fps = Bildrate
ltc-read = LTC lesen von
ltc-read-off = Aus
ltc-decoded = Eingehender Timecode
ltc-no-lock = kein Signal
ltc-note = Der Generator synchronisiert sich auf die Tageszeit, non-drop. Nimm seine Spur auf (in den Ausgabeeinstellungen zuweisen) oder route sie auf einen Ausgang für externes Gerät. Der Leser speist die Timecode-Zeile im Statistik-Overlay und stempelt Kapitelmarken.
...
stats-rehearsal-note = Probe — Ziele senden nur an eine lokale Senke
stats-timeline-open = Zeitleiste
timeline-title = Sitzungs-Zeitleiste
timeline-empty = Noch nichts aufgezeichnet — die Zeitleiste läuft, während du streamst oder aufnimmst.
timeline-live = LIVE — zeichnet noch auf
timeline-fit = Einpassen
timeline-legend-fps = fps
timeline-legend-behind = Encoder-Warteschlange (Frames Rückstand)
...
scenes-recent-title = Zuletzt
scenes-recent-clear = Leeren
scenes-recent-clear-confirm = Liste der letzten Szenen leeren?
...
livebutton-rehearse = Probe starten
livebutton-rehearse-record-confirm = Diese Probe auch als Videodatei aufnehmen?
livebutton-rehearse-title = Die ganze Show gegen eine lokale Senke fahren — nichts wird gesendet
livebutton-end-rehearsal = Probe beenden
livebutton-title-rehearsing = Eine Probe läuft — nichts verlässt diesen Rechner
livebutton-badge-rehearsal = PROBE
livebutton-aria-rehearsal = Probe läuft
livebutton-rehearsal-banner = Probe — nichts verlässt diesen Rechner
...
properties-timer-clock = Auf eine Uhrzeit herunterzählen
...
filters-name-perspective = Perspektive
filters-name-fade-loop = Blendschleife
...
filters-tilt = Neigung
filters-far-fade = Ausblenden zur Ferne
filters-fade-in-s = Einblenden (s)
filters-visible-s = Sichtbar (s)
filters-fade-out-s = Ausblenden (s)
filters-hidden-s = Verborgen (s)
...
recordings-trim = Trimmen
recordings-trim-title = Einen Clip aus dieser Aufnahme schneiden — Keyframe-genaue Schnitte exportieren ohne Neukodierung
recordings-verify = Prüfen
recordings-verify-title = Integrität der Datei prüfen — Containerstruktur, Kontinuität, A/V-Interleaving, Dauer
recordings-verifying = Wird geprüft…
verify-dismiss = Schließen
verify-verdict-pass = { $name } — Integrität in Ordnung
verify-verdict-warn = { $name } — geprüft, mit Warnungen
verify-verdict-fail = { $name } — Probleme gefunden
verify-container = Container
verify-video-continuity = Video-Kontinuität
verify-audio-continuity = Audio-Kontinuität
verify-av-interleave = A/V-Interleaving
verify-duration = Dauer
recordings-alpha-label = Alpha
recordings-prores-title = Alpha-erhaltendes ProRes-4444-.mov-Master exportieren (für den Schnitt)
recordings-qtrle-title = Alpha-erhaltendes QuickTime-Animation-.mov exportieren (maximale Kompatibilität)
trim-title = Trimmen — { $name }
trim-loading = Datei wird gelesen…
trim-preview-alt = Vorschaubild
trim-position = Wiedergabeposition
trim-step-second-back = Eine Sekunde zurück
trim-step-frame-back = Ein Frame zurück
trim-step-frame-forward = Ein Frame vor
trim-step-second-forward = Eine Sekunde vor
trim-snap = Keyframe
trim-snap-title = Zum nächsten Keyframe springen — ein Schnitt dort exportiert ohne Neukodierung
trim-set-in = In-Punkt
trim-set-out = Out-Punkt
trim-range-invalid = Der Out-Punkt muss nach dem In-Punkt liegen.
trim-copy-badge = ✓ Export ohne Neukodierung — der In-Punkt liegt auf einem Keyframe.
trim-reencode-badge = Wird neu kodiert: Der In-Punkt liegt zwischen Keyframes (mit „Keyframe" für einen verlustfreien Schnitt einrasten).
trim-export = Clip exportieren
trim-export-916 = 9:16
trim-export-916-title = Vertikal umrahmt exportieren (zentrierter Zuschnitt in der Größe der vertikalen Leinwand) — kodiert immer neu
...
bench-open = Encoder-Benchmark ausführen…
bench-title = Encoder-Benchmark
bench-intro = Fährt kurze gemessene Encode-Leitern (jeder erkannte Encoder × Preset × Auflösung) auf diesem Rechner — etwa eine Minute, komplett offline, nichts verlässt den Computer. Fehlschläge werden gelistet, nicht versteckt. Vorher Stream/Aufnahme beenden.
bench-start = Benchmark starten
bench-rerun = Erneut ausführen
bench-running = Messe… { $done } / { $total }
bench-cancel = Abbrechen
bench-col-encoder = Encoder
bench-col-preset = Preset
bench-col-rung = Stufe
bench-col-achieved = fps
bench-col-headroom = Reserve
bench-failed = fehlgeschlagen
bench-rec-title = Empfehlung (gemessen)
bench-rec-body = { $encoder } mit { $preset }, { $width }×{ $height } @ { $fps } fps — gemessen { $headroom }× Echtzeit. Empfohlene Stream-Bitrate: { $bitrate } kbps.
bench-rec-none = Nichts hält Echtzeit auf diesem Rechner durch — Canvas-Auflösung oder fps senken und erneut messen.
bench-apply = Auf Aufnahme-Einstellungen anwenden
bench-applied = Angewendet ✓
...
output-iso-heading = ISO-Aufnahme
output-iso-explainer = Ausgewählte Quellen sauber aufnehmen, jede in ihre eigene Datei neben dem Programm — vor dem Compositing, in Canvas-Größe und -Bildrate, sodass jede Datei ausgerichtet auf einer Schnitt-Timeline landet. Zwei Spuren sind auf einer Mittelklasse-GPU unproblematisch; jede weitere kostet einen zusätzlichen Render- und Encode-Durchlauf.
output-iso-none = Noch keine Quellen in der Sammlung.
output-iso-source-on = „{ $name }“ wird als eigene ISO-Datei aufgenommen — zum Beenden klicken
output-iso-source-off = „{ $name }“ als eigene ISO-Datei aufnehmen
output-iso-post-filter = Mit den Filtern der Quelle aufnehmen (Post-Filter); ohne Häkchen wird die rohe Quelle aufgenommen
...
output-split-on-rundown = Ablaufplan-Schritt
output-auto-markers = Kapitelmarker automatisch bei Studio-Ereignissen setzen (Szenenwechsel, Replay-Speicherung, Reconnect, verlorene Frames, Alarme, Regeln)
output-auto-markers-title = Typisierte Marker landen in den Kapiteln der Aufnahme (mkv) oder der .chapters.txt-Sidecar-Datei, neben dem manuellen Marker-Hotkey
output-pipeline-heading = Pipeline nach der Aufnahme
output-pipeline-explainer = Nach dem Finalisieren einer Aufnahme laufen diese Schritte der Reihe nach im Hintergrund auf der Hauptdatei. Ein geschlossener Aktionssatz — einen „Befehl ausführen"-Schritt gibt es bewusst nicht. Die Kette stoppt beim ersten Fehler.
output-pipeline-enabled = Pipeline nach jeder Aufnahme ausführen
output-pipeline-add = Schritt hinzufügen…
output-pipeline-up = Nach oben
output-pipeline-down = Nach unten
output-pipeline-remove = Schritt entfernen
output-pipeline-template = Umbenennungsvorlage (CAP-M25-Token)
output-pipeline-folder = Ordner
pipeline-queue = Pipeline nach der Aufnahme
pipeline-verify = Prüfen
pipeline-remux = Zu MP4 remuxen
pipeline-normalize = Lautheit normalisieren
pipeline-rename = Umbenennen
pipeline-move = In Ordner verschieben
pipeline-copy = In Ordner kopieren
pipeline-reveal = Im Dateimanager zeigen
pipeline-luaEvent = Lua-Skripte benachrichtigen
...
stream-session-report = Beim Sitzungsende einen Bericht (HTML + Markdown) neben der Aufnahme ablegen
stream-simulator-title = Netzwerk-Simulator (Proben)
stream-simulator-note = Formt nur die lokalen Senken der Probe — übt Reconnects und dünne Uplinks. Ein echtes Go Live wird nie beeinträchtigt.
stream-simulator-profile = Profil
stream-simulator-off = Aus
stream-simulator-hotel-wifi = Hotel-WLAN
stream-simulator-mobile-hotspot = Mobiler Hotspot
stream-simulator-custom = Benutzerdefiniert
stream-simulator-bandwidth = Bandbreite (kbps, 0 = unbegrenzt)
stream-simulator-latency = Latenz (ms)
stream-simulator-jitter = Jitter (± ms)
stream-simulator-outage-every = Ausfall alle (s, 0 = nie)
stream-simulator-outage-len = Ausfalldauer (s)
...
workspace-pack-title = Szenensammlungs-Paket
workspace-pack-export = Paket exportieren…
workspace-pack-exporting = Exportiere…
workspace-pack-import = Paket importieren…
workspace-pack-importing = Importiere…
workspace-pack-hint = Ein .fcappack bündelt die aktive Sammlung samt ihren lokalen Assets in eine einzige portable Datei — teile ein ganzes Layout, ohne Server. Der Import legt es als neue Sammlung an und wechselt dorthin.
workspace-pack-exported = „{ $name }“ exportiert — { $bundled } Asset(s) gebündelt, { $external } extern.
workspace-pack-imported = „{ $name }” importiert — { $scenes } Szene(n), { $relinked } Asset(s) neu verknüpft, { $external } extern.
workspace-compare = Vergleichen & zusammenführen…
compare-title = Vergleichen & zusammenführen
compare-intro = Vergleiche die aktive Sammlung mit einer anderen und übernimm nur die von dir ausgewählten Änderungen. Nichts verlässt diesen Rechner.
compare-target-label = Vergleichen mit
compare-target-none = Sammlung auswählen…
compare-target-pack = Aus einer Paketdatei…
compare-against = vs { $name }
compare-comparing = Wird verglichen…
compare-no-diff = Keine Unterschiede — die Sammlungen stimmen überein.
compare-select-all = Alle auswählen
compare-clear = Zurücksetzen
compare-merge-hint = Beim Auswählen einer Szene werden auch die von ihr genutzten Quellen übernommen.
compare-sources-title = Quellen
compare-scenes-title = Szenen
compare-kind-added = Hinzugefügt
compare-kind-removed = Entfernt
compare-kind-modified = Geändert
compare-renamed = war „{ $from }”
compare-reordered = neu gestapelt
compare-apply = { $count } übernehmen
compare-apply-none = Änderungen zum Übernehmen auswählen
compare-applying = Wird übernommen…
compare-aspect-source = Quelle
compare-aspect-transform = Position
compare-aspect-visibility = Sichtbarkeit
compare-aspect-outputs = Ausgaben
compare-aspect-filters = Filter
compare-aspect-lock = Sperre
compare-aspect-blend = Mischmodus
compare-aspect-scaling = Skalierung
compare-aspect-backdrop = Hintergrund
compare-aspect-reveal = Einblendung
compare-aspect-name = Name
compare-aspect-settings = Einstellungen
compare-aspect-audio = Audio
workspace-snapshots = Snapshots…
snapshots-title = Snapshots
snapshots-intro = Benannte Speicherpunkte dieser Sammlung, zu denen du zurückkehren kannst — absichtlich aufbewahrt, über Autospeichern und Rückgängig hinaus. Lokal gespeichert.
snapshots-name-placeholder = Diesen Speicherpunkt benennen…
snapshots-create = Snapshot speichern
snapshots-empty = Noch keine Snapshots — speichere einen, um einen benannten Speicherpunkt zu behalten, zu dem du zurückkehren kannst.
snapshots-usage = { $count } von { $cap } behalten · { $size }
snapshots-scenes = { $scenes } Szenen · { $sources } Quellen
snapshots-restore = Wiederherstellen
snapshots-compare = Vergleichen
snapshots-delete = Snapshot löschen
snapshots-delete-aria = Snapshot „{ $name }" löschen
snapshots-restore-confirm = Diesen Snapshot wiederherstellen? Dein aktuelles Layout wird zuerst als Snapshot gespeichert.

# --- Phase 8 (backup / theme editor / dock presets / settings search / quick actions) ---
workspace-backup = Sichern & Wiederherstellen…
backup-title = Sichern & Wiederherstellen
backup-intro = Sichere dein ganzes Studio — Einstellungen, Profile, Szenensammlungen — in eine Datei und stelle es hier oder auf einem neuen Rechner wieder her.
backup-export = Sicherung exportieren…
backup-exporting = Wird exportiert…
backup-exported = { $collections } Sammlung(en) und { $profiles } Profil(e) gesichert ({ $size }).
backup-restore = Aus Sicherung wiederherstellen…
backup-secrets-note = Stream-Schlüssel und Passwörter sind nie in einer Sicherung enthalten — gib sie nach dem Wiederherstellen erneut ein.
backup-restore-from = Sicherung erstellt { $created } (v{ $version })
backup-restore-settings = Einstellungen
backup-restore-collections = Szenensammlungen ({ $count })
backup-restore-profiles = Profile ({ $count })
backup-restore-apply = Auswahl wiederherstellen
backup-restoring = Wird wiederhergestellt…
backup-restored = Wiederhergestellt.
backup-restart-note = Starte Freally Capture neu, um die wiederhergestellten Sammlungen und Profile zu laden.
backup-cancel = Abbrechen
theme-editor-title = Eigene Palette
theme-color-bg = Hintergrund
theme-color-panel = Panel
theme-color-text = Text
theme-color-muted = Gedämpft
theme-color-accent = Akzent
theme-color-accent2 = Akzent 2
theme-contrast-text-bg = Text auf Hintergrund
theme-contrast-text-panel = Text auf Panel
theme-contrast-muted-bg = Gedämpft auf Hintergrund
theme-contrast-accent-bg = Akzent auf Hintergrund
theme-contrast-low = (Ziel ≥ { $min }:1)
theme-reset = Auf Dunkel zurücksetzen
theme-export = .fctheme exportieren…
theme-import = .fctheme importieren…
workspace-dock-presets = Dock-Layouts
workspace-dock-preset-placeholder = Aktuelles Layout speichern als…
workspace-dock-preset-save = Speichern
workspace-dock-preset-apply = Zu „{ $name }“ wechseln
workspace-dock-preset-delete = Layout „{ $name }“ löschen
workspace-dock-presets-hint = Ein Layout merkt sich das Statistik-Dock und die Mixer-Ausrichtung. Klicke eines an, um dorthin zu wechseln.
...
menu-tools-quick-actions = Schnellaktionen…
menu-tools-featured-chat = Hervorgehobene Chatnachricht …
quick-actions-title = Schnellaktionen
quick-actions-empty = Noch keine Schaltflächen — klicke auf Bearbeiten, um welche hinzuzufügen.
quick-actions-edit = Bearbeiten
quick-actions-done = Fertig
quick-actions-add-page = Seite
quick-actions-label = Schaltflächenbeschriftung
quick-actions-color = Schaltflächenfarbe
quick-actions-add = Schaltfläche hinzufügen
quick-actions-remove = „{ $name }“ entfernen
quick-actions-delete-page = „{ $name }“ löschen
quick-actions-hint = Schaltflächen lösen dieselben Studio-Befehle aus wie Hotkeys und das LAN-Panel — auch Szenen, Makros und Soundboard-Pads. Befehlsschaltflächen erscheinen zudem im LAN-Panel.
quick-actions-cmd-transition = Übergang
quick-actions-cmd-startStream = Live gehen
quick-actions-cmd-stopStream = Stream beenden
quick-actions-cmd-startRecording = Aufnahme starten
quick-actions-cmd-stopRecording = Aufnahme stoppen
quick-actions-cmd-pauseRecording = Aufnahme pausieren
quick-actions-cmd-addMarker = Marker setzen
quick-actions-cmd-armReplay = Replay scharfschalten
quick-actions-cmd-saveReplay = Replay speichern
quick-actions-cmd-setStudioMode = Studio-Modus umschalten
quick-actions-cmd-scene = Zur Szene wechseln…
quick-actions-cmd-macro = Makro ausführen…
quick-actions-cmd-soundboard = Soundboard-Pad…
quick-actions-value-scene = Szenenname
quick-actions-value-macro = Makroname
quick-actions-value-soundboard = Pad-ID
teleprompter-stop = Stopp
about-portable-on = Portabler Modus: an — alle App-Daten werden neben der App gespeichert.
about-portable-off = Portabler Modus: aus. Lege eine Datei „{ $marker }" neben der App an, um sie voll eigenständig auszuführen (USB-Stick-Modus).
about-portable-data = Datenordner: { $path }
...
history-toggleOutputVisibility = Ausgabe-Sichtbarkeit umschalten
...
palette-featured-chat = Hervorgehobene Chatnachricht …
featured-chat-title = Hervorgehobene Chatnachricht
featured-chat-intro = Hefte eine aktuelle Chatzeile als gestaltetes Banner unten ins Programm — Zuschauer von Stream und Aufnahme sehen es. Die Anheftung endet beim Neustart; die Farben bleiben.
featured-chat-empty = Noch kein Chat — füge eine Chat-Overlay-Quelle hinzu und verbinde sie mit deinem Kanal; Zeilen erscheinen hier, sobald sie eintreffen.
featured-chat-pinned = Im Programm:
featured-chat-pin = Anheften
featured-chat-clear = Entfernen
featured-chat-bg = Bannerfarbe
featured-chat-text = Textfarbe
featured-chat-note = Das Banner sitzt unten mittig über jeder Szene — entferne es, um es aus dem Programm zu nehmen.
...
properties-stats-show-timecode = Timecode anzeigen (LTC)
...
sources-visualizer-classic = Klassische Farben
...
menu-collection-clear = Verlauf löschen …
menu-collection-clear-confirm = Diese Szenensammlungen und ihre Dateien endgültig löschen? { $names } — die aktive Sammlung „{ $active }" bleibt erhalten. Dies kann nicht rückgängig gemacht werden.
...
telestrator-draw = Zeichnen
telestrator-tool-pen = Stift
telestrator-tool-highlight = Textmarker
telestrator-tool-arrow = Pfeil
telestrator-tool-ellipse = Ellipse
telestrator-color = Farbe
telestrator-width = Breite
telestrator-whiteboard = Whiteboard-Modus
telestrator-persist = Behalten
telestrator-fade = Ausblenden
telestrator-undo = Letzte Markierung rückgängig
telestrator-clear = Markierungen löschen
hotkeys-telestrator-clear = Telestrator: Markierungen löschen

# --- Teleprompter (CAP-N58) ---
teleprompter-title = Teleprompter
teleprompter-loading = Wird geladen…
teleprompter-empty = Noch kein Skript — füge im Teleprompter-Panel eines hinzu.
teleprompter-script = Skript
teleprompter-script-placeholder = Skript eingeben oder einfügen…
teleprompter-top = Anfang
teleprompter-slower = Langsamer
teleprompter-play = Start
teleprompter-pause = Pause
teleprompter-faster = Schneller
teleprompter-step-back = Schritt zurück
teleprompter-step-forward = Schritt vor
teleprompter-est-time = Lesezeit
teleprompter-caesura-hint = Für eine Pause -- eingeben
teleprompter-caesura-pause = Zäsurpause — Für eine Pause -- eingeben
teleprompter-countdown = Countdown starten
teleprompter-countdown-secs = Countdown (Sekunden)
teleprompter-speed = Tempo (Zeichen/Sek.)
teleprompter-speed-bpm = Tempo (BPM)
teleprompter-bpm-mode = BPM-Modus (Gesang)
teleprompter-font = Schriftgröße
teleprompter-mirror = Spiegeln (Glas)
teleprompter-open-projector = Projektor öffnen
teleprompter-preview = Vorschau
teleprompter-remote-hint = Steuere den Bildlauf per Hotkey, MIDI oder LAN-Panel, während dies geschlossen ist.
teleprompter-read-aloud = Mit betriebssystemeigener Sprachsynthese vorlesen
menu-tools-teleprompter = Teleprompter
hotkeys-teleprompter-toggle = Teleprompter: Start / Pause

# --- Remote guests: green room / cues / QoS / auto-grid (CAP-N54–N56, N59) ---
remote-hosting-count = { $count } Gäste werden gehostet
remote-green-room-default = Green Room
remote-green-room-default-title = Neue Gäste warten im Green Room, bis du sie einsetzt
remote-auto-grid = Auto-Raster
remote-auto-grid-title = Gäste beim Kommen und Gehen automatisch im Raster anordnen
remote-arrange-grid = Raster anordnen
remote-arrange-grid-title = Die eingesetzten Gäste jetzt im Raster anordnen
remote-green-room-monitor = Green-Room-Vorschau
remote-tech-cam-ok = Kamera ✓
remote-tech-cam-no = Keine Kamera
remote-tech-mic-ok = Mikro ✓
remote-tech-mic-no = Kein Mikro
remote-seat-on-air = Auf Sendung setzen
remote-cues-label = Cues
remote-cue = Cue
remote-cue-thirty = 30 Sekunden
remote-cue-wrap = Zum Schluss kommen
remote-cue-next = Du bist als Nächstes dran
remote-cue-speak = Lauter sprechen
remote-qos-good = Verbindung gut
remote-qos-fair = Verbindung mittelmäßig
remote-qos-poor = Verbindung schlecht
remote-green-room-guest = Du bist im Green Room — der Host schaltet dich gleich auf Sendung.

# --- Hotkey audit — Phase 7 actions ---
hotkey-audit-action-telestrator-clear = Telestrator: Markierungen löschen
hotkey-audit-action-teleprompter-toggle = Teleprompter: Start / Pause
...
sources-add-starting-soon = Startet bald …
sources-starting-soon-title = Startet bald
sources-starting-soon-default = Startet bald
sources-starting-soon-message = Nachricht
sources-starting-soon-minutes = Minuten
sources-starting-soon-hours = Stunden
sources-starting-soon-start-at = Beginn um
sources-starting-soon-music = Hintergrundmusik …
sources-starting-soon-music-name = Hintergrundmusik
sources-starting-soon-background = Hintergrund
sources-starting-soon-note = Ein bildschirmfüllender Countdown, der bei null rot blinkt und stehen bleibt — lösche ihn und schneide von Hand auf deine Live-Szene, wenn du bereit bist.
sources-starting-soon-add = Hinzufügen
sources-slate-solid = Vollton
sources-slate-gradient = Verlauf
sources-slate-transparent = Transparent
sources-slate-image = Bild
sources-slate-file = Bild / Video / GIF
sources-slate-browse = Durchsuchen …
sources-starting-soon-choose-image = Bild wählen …
sources-slate-media-note = Standbilder werden hier eingebettet. Für ein Video oder GIF als Endlos-Hintergrund wähle „Transparent" und lege den Szenen-Hintergrund (das 🖼 in der Szenenleiste) fest — der Countdown liegt darüber.
properties-timer-slate = Startet-bald-Tafel
properties-timer-slate-off = Aus (Inline-Text)
properties-timer-message = Nachricht
properties-timer-slate-color = Tafelfarbe
properties-timer-slate-from = Von
properties-timer-slate-to = Bis
properties-timer-slate-note = Transparent lässt ein Bild, Video oder einen Szenen-Hintergrund unter der Tafel durchscheinen.
