...
settings-more-section = Altre impostazioni
settings-open-output = Registrazione…
settings-open-stream = Streaming…
settings-open-replay = Replay…
settings-open-hotkeys = Scorciatoie…
settings-open-remote = API remota…
settings-open-about = Informazioni…
controls-settings = ⚙ Impostazioni…
controls-settings-title = Lingua, aspetto e le preferenze a livello di app
...
hotkeys-still-placeholder = es. Ctrl+Shift+P
...
hotkeys-panic-placeholder = es. Ctrl+Shift+F12
hotkeys-timer-toggle = Avvia/pausa tutti i timer
hotkeys-timer-toggle-placeholder = es. Ctrl+Shift+T
hotkeys-timer-reset = Reset di tutti i timer
hotkeys-timer-reset-placeholder = es. Ctrl+Shift+0
...
controls-automation = Automazione
...
hotkeys-split-placeholder = es. Numpad1
...
hotkeys-playlist-placeholder = es. Ctrl+Alt+Right
...
hotkeys-replay-roll-placeholder = es. Ctrl+Shift+I
