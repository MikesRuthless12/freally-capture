...
sources-add-background-music = Musica di sottofondo…
sources-background-music-note = Si ripete, udibile nell'anteprima e registrato/trasmesso. Per usare la musica al posto dell'audio di un video, disattiva la traccia Backdrop del video.
sources-background-music-count = { $n } tracce
sources-background-music-shuffle = Casuale
...
sources-game-accept = Accetta il rischio e scegli un gioco
sources-game-pick = Scegli la finestra del gioco da catturare. Resta agganciata solo mentre giochi.
...
controls-virtual-camera-stop = ⌁ Arresta la fotocamera virtuale
controls-virtual-camera-ready = Pubblica il programma come fotocamera selezionabile da altre app.
...
scenes-recent-title = Recenti
scenes-recent-clear = Cancella
scenes-recent-clear-confirm = Cancellare l'elenco delle scene recenti?
...
livebutton-rehearse-record-confirm = Registrare anche questa prova in un file video?
...
properties-timer-clock = Conto alla rovescia fino a un orario
...
workspace-pack-title = Pacchetto raccolta scene
workspace-pack-export = Esporta pacchetto…
workspace-pack-exporting = Esportazione…
workspace-pack-import = Importa pacchetto…
workspace-pack-importing = Importazione…
workspace-pack-hint = Un .fcappack raccoglie la raccolta attiva e le sue risorse locali in un unico file portabile — condividi un intero layout, senza server. L'importazione la inserisce come nuova raccolta e vi passa.
workspace-pack-exported = «{ $name }» esportata — { $bundled } risorsa/e inclusa/e, { $external } esterna/e.
workspace-pack-imported = «{ $name }» importata — { $scenes } scena/e, { $relinked } risorsa/e ricollegata/e, { $external } esterna/e.
workspace-compare = Confronta e unisci…
compare-title = Confronta e unisci
compare-intro = Confronta la collezione attiva con un'altra e importa solo le modifiche che scegli. Nulla lascia questo computer.
compare-target-label = Confronta con
compare-target-none = Scegli una collezione…
compare-target-pack = Da un file pacchetto…
compare-against = vs { $name }
compare-comparing = Confronto in corso…
compare-no-diff = Nessuna differenza — le collezioni coincidono.
compare-select-all = Seleziona tutto
compare-clear = Cancella
compare-merge-hint = Scegliendo una scena vengono importate anche le sorgenti che usa.
compare-sources-title = Sorgenti
compare-scenes-title = Scene
compare-kind-added = Aggiunto
compare-kind-removed = Rimosso
compare-kind-modified = Modificato
compare-renamed = era «{ $from }»
compare-reordered = riordinato
compare-apply = Applica { $count }
compare-apply-none = Seleziona le modifiche da applicare
compare-applying = Applicazione…
compare-aspect-source = sorgente
compare-aspect-transform = posizione
compare-aspect-visibility = visibilità
compare-aspect-outputs = uscite
compare-aspect-filters = filtri
compare-aspect-lock = blocco
compare-aspect-blend = fusione
compare-aspect-scaling = ridimensionamento
compare-aspect-backdrop = sfondo
compare-aspect-reveal = rivelazione
compare-aspect-name = nome
compare-aspect-settings = impostazioni
compare-aspect-audio = audio
workspace-snapshots = Istantanee…
snapshots-title = Istantanee
snapshots-intro = Punti di controllo con nome di questa collezione a cui puoi tornare — conservati di proposito, oltre al salvataggio automatico e all'annulla. Archiviati in locale.
snapshots-name-placeholder = Dai un nome a questo punto…
snapshots-create = Salva istantanea
snapshots-empty = Ancora nessuna istantanea — salvane una per conservare un punto di controllo con nome a cui tornare.
snapshots-usage = { $count } di { $cap } conservate · { $size }
snapshots-scenes = { $scenes } scene · { $sources } sorgenti
snapshots-restore = Ripristina
snapshots-compare = Confronta
snapshots-delete = Elimina istantanea
snapshots-delete-aria = Elimina istantanea «{ $name }»
snapshots-restore-confirm = Ripristinare questa istantanea? Il layout attuale viene prima salvato come istantanea.

# --- Phase 8 (backup / theme editor / dock presets / settings search / quick actions) ---
workspace-backup = Backup e ripristino…
backup-title = Backup e ripristino
backup-intro = Salva l'intero studio — impostazioni, profili, raccolte di scene — in un unico file e ripristinalo qui o su una nuova macchina.
backup-export = Esporta backup…
backup-exporting = Esportazione…
backup-exported = Eseguito il backup di { $collections } raccolta/e e { $profiles } profilo/i ({ $size }).
backup-restore = Ripristina da backup…
backup-secrets-note = Le chiavi di streaming e le password non sono mai incluse in un backup — reinseriscile dopo il ripristino.
backup-restore-from = Backup creato il { $created } (v{ $version })
backup-restore-settings = Impostazioni
backup-restore-collections = Raccolte di scene ({ $count })
backup-restore-profiles = Profili ({ $count })
backup-restore-apply = Ripristina selezionati
backup-restoring = Ripristino…
backup-restored = Ripristinato.
backup-restart-note = Riavvia Freally Capture per caricare le raccolte e i profili ripristinati.
backup-cancel = Annulla
theme-editor-title = Tavolozza personalizzata
theme-color-bg = Sfondo
theme-color-panel = Pannello
theme-color-text = Testo
theme-color-muted = Attenuato
theme-color-accent = Accento
theme-color-accent2 = Accento 2
theme-contrast-text-bg = Testo su sfondo
theme-contrast-text-panel = Testo su pannello
theme-contrast-muted-bg = Attenuato su sfondo
theme-contrast-accent-bg = Accento su sfondo
theme-contrast-low = (mira a ≥ { $min }:1)
theme-reset = Ripristina al tema scuro
theme-export = Esporta .fctheme…
theme-import = Importa .fctheme…
workspace-dock-presets = Layout dei pannelli
workspace-dock-preset-placeholder = Salva il layout attuale come…
workspace-dock-preset-save = Salva
workspace-dock-preset-apply = Passa a «{ $name }»
workspace-dock-preset-delete = Elimina il layout «{ $name }»
workspace-dock-presets-hint = Un layout ricorda il pannello statistiche e l'orientamento del mixer. Fai clic su uno per passarci.
...
menu-tools-quick-actions = Azioni rapide…
menu-tools-featured-chat = Messaggio chat in evidenza…
quick-actions-title = Azioni rapide
quick-actions-empty = Ancora nessun pulsante — fai clic su Modifica per aggiungerne.
quick-actions-edit = Modifica
quick-actions-done = Fatto
quick-actions-add-page = Pagina
quick-actions-label = Etichetta del pulsante
quick-actions-color = Colore del pulsante
quick-actions-add = Aggiungi pulsante
quick-actions-remove = Rimuovi «{ $name }»
quick-actions-delete-page = Elimina «{ $name }»
quick-actions-hint = I pulsanti attivano gli stessi comandi dello studio dei tasti di scelta rapida e del pannello LAN — scene, macro e pad della soundboard compresi. I pulsanti di comando compaiono anche sul pannello LAN.
quick-actions-cmd-transition = Transizione
quick-actions-cmd-startStream = Vai in diretta
quick-actions-cmd-stopStream = Termina diretta
quick-actions-cmd-startRecording = Avvia registrazione
quick-actions-cmd-stopRecording = Ferma registrazione
quick-actions-cmd-pauseRecording = Metti in pausa la registrazione
quick-actions-cmd-addMarker = Aggiungi marcatore
quick-actions-cmd-armReplay = Arma il replay
quick-actions-cmd-saveReplay = Salva replay
quick-actions-cmd-setStudioMode = Attiva/disattiva modalità studio
quick-actions-cmd-scene = Passa alla scena…
quick-actions-cmd-macro = Esegui macro…
quick-actions-cmd-soundboard = Pad della soundboard…
quick-actions-value-scene = Nome della scena
quick-actions-value-macro = Nome della macro
quick-actions-value-soundboard = ID del pad
teleprompter-stop = Ferma
about-portable-on = Modalità portatile: attiva — tutti i dati dell'app vengono archiviati accanto all'app.
about-portable-off = Modalità portatile: disattivata. Aggiungi un file «{ $marker }» accanto all'app per eseguirla in modo completamente autonomo (modalità chiavetta USB).
about-portable-data = Cartella dati: { $path }
...
palette-featured-chat = Messaggio chat in evidenza…
featured-chat-title = Messaggio chat in evidenza
featured-chat-intro = Fissa una riga di chat recente come banner in basso nel programma — gli spettatori di stream e registrazione la vedono. Il pin si azzera al riavvio; i colori restano.
featured-chat-empty = Ancora nessuna chat — aggiungi una sorgente Chat Overlay e collegala al tuo canale; le righe appariranno qui all'arrivo.
featured-chat-pinned = In onda:
featured-chat-pin = Metti in evidenza
featured-chat-clear = Rimuovi
featured-chat-bg = Colore banner
featured-chat-text = Colore testo
featured-chat-note = Il banner sta in basso al centro, sopra ogni scena — rimuovilo per toglierlo dall'aria.
...
sources-visualizer-classic = Colori classici
...
menu-collection-clear = Cancella cronologia…
menu-collection-clear-confirm = Eliminare definitivamente queste raccolte di scene e i loro file? { $names } — la raccolta attiva «{ $active }» viene mantenuta. L'operazione non può essere annullata.
...
telestrator-draw = Disegna
telestrator-tool-pen = Penna
telestrator-tool-highlight = Evidenziatore
telestrator-tool-arrow = Freccia
telestrator-tool-ellipse = Ellisse
telestrator-color = Colore
telestrator-width = Spessore
telestrator-whiteboard = Modalità lavagna
telestrator-persist = Mantieni
telestrator-fade = Dissolvi
telestrator-undo = Annulla ultimo segno
telestrator-clear = Cancella segni
hotkeys-telestrator-clear = Telestrator: cancella segni

# --- Teleprompter (CAP-N58) ---
teleprompter-title = Teleprompter
teleprompter-loading = Caricamento…
teleprompter-empty = Ancora nessun copione — aggiungine uno nel pannello del teleprompter.
teleprompter-script = Copione
teleprompter-script-placeholder = Scrivi o incolla il tuo copione…
teleprompter-top = Inizio
teleprompter-slower = Più lento
teleprompter-play = Riproduci
teleprompter-pause = Pausa
teleprompter-faster = Più veloce
teleprompter-step-back = Passo indietro
teleprompter-step-forward = Passo avanti
teleprompter-est-time = Tempo di lettura
teleprompter-caesura-hint = Digita -- per una pausa
teleprompter-caesura-pause = Pausa di cesura — Digita -- per una pausa
teleprompter-countdown = Avvia conto alla rovescia
teleprompter-countdown-secs = Conto alla rovescia (secondi)
teleprompter-speed = Velocità (caratteri/s)
teleprompter-speed-bpm = Velocità (BPM)
teleprompter-bpm-mode = Modalità BPM (canto)
teleprompter-font = Dimensione testo
teleprompter-mirror = Specchio (vetro)
teleprompter-open-projector = Apri proiettore
teleprompter-preview = Anteprima
teleprompter-remote-hint = Controlla lo scorrimento con una scorciatoia, il MIDI o il pannello LAN mentre questo è chiuso.
teleprompter-read-aloud = Leggi ad alta voce con la sintesi vocale del sistema operativo
menu-tools-teleprompter = Teleprompter
hotkeys-teleprompter-toggle = Teleprompter: riproduci / pausa

# --- Remote guests: green room / cues / QoS / auto-grid (CAP-N54–N56, N59) ---
remote-hosting-count = Hosting di { $count } ospite/i
remote-green-room-default = Sala d'attesa
remote-green-room-default-title = I nuovi ospiti attendono in sala finché non li metti in scena
remote-auto-grid = Griglia automatica
remote-auto-grid-title = Mantieni gli ospiti in griglia mentre entrano ed escono
remote-arrange-grid = Disponi griglia
remote-arrange-grid-title = Ridisponi ora in griglia gli ospiti in scena
remote-green-room-monitor = Anteprima sala d'attesa
remote-tech-cam-ok = Cam ✓
remote-tech-cam-no = Niente cam
remote-tech-mic-ok = Mic ✓
remote-tech-mic-no = Niente mic
remote-seat-on-air = Manda in onda
remote-cues-label = Segnali
remote-cue = Segnale
remote-cue-thirty = 30 secondi
remote-cue-wrap = Concludi
remote-cue-next = Tocca a te tra poco
remote-cue-speak = Parla più forte
remote-qos-good = Connessione buona
remote-qos-fair = Connessione discreta
remote-qos-poor = Connessione scarsa
remote-green-room-guest = Sei in sala d'attesa — l'host ti manderà in onda a breve.

# --- Hotkey audit — Phase 7 actions ---
hotkey-audit-action-telestrator-clear = Telestrator: cancella segni
hotkey-audit-action-teleprompter-toggle = Teleprompter: riproduci / pausa
...
sources-add-starting-soon = A breve in diretta…
sources-starting-soon-title = A breve in diretta
sources-starting-soon-default = A breve in diretta
sources-starting-soon-message = Messaggio
sources-starting-soon-minutes = Minuti
sources-starting-soon-hours = Ore
sources-starting-soon-start-at = Inizia alle
sources-starting-soon-music = Musica di sottofondo…
sources-starting-soon-music-name = Musica di sottofondo
sources-starting-soon-background = Sfondo
sources-starting-soon-note = Un conto alla rovescia a schermo intero che lampeggia in rosso e si ferma allo zero: cancellalo e passa manualmente alla tua scena in diretta quando sei pronto.
sources-starting-soon-add = Aggiungi
sources-slate-solid = Tinta unita
sources-slate-gradient = Gradiente
sources-slate-transparent = Trasparente
sources-slate-image = Immagine
sources-slate-file = Immagine / Video / GIF
sources-slate-browse = Sfoglia…
sources-starting-soon-choose-image = Scegli immagine…
sources-slate-media-note = Le immagini fisse vengono incorporate qui. Per un video o una GIF di sfondo in loop, scegli «Trasparente» e imposta lo sfondo della scena (il 🖼 nella barra delle scene): il conto alla rovescia sta sopra.
properties-timer-slate = Schermata «A breve in diretta»
properties-timer-slate-off = Disattivato (testo in linea)
properties-timer-message = Messaggio
properties-timer-slate-color = Colore schermata
properties-timer-slate-from = Da
properties-timer-slate-to = A
properties-timer-slate-note = Trasparente lascia intravedere un'immagine, un video o uno sfondo di scena sotto la schermata.
...
sources-browser-component-missing = Richiede il componente Browser Runtime — installalo da Strumenti → Componenti.
sources-browser-component-unsupported = CEF non pubblica una build di Browser Runtime per questa piattaforma, quindi questa sorgente non può essere renderizzata qui.
sources-browser-component-installing = Installazione del componente Browser Runtime… questa sorgente verrà renderizzata al termine.
sources-browser-component-error = Impossibile installare il componente Browser Runtime: { $message }

# Shown when a dialog or dock hits a render error (ErrorBoundary).
panel-error-title = Questo pannello si è arrestato
panel-error-hint = Registrazione e streaming non sono interessati. Chiudi e riapri.
