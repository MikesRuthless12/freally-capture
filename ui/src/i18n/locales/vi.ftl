...
hotkeys-timer-toggle-placeholder = vd. Ctrl+Shift+T
hotkeys-timer-reset = Đặt lại mọi hẹn giờ
hotkeys-timer-reset-placeholder = vd. Ctrl+Shift+0
...
controls-automation = Tự động hoá
...
hotkeys-split-placeholder = vd. Numpad1
...
hotkeys-playlist-placeholder = vd. Ctrl+Alt+Right
...
hotkeys-replay-roll-placeholder = vd. Ctrl+Shift+I
