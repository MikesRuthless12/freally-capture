...
sources-add-background-music = Nhạc nền…
sources-background-music-note = Phát lặp, nghe được ở bản xem trước và được ghi/phát trực tiếp. Để dùng nhạc thay cho tiếng video, tắt tiếng dải Backdrop của video.
sources-background-music-count = { $n } bản nhạc
sources-background-music-shuffle = Ngẫu nhiên
...
sources-stream-hide = Ẩn trên stream
sources-stream-show = Hiện trên stream
sources-stream-hide-item = Ẩn { $name } trên stream
sources-stream-show-item = Hiện { $name } trên stream
sources-record-hide = Ẩn trong bản ghi
sources-record-show = Hiện trong bản ghi
sources-record-hide-item = Ẩn { $name } trong bản ghi
sources-record-show-item = Hiện { $name } trong bản ghi
...
controls-iso-lanes = Số làn ISO đang ghi cùng chương trình: { $count }
...
ltc-badge = LTC
ltc-title = Mã thời gian SMPTE (LTC)
ltc-intro = Tạo mã thời gian tuyến tính SMPTE trên một track, và đọc LTC đến từ bất kỳ đầu vào âm thanh nào — mã thời gian âm thanh cổ điển để đồng bộ máy ghi và máy quay ngoài khi hậu kỳ. Hoàn toàn ngoại tuyến.
ltc-generate = Tạo LTC lên một track
ltc-track = Track mã thời gian
ltc-track-option = Track { $track }
ltc-fps = Tốc độ khung hình
ltc-read = Đọc LTC từ
ltc-read-off = Tắt
ltc-decoded = Mã thời gian đến
ltc-no-lock = không có tín hiệu
ltc-note = Bộ tạo đồng bộ theo giờ trong ngày, non-drop. Ghi track của nó (gán trong cài đặt Đầu ra) hoặc định tuyến ra một đầu ra để cấp cho thiết bị ngoài. Bộ đọc điều khiển dòng mã thời gian trên lớp phủ thống kê và đóng dấu điểm đánh dấu chương.
...
stats-disk = Đĩa
stats-disk-free = trống
stats-disk-left = Ghi còn lại
stats-disk-rate = ≈ { $rate } MB/s đang ghi
stats-vertical-fps = FPS 9:16
stats-targets-label = Đích luồng
stats-rehearsal-note = Diễn tập — các đích chỉ phát tới sink cục bộ
stats-timeline-open = Dòng thời gian
timeline-title = Dòng thời gian phiên
timeline-empty = Chưa có gì được ghi — dòng thời gian ghi trong khi bạn stream hoặc ghi hình.
timeline-live = LIVE — vẫn đang ghi
timeline-fit = Vừa khung
timeline-legend-fps = fps
timeline-legend-behind = hàng đợi bộ mã hóa (khung trễ)
...
scenes-recent-title = Gần đây
scenes-recent-clear = Xóa
scenes-recent-clear-confirm = Xóa danh sách cảnh gần đây?
...
livebutton-rehearse = Diễn tập
livebutton-rehearse-record-confirm = Cũng ghi buổi diễn tập này vào tệp video?
livebutton-rehearse-title = Chạy toàn bộ chương trình với đích cục bộ — không gửi gì đi
livebutton-end-rehearsal = Kết thúc diễn tập
livebutton-title-rehearsing = Đang diễn tập — không gì rời khỏi máy này
livebutton-badge-rehearsal = DIỄN TẬP
livebutton-aria-rehearsal = Đang diễn tập
livebutton-rehearsal-banner = Diễn tập — không gì rời khỏi máy này
...
properties-timer-clock = Đếm ngược đến một giờ
...
filters-name-perspective = Phối cảnh
filters-name-fade-loop = Vòng lặp mờ dần
...
filters-shader-gallery = Thư viện
filters-shader-gallery-pick = Tải preset…
filters-shader-gallery-grayscale = Thang xám
filters-shader-gallery-invert = Đảo màu
filters-shader-gallery-scanlines = Đường quét
filters-shader-gallery-vignette = Vignette
filters-shader-source = Mã nguồn shader (WGSL)
filters-shader-hint = Viết một effect(uv, color, p, texel, time) bằng WGSL trả về vec4. Chú thích tham số bằng // @param name min max default để tạo thanh trượt. Shader không hợp lệ sẽ bị bỏ qua — nguồn hiển thị không lọc cho đến khi biên dịch được.
filters-name-bezier-mask = Mặt nạ Bézier
filters-mask-editor-hint = Kéo một điểm để di chuyển, nhấp đúp để thêm, nhấp chuột phải vào một điểm để xóa.
filters-mask-shape = Hình dạng
filters-mask-shape-pick = Preset…
filters-mask-shape-rectangle = Hình chữ nhật
filters-mask-shape-diamond = Hình thoi
filters-mask-shape-hexagon = Lục giác
filters-mask-shape-circle = Hình tròn
filters-mask-feather = Làm mờ viền
filters-mask-export-wipe = Xuất dưới dạng wipe…
...
filters-tilt = Độ nghiêng
filters-far-fade = Mờ dần cạnh xa
filters-fade-in-s = Hiện dần (giây)
filters-visible-s = Hiển thị (giây)
filters-fade-out-s = Mờ dần (giây)
filters-hidden-s = Ẩn (giây)
...
recordings-trim = Cắt
recordings-trim-title = Cắt một đoạn từ bản ghi này — vết cắt trùng khung hình khóa xuất ra không cần mã hóa lại
recordings-verify = Kiểm tra
recordings-verify-title = Kiểm tra tính toàn vẹn của tệp — cấu trúc vùng chứa, tính liên tục, xen kẽ A/V, thời lượng
recordings-verifying = Đang kiểm tra…
verify-dismiss = Đóng
verify-verdict-pass = { $name } — toàn vẹn tốt
verify-verdict-warn = { $name } — đã kiểm tra, có cảnh báo
verify-verdict-fail = { $name } — phát hiện sự cố
verify-container = Vùng chứa
verify-video-continuity = Tính liên tục video
verify-audio-continuity = Tính liên tục âm thanh
verify-av-interleave = Xen kẽ A/V
verify-duration = Thời lượng
recordings-alpha-label = alpha
recordings-prores-title = Xuất bản master .mov ProRes 4444 giữ nguyên alpha (để dựng phim)
recordings-qtrle-title = Xuất .mov QuickTime Animation giữ nguyên alpha (tương thích tối đa)
trim-title = Cắt — { $name }
trim-loading = Đang đọc tệp…
trim-preview-alt = Khung hình xem trước
trim-position = Vị trí phát
trim-step-second-back = Lùi một giây
trim-step-frame-back = Lùi một khung hình
trim-step-frame-forward = Tiến một khung hình
trim-step-second-forward = Tiến một giây
trim-snap = Khung hình khóa
trim-snap-title = Bám vào khung hình khóa gần nhất — cắt tại đó xuất ra không cần mã hóa lại
trim-set-in = Điểm vào
trim-set-out = Điểm ra
trim-range-invalid = Điểm ra phải nằm sau điểm vào.
trim-copy-badge = ✓ Xuất không mã hóa lại — điểm vào nằm đúng khung hình khóa.
trim-reencode-badge = Sẽ mã hóa lại: điểm vào nằm giữa các khung hình khóa (dùng "Khung hình khóa" để bám cho vết cắt không mất chất lượng).
trim-export = Xuất đoạn cắt
trim-export-916 = 9:16
trim-export-916-title = Xuất dọc đã đóng khung lại (cắt giữa theo kích thước khung vẽ dọc) — luôn mã hóa lại
...
bench-open = Chạy benchmark bộ mã hóa…
bench-title = Benchmark bộ mã hóa
bench-intro = Chạy các thang mã hóa đo lường ngắn (mỗi bộ mã hóa phát hiện × preset × độ phân giải) trên máy này — khoảng một phút, hoàn toàn ngoại tuyến, không gì rời khỏi máy. Lỗi được liệt kê, không bị giấu. Hãy dừng stream/ghi hình trước.
bench-start = Bắt đầu benchmark
bench-rerun = Chạy lại
bench-running = Đang đo… { $done } / { $total }
bench-cancel = Hủy
bench-col-encoder = Bộ mã hóa
bench-col-preset = Preset
bench-col-rung = Bậc
bench-col-achieved = fps
bench-col-headroom = Dự phòng
bench-failed = thất bại
bench-rec-title = Khuyến nghị (đo lường)
bench-rec-body = { $encoder } với { $preset }, { $width }×{ $height } @ { $fps } fps — đo được { $headroom }× thời gian thực. Bitrate stream đề xuất: { $bitrate } kbps.
bench-rec-none = Không cấu hình nào giữ được thời gian thực trên máy này — hạ độ phân giải canvas hoặc fps rồi đo lại.
bench-apply = Áp dụng vào cài đặt ghi hình
bench-applied = Đã áp dụng ✓
...
output-iso-heading = Ghi ISO
output-iso-explainer = Ghi các nguồn đã chọn ở dạng sạch, mỗi nguồn vào một tệp riêng bên cạnh chương trình — trước khi ghép, ở kích thước và tốc độ khung hình của khung vẽ, để mọi tệp rơi thẳng hàng trên dòng thời gian dựng phim. Hai làn chạy thoải mái trên GPU tầm trung; mỗi làn thêm tốn thêm một lần kết xuất và mã hóa.
output-iso-none = Bộ sưu tập chưa có nguồn nào.
output-iso-source-on = Đang ghi "{ $name }" thành tệp ISO riêng — bấm để dừng
output-iso-source-off = Ghi "{ $name }" thành tệp ISO riêng
output-iso-post-filter = Ghi kèm bộ lọc của nguồn (hậu lọc); bỏ chọn sẽ ghi nguồn thô
...
output-split-on-marker = đánh dấu
output-split-on-rundown = bước kịch bản
output-auto-markers = Tự động thả điểm đánh dấu chương theo sự kiện studio (chuyển cảnh, lưu replay, kết nối lại, rơi khung hình, cảnh báo, quy tắc)
output-auto-markers-title = Điểm đánh dấu có nhãn được ghi vào chương của bản ghi (mkv) hoặc tệp .chapters.txt, bên cạnh phím tắt thủ công
output-pipeline-heading = Chuỗi xử lý sau ghi hình
output-pipeline-explainer = Khi bản ghi hoàn tất, các bước này chạy trên tệp chính, theo thứ tự, ở chế độ nền. Bộ hành động đóng — cố ý không có bước "chạy lệnh". Chuỗi dừng ở lỗi đầu tiên.
output-pipeline-enabled = Chạy chuỗi xử lý sau mỗi bản ghi
output-pipeline-add = Thêm bước…
output-pipeline-up = Chuyển lên
output-pipeline-down = Chuyển xuống
output-pipeline-remove = Xóa bước
output-pipeline-template = Mẫu đổi tên (token CAP-M25)
output-pipeline-folder = Thư mục
pipeline-queue = Chuỗi xử lý sau ghi hình
pipeline-verify = Kiểm tra
pipeline-remux = Remux sang MP4
pipeline-normalize = Chuẩn hóa âm lượng
pipeline-rename = Đổi tên
pipeline-move = Chuyển vào thư mục
pipeline-copy = Sao chép vào thư mục
pipeline-reveal = Hiện trong trình quản lý tệp
pipeline-luaEvent = Báo cho script Lua
...
stream-session-report = Khi phiên kết thúc, ghi báo cáo phiên (HTML + Markdown) cạnh bản ghi
stream-simulator-title = Trình mô phỏng mạng (diễn tập)
stream-simulator-note = Chỉ định hình các sink cục bộ của buổi diễn tập — luyện kết nối lại và đường truyền yếu. Go Live thật không bao giờ bị suy giảm.
stream-simulator-profile = Hồ sơ
stream-simulator-off = Tắt
stream-simulator-hotel-wifi = Wi-Fi khách sạn
stream-simulator-mobile-hotspot = Điểm phát di động
stream-simulator-custom = Tùy chỉnh
stream-simulator-bandwidth = Băng thông (kbps, 0 = không giới hạn)
stream-simulator-latency = Độ trễ (ms)
stream-simulator-jitter = Jitter (± ms)
stream-simulator-outage-every = Đứt mỗi (giây, 0 = không bao giờ)
stream-simulator-outage-len = Thời gian đứt (giây)
...
workspace-pack-title = Gói bộ sưu tập cảnh
workspace-pack-export = Xuất gói…
workspace-pack-exporting = Đang xuất…
workspace-pack-import = Nhập gói…
workspace-pack-importing = Đang nhập…
workspace-pack-hint = Một .fcappack gói bộ sưu tập đang hoạt động cùng các tài nguyên cục bộ của nó vào một tệp di động duy nhất — chia sẻ toàn bộ bố cục, không cần máy chủ. Nhập sẽ đưa nó vào như một bộ sưu tập mới và chuyển sang đó.
workspace-pack-exported = Đã xuất "{ $name }" — { $bundled } tài nguyên đã gói, { $external } bên ngoài.
workspace-pack-imported = Đã nhập "{ $name }" — { $scenes } cảnh, { $relinked } tài nguyên đã liên kết lại, { $external } bên ngoài.
workspace-compare = So sánh & hợp nhất…
compare-title = So sánh & hợp nhất
compare-intro = So sánh bộ sưu tập đang hoạt động với một bộ khác và chỉ lấy về những thay đổi bạn chọn. Không có gì rời khỏi máy này.
compare-target-label = So sánh với
compare-target-none = Chọn một bộ sưu tập…
compare-target-pack = Từ tệp gói…
compare-against = so với { $name }
compare-comparing = Đang so sánh…
compare-no-diff = Không có khác biệt — các bộ sưu tập trùng khớp.
compare-select-all = Chọn tất cả
compare-clear = Xóa
compare-merge-hint = Chọn một cảnh cũng mang theo các nguồn mà nó sử dụng.
compare-sources-title = Nguồn
compare-scenes-title = Cảnh
compare-kind-added = Đã thêm
compare-kind-removed = Đã xóa
compare-kind-modified = Đã thay đổi
compare-renamed = trước là "{ $from }"
compare-reordered = đã sắp xếp lại
compare-apply = Áp dụng { $count }
compare-apply-none = Chọn thay đổi để áp dụng
compare-applying = Đang áp dụng…
compare-aspect-source = nguồn
compare-aspect-transform = vị trí
compare-aspect-visibility = hiển thị
compare-aspect-outputs = đầu ra
compare-aspect-filters = bộ lọc
compare-aspect-lock = khóa
compare-aspect-blend = hòa trộn
compare-aspect-scaling = tỷ lệ
compare-aspect-backdrop = nền
compare-aspect-reveal = hé lộ
compare-aspect-name = tên
compare-aspect-settings = cài đặt
compare-aspect-audio = âm thanh
workspace-snapshots = Ảnh chụp nhanh…
snapshots-title = Ảnh chụp nhanh
snapshots-intro = Các điểm mốc được đặt tên của bộ sưu tập này mà bạn có thể quay lại — được giữ lại có chủ đích, ngoài tự động lưu và hoàn tác. Lưu cục bộ.
snapshots-name-placeholder = Đặt tên cho điểm mốc này…
snapshots-create = Lưu ảnh chụp nhanh
snapshots-empty = Chưa có ảnh chụp nhanh nào — hãy lưu một cái để giữ một điểm mốc được đặt tên mà bạn có thể quay lại.
snapshots-usage = Đã giữ { $count } trong { $cap } · { $size }
snapshots-scenes = { $scenes } cảnh · { $sources } nguồn
snapshots-restore = Khôi phục
snapshots-compare = So sánh
snapshots-delete = Xóa ảnh chụp nhanh
snapshots-delete-aria = Xóa ảnh chụp nhanh "{ $name }"
snapshots-restore-confirm = Khôi phục ảnh chụp nhanh này? Bố cục hiện tại của bạn được lưu thành một ảnh chụp nhanh trước.

# --- Phase 8 (backup / theme editor / dock presets / settings search / quick actions) ---
workspace-backup = Sao lưu và khôi phục…
backup-title = Sao lưu và khôi phục
backup-intro = Lưu toàn bộ studio của bạn — cài đặt, hồ sơ, bộ sưu tập cảnh — vào một tệp, rồi khôi phục tại đây hoặc trên máy mới.
backup-export = Xuất bản sao lưu…
backup-exporting = Đang xuất…
backup-exported = Đã sao lưu { $collections } bộ sưu tập và { $profiles } hồ sơ ({ $size }).
backup-restore = Khôi phục từ bản sao lưu…
backup-secrets-note = Khóa phát trực tiếp và mật khẩu không bao giờ được đưa vào bản sao lưu — hãy nhập lại chúng sau khi khôi phục.
backup-restore-from = Bản sao lưu tạo lúc { $created } (v{ $version })
backup-restore-settings = Cài đặt
backup-restore-collections = Bộ sưu tập cảnh ({ $count })
backup-restore-profiles = Hồ sơ ({ $count })
backup-restore-apply = Khôi phục mục đã chọn
backup-restoring = Đang khôi phục…
backup-restored = Đã khôi phục.
backup-restart-note = Khởi động lại Freally Capture để tải các bộ sưu tập và hồ sơ đã khôi phục.
backup-cancel = Hủy
theme-editor-title = Bảng màu tùy chỉnh
theme-color-bg = Nền
theme-color-panel = Bảng
theme-color-text = Chữ
theme-color-muted = Mờ
theme-color-accent = Nhấn
theme-color-accent2 = Nhấn 2
theme-contrast-text-bg = Chữ trên nền
theme-contrast-text-panel = Chữ trên bảng
theme-contrast-muted-bg = Mờ trên nền
theme-contrast-accent-bg = Nhấn trên nền
theme-contrast-low = (mục tiêu ≥ { $min }:1)
theme-reset = Đặt lại về tối
theme-export = Xuất .fctheme…
theme-import = Nhập .fctheme…
workspace-dock-presets = Bố cục dock
workspace-dock-preset-placeholder = Lưu bố cục hiện tại thành…
workspace-dock-preset-save = Lưu
workspace-dock-preset-apply = Chuyển sang "{ $name }"
workspace-dock-preset-delete = Xóa bố cục "{ $name }"
workspace-dock-presets-hint = Một bố cục ghi nhớ dock thống kê và hướng của bộ trộn. Nhấp vào một bố cục để chuyển sang nó.
...
menu-tools-quick-actions = Thao tác nhanh…
menu-tools-featured-chat = Tin nhắn chat nổi bật…
quick-actions-title = Thao tác nhanh
quick-actions-empty = Chưa có nút nào — nhấp Sửa để thêm.
quick-actions-edit = Sửa
quick-actions-done = Xong
quick-actions-add-page = Trang
quick-actions-label = Nhãn nút
quick-actions-color = Màu nút
quick-actions-add = Thêm nút
quick-actions-remove = Xóa "{ $name }"
quick-actions-delete-page = Xóa "{ $name }"
quick-actions-hint = Các nút chạy cùng những lệnh studio như phím tắt và bảng LAN — cả cảnh, macro và pad soundboard. Các nút lệnh cũng hiển thị trên bảng LAN.
quick-actions-cmd-transition = Chuyển cảnh
quick-actions-cmd-startStream = Phát trực tiếp
quick-actions-cmd-stopStream = Kết thúc phát
quick-actions-cmd-startRecording = Bắt đầu ghi
quick-actions-cmd-stopRecording = Dừng ghi
quick-actions-cmd-pauseRecording = Tạm dừng ghi
quick-actions-cmd-addMarker = Thêm điểm đánh dấu
quick-actions-cmd-armReplay = Bật phát lại
quick-actions-cmd-saveReplay = Lưu phát lại
quick-actions-cmd-setStudioMode = Bật/tắt chế độ Studio
quick-actions-cmd-scene = Chuyển sang cảnh…
quick-actions-cmd-macro = Chạy macro…
quick-actions-cmd-soundboard = Pad soundboard…
quick-actions-value-scene = Tên cảnh
quick-actions-value-macro = Tên macro
quick-actions-value-soundboard = ID pad
teleprompter-stop = Dừng
about-portable-on = Chế độ di động: bật — mọi dữ liệu ứng dụng được lưu ngay cạnh ứng dụng.
about-portable-off = Chế độ di động: tắt. Thêm một tệp "{ $marker }" cạnh ứng dụng để chạy hoàn toàn độc lập (chế độ USB).
about-portable-data = Thư mục dữ liệu: { $path }
...
studio-preview-stinger-matte-title = Cách một stinger track-matte đóng gói độ trong suốt: phần fill và matte của nó đặt cạnh nhau (ngang) hoặc xếp chồng (dọc)
studio-preview-stinger-duck-label = Duck chương trình
studio-preview-stinger-duck-title = Giảm (duck) âm thanh chương trình xuống dưới âm thanh riêng của stinger khi nó phát (0 = tắt)
...
transition-kind-move = Di chuyển (morph)

# --- stinger track-matte modes (rendered from STINGER_MATTES in api/types.ts) ---
stinger-matte-none = Không
stinger-matte-horizontal = Cạnh nhau
stinger-matte-vertical = Xếp chồng
...
history-toggleOutputVisibility = Bật/tắt hiển thị theo đầu ra
...
palette-featured-chat = Tin nhắn chat nổi bật…
featured-chat-title = Tin nhắn chat nổi bật
featured-chat-intro = Ghim một dòng chat gần đây làm banner dưới cùng của chương trình — người xem stream và bản ghi đều thấy. Ghim sẽ mất khi khởi động lại; màu sắc được giữ.
featured-chat-empty = Chưa có chat — thêm nguồn Chat Overlay và trỏ tới kênh của bạn; các dòng sẽ xuất hiện ở đây khi đến.
featured-chat-pinned = Trên chương trình:
featured-chat-pin = Ghim
featured-chat-clear = Bỏ ghim
featured-chat-bg = Màu banner
featured-chat-text = Màu chữ
featured-chat-note = Banner nằm ở giữa phía dưới, phía trên mọi cảnh — bỏ ghim để gỡ khỏi sóng.
...
properties-stats-show-timecode = Hiện mã thời gian (LTC)
...
sources-visualizer-classic = Màu cổ điển
...
menu-collection-clear = Xóa lịch sử…
menu-collection-clear-confirm = Xóa vĩnh viễn các bộ sưu tập cảnh này và tệp của chúng? { $names } — bộ sưu tập đang hoạt động "{ $active }" được giữ lại. Không thể hoàn tác.
...
whats-new-empty = Không có ghi chú phát hành cho phiên bản này.
filters-name-directional-blur = Làm mờ định hướng
filters-name-radial-blur = Làm mờ xuyên tâm
filters-name-zoom-blur = Làm mờ thu phóng
filters-name-pixelate = Điểm ảnh hóa
filters-angle = Góc (°)
filters-center-x = Tâm X
filters-center-y = Tâm Y
filters-block-size = Kích thước khối (px)
filters-name-freeze = Đóng băng
filters-freeze-hint = Khi bật, nguồn này giữ khung hình cuối cùng — chương trình, xem trước, ghi hình và phát trực tuyến đều đóng băng cùng nhau. Bật/tắt bộ lọc này để đóng băng hoặc bỏ đóng băng.
transform-3d = Nghiêng 3D
transform-rotation-x = Nghiêng X (°)
transform-rotation-y = Nghiêng Y (°)
transform-perspective = Phối cảnh
transform-reveal = Hiện/ẩn
transform-reveal-ms = Mờ dần khi hiện (ms)
sources-clone-title = Nhân bản (cùng nguồn, bộ lọc riêng)
sources-clone-item = Nhân bản { $name }
menu-tools-downstream = Keyer đầu ra…
menu-tools-transition-rules = Quy tắc chuyển cảnh…
dsk-title = Keyer đầu ra
dsk-hint = Các lớp phủ được ghép trên đầu ra chương trình — nằm trên mọi cảnh và giữ nguyên khi bạn chuyển cảnh (logo, huy hiệu TRỰC TIẾP, thanh chú thích dưới). Mục trên cùng của danh sách được vẽ trên cùng.
dsk-empty = Chưa có keyer — thêm một nguồn để phủ nó lên mọi cảnh.
dsk-enable = Bật keyer này
dsk-move-up = Di chuyển lên (trên cùng)
dsk-move-down = Di chuyển xuống
dsk-remove = Xóa keyer
dsk-opacity = Độ mờ
dsk-x = X (px)
dsk-y = Y (px)
dsk-scale = Tỷ lệ
dsk-add = + Thêm keyer
transition-rules-title = Quy tắc chuyển cảnh
transition-rules-hint = Gán cho một cặp cảnh chuyển cảnh riêng. Khi bạn chuyển từ cảnh đầu sang cảnh thứ hai, loại và thời lượng này được dùng thay cho mặc định (quy tắc Stinger/Ảnh vẫn dùng tệp đã đặt trong bảng điều khiển chuyển cảnh).
transition-rules-empty = Chưa có quy tắc — mỗi cặp cảnh dùng chuyển cảnh mặc định.
transition-rules-from = Từ
transition-rules-to = Đến
transition-rules-kind = Chuyển cảnh
transition-rules-duration = Thời lượng (ms)
transition-rules-add = Thêm quy tắc
transition-rules-remove = Xóa quy tắc

# --- Telestrator (CAP-N57) ---
telestrator-group = Telestrator
telestrator-draw = Vẽ
telestrator-tool-pen = Bút
telestrator-tool-highlight = Bút dạ quang
telestrator-tool-arrow = Mũi tên
telestrator-tool-ellipse = Hình elip
telestrator-color = Màu
telestrator-width = Độ dày
telestrator-whiteboard = Chế độ bảng trắng
telestrator-persist = Giữ
telestrator-fade = Mờ dần
telestrator-undo = Hoàn tác nét cuối
telestrator-clear = Xóa nét vẽ
hotkeys-telestrator-clear = Telestrator: xóa nét vẽ

# --- Teleprompter (CAP-N58) ---
teleprompter-title = Máy nhắc chữ
teleprompter-loading = Đang tải…
teleprompter-empty = Chưa có kịch bản — thêm một kịch bản trong bảng máy nhắc chữ.
teleprompter-script = Kịch bản
teleprompter-script-placeholder = Nhập hoặc dán kịch bản của bạn…
teleprompter-top = Đầu
teleprompter-slower = Chậm hơn
teleprompter-play = Phát
teleprompter-pause = Tạm dừng
teleprompter-faster = Nhanh hơn
teleprompter-step-back = Lùi lại
teleprompter-step-forward = Tiến tới
teleprompter-est-time = Thời gian đọc
teleprompter-caesura-hint = Nhập -- để tạm dừng
teleprompter-caesura-pause = Tạm dừng — Nhập -- để tạm dừng
teleprompter-countdown = Bắt đầu đếm ngược
teleprompter-countdown-secs = Đếm ngược (giây)
teleprompter-speed = Tốc độ (ký tự/giây)
teleprompter-speed-bpm = Tốc độ (BPM)
teleprompter-bpm-mode = Chế độ BPM (hát)
teleprompter-font = Cỡ chữ
teleprompter-mirror = Gương (kính)
teleprompter-open-projector = Mở máy chiếu
teleprompter-preview = Xem trước
teleprompter-remote-hint = Điều khiển cuộn bằng phím tắt, MIDI hoặc bảng LAN khi cửa sổ này đóng.
teleprompter-read-aloud = Đọc to bằng bộ tổng hợp giọng nói của hệ điều hành
menu-tools-teleprompter = Máy nhắc chữ
hotkeys-teleprompter-toggle = Máy nhắc chữ: phát / tạm dừng

# --- Remote guests: green room / cues / QoS / auto-grid (CAP-N54–N56, N59) ---
remote-hosting-count = Đang tổ chức { $count } khách
remote-green-room-default = Phòng chờ
remote-green-room-default-title = Khách mới đợi trong phòng chờ cho đến khi bạn cho lên hình
remote-auto-grid = Lưới tự động
remote-auto-grid-title = Giữ khách trong lưới khi họ vào và rời đi
remote-arrange-grid = Sắp lưới
remote-arrange-grid-title = Sắp lại các khách đang lên hình vào lưới ngay
remote-green-room-monitor = Xem trước phòng chờ
remote-tech-cam-ok = Cam ✓
remote-tech-cam-no = Không cam
remote-tech-mic-ok = Mic ✓
remote-tech-mic-no = Không mic
remote-seat-on-air = Cho lên sóng
remote-cues-label = Nhắc
remote-cue = Nhắc
remote-cue-thirty = 30 giây
remote-cue-wrap = Kết thúc đi
remote-cue-next = Sắp đến lượt bạn
remote-cue-speak = Nói to hơn
remote-qos-good = Kết nối tốt
remote-qos-fair = Kết nối trung bình
remote-qos-poor = Kết nối kém
remote-green-room-guest = Bạn đang ở phòng chờ — người dẫn sẽ cho bạn lên sóng ngay.

# --- Hotkey audit — Phase 7 actions ---
hotkey-audit-action-telestrator-clear = Telestrator: xóa nét vẽ
hotkey-audit-action-teleprompter-toggle = Máy nhắc chữ: phát / tạm dừng
hotkey-audit-feature-telestrator = Telestrator
hotkey-audit-feature-teleprompter = Máy nhắc chữ

# V1-C — Starting Soon countdown slate
sources-add-starting-soon = Sắp bắt đầu…
sources-starting-soon-title = Sắp bắt đầu
sources-starting-soon-default = Sắp bắt đầu
sources-starting-soon-message = Tin nhắn
sources-starting-soon-minutes = Phút
sources-starting-soon-hours = Giờ
sources-starting-soon-start-at = Bắt đầu lúc
sources-starting-soon-music = Nhạc nền…
sources-starting-soon-music-name = Nhạc nền
sources-starting-soon-background = Nền
sources-starting-soon-note = Bộ đếm ngược toàn màn hình nhấp nháy đỏ và dừng ở 0 — xóa nó và tự chuyển sang cảnh trực tiếp của bạn khi sẵn sàng.
sources-starting-soon-add = Thêm
sources-slate-solid = Màu đặc
sources-slate-gradient = Chuyển sắc
sources-slate-transparent = Trong suốt
sources-slate-image = Hình ảnh
sources-slate-file = Hình ảnh / Video / GIF
sources-slate-browse = Duyệt…
sources-starting-soon-choose-image = Chọn hình ảnh…
sources-slate-media-note = Ảnh tĩnh được nhúng tại đây. Để dùng video hoặc GIF lặp làm nền, chọn 'Trong suốt' và đặt Backdrop của cảnh (biểu tượng 🖼 trên thanh Cảnh) — đồng hồ đếm ngược nằm trên cùng.
properties-timer-slate = Bảng «Sắp bắt đầu»
properties-timer-slate-off = Tắt (văn bản nội dòng)
properties-timer-message = Tin nhắn
properties-timer-slate-color = Màu bảng
properties-timer-slate-from = Từ
properties-timer-slate-to = Đến
properties-timer-slate-note = Trong suốt cho phép hình ảnh, video hoặc nền cảnh bên dưới bảng hiện ra.
