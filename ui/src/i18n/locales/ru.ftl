...
sources-add-background-music = Фоновая музыка…
sources-background-music-note = Играет по кругу, слышна в предпросмотре и записывается/транслируется. Чтобы использовать музыку вместо звука видео, отключите дорожку Backdrop видео.
sources-background-music-count = { $n } треков
sources-background-music-shuffle = Перемешать
...
sources-stream-hide = Скрыть в стриме
sources-stream-show = Показать в стриме
sources-stream-hide-item = Скрыть { $name } в стриме
sources-stream-show-item = Показать { $name } в стриме
sources-record-hide = Скрыть в записи
sources-record-show = Показать в записи
sources-record-hide-item = Скрыть { $name } в записи
sources-record-show-item = Показать { $name } в записи
...
sources-game-accept = Принять риск и выбрать игру
sources-game-pick = Выберите окно игры для захвата. Подключение сохраняется только во время игры.
...
controls-iso-lanes = ISO-дорожки, записываемые вместе с программой: { $count }
...
ltc-badge = LTC
ltc-title = Тайм-код SMPTE (LTC)
ltc-intro = Генерируйте линейный тайм-код SMPTE на дорожке и читайте входящий LTC с любого аудиовхода — классический аудио-тайм-код для синхронизации внешних рекордеров и камер на постпродакшене. Полностью офлайн.
ltc-generate = Генерировать LTC на дорожку
ltc-track = Дорожка тайм-кода
ltc-track-option = Дорожка { $track }
ltc-fps = Частота кадров
ltc-read = Читать LTC из
ltc-read-off = Выкл.
ltc-decoded = Входящий тайм-код
ltc-no-lock = нет сигнала
ltc-note = Генератор синхронизируется со временем суток, без пропуска кадров. Запишите его дорожку (назначьте в настройках вывода) или направьте на выход для внешнего оборудования. Читатель питает строку тайм-кода в оверлее статистики и штампует маркеры глав.
...
stats-rehearsal-note = Репетиция — цели публикуют только в локальный приёмник
stats-timeline-open = Таймлайн
timeline-title = Таймлайн сессии
timeline-empty = Пока ничего не записано — таймлайн пишется, пока идёт стрим или запись.
timeline-live = LIVE — ещё записывается
timeline-fit = Вписать
timeline-legend-fps = fps
timeline-legend-behind = очередь кодера (кадров позади)
...
scenes-recent-title = Недавние
scenes-recent-clear = Очистить
scenes-recent-clear-confirm = Очистить список недавних сцен?
...
livebutton-rehearse = Репетиция
livebutton-rehearse-record-confirm = Записать эту репетицию также в видеофайл?
livebutton-rehearse-title = Прогнать всё шоу на локальный приёмник — ничего не отправляется
livebutton-end-rehearsal = Завершить репетицию
livebutton-title-rehearsing = Идёт репетиция — ничего не покидает этот компьютер
livebutton-badge-rehearsal = РЕПЕТИЦИЯ
livebutton-aria-rehearsal = Идёт репетиция
livebutton-rehearsal-banner = Репетиция — ничего не покидает этот компьютер
...
properties-timer-clock = Обратный отсчёт до времени
...
filters-name-perspective = Перспектива
filters-name-fade-loop = Цикл затухания
...
filters-tilt = Наклон
filters-far-fade = Затухание дальнего края
filters-fade-in-s = Появление (с)
filters-visible-s = Видим (с)
filters-fade-out-s = Исчезание (с)
filters-hidden-s = Скрыт (с)
...
recordings-trim = Обрезать
recordings-trim-title = Вырежьте клип из этой записи — срезы по ключевым кадрам экспортируются без перекодирования
recordings-verify = Проверить
recordings-verify-title = Проверка целостности файла — структура контейнера, непрерывность, чередование A/V, длительность
recordings-verifying = Проверка…
verify-dismiss = Закрыть
verify-verdict-pass = { $name } — целостность в порядке
verify-verdict-warn = { $name } — проверено с предупреждениями
verify-verdict-fail = { $name } — найдены проблемы
verify-container = Контейнер
verify-video-continuity = Непрерывность видео
verify-audio-continuity = Непрерывность аудио
verify-av-interleave = Чередование A/V
verify-duration = Длительность
recordings-alpha-label = альфа
recordings-prores-title = Экспортировать мастер .mov ProRes 4444 с сохранением альфы (для монтажа)
recordings-qtrle-title = Экспортировать .mov QuickTime Animation с сохранением альфы (максимальная совместимость)
trim-title = Обрезка — { $name }
trim-loading = Чтение файла…
trim-preview-alt = Кадр предпросмотра
trim-position = Позиция воспроизведения
trim-step-second-back = Секунда назад
trim-step-frame-back = Кадр назад
trim-step-frame-forward = Кадр вперёд
trim-step-second-forward = Секунда вперёд
trim-snap = Ключевой кадр
trim-snap-title = Привязать к ближайшему ключевому кадру — срез там экспортируется без перекодирования
trim-set-in = Точка входа
trim-set-out = Точка выхода
trim-range-invalid = Точка выхода должна идти после точки входа.
trim-copy-badge = ✓ Экспорт без перекодирования — точка входа лежит на ключевом кадре.
trim-reencode-badge = Будет перекодировано: точка входа между ключевыми кадрами (нажмите «Ключевой кадр» для среза без потерь).
trim-export = Экспортировать клип
trim-export-916 = 9:16
trim-export-916-title = Экспорт в вертикальном формате (центрированная обрезка под размер вертикального холста) — всегда перекодирует
...
bench-open = Запустить бенчмарк кодеров…
bench-title = Бенчмарк кодеров
bench-intro = Прогоняет короткие измеренные лесенки кодирования (каждый найденный кодер × пресет × разрешение) на этой машине — около минуты, полностью офлайн, ничего не покидает компьютер. Сбои перечисляются, а не скрываются. Сначала остановите стрим или запись.
bench-start = Начать бенчмарк
bench-rerun = Запустить снова
bench-running = Измерение… { $done } / { $total }
bench-cancel = Отмена
bench-col-encoder = Кодер
bench-col-preset = Пресет
bench-col-rung = Ступень
bench-col-achieved = fps
bench-col-headroom = Запас
bench-failed = сбой
bench-rec-title = Рекомендация (измеренная)
bench-rec-body = { $encoder } с { $preset }, { $width }×{ $height } @ { $fps } fps — измерено { $headroom }× реального времени. Рекомендуемый битрейт стрима: { $bitrate } кбит/с.
bench-rec-none = Ничто не держит реальное время на этой машине — уменьшите разрешение холста или fps и повторите.
bench-apply = Применить к настройкам записи
bench-applied = Применено ✓
...
output-iso-heading = ISO-запись
output-iso-explainer = Записывайте выбранные источники в чистом виде, каждый в свой файл рядом с программой — до композиции, в размере и частоте кадров холста, чтобы каждый файл ложился на монтажную шкалу выровненным. Две дорожки комфортны на GPU среднего класса; каждая дополнительная — ещё один рендер и кодирование.
output-iso-none = В коллекции пока нет источников.
output-iso-source-on = «{ $name }» записывается в собственный ISO-файл — нажмите, чтобы остановить
output-iso-source-off = Записывать «{ $name }» в собственный ISO-файл
output-iso-post-filter = Записывать с фильтрами источника (пост-фильтр); без галочки записывается необработанный источник
...
output-split-on-marker = маркере
output-split-on-rundown = шаге сценария
output-auto-markers = Автоматически ставить маркеры глав на событиях студии (смена сцены, сохранение повтора, переподключение, потерянные кадры, тревоги, правила)
output-auto-markers-title = Типизированные маркеры попадают в главы записи (mkv) или файл .chapters.txt, рядом с ручной горячей клавишей
output-pipeline-heading = Конвейер после записи
output-pipeline-explainer = После финализации записи эти шаги выполняются над основным файлом по порядку в фоне. Закрытый набор действий — шага «выполнить команду» нет намеренно. Цепочка останавливается на первой ошибке.
output-pipeline-enabled = Запускать конвейер после каждой записи
output-pipeline-add = Добавить шаг…
output-pipeline-up = Вверх
output-pipeline-down = Вниз
output-pipeline-remove = Удалить шаг
output-pipeline-template = Шаблон переименования (токены CAP-M25)
output-pipeline-folder = Папка
pipeline-queue = Конвейер после записи
pipeline-verify = Проверить
pipeline-remux = Ремукс в MP4
pipeline-normalize = Нормализовать громкость
pipeline-rename = Переименовать
pipeline-move = Переместить в папку
pipeline-copy = Скопировать в папку
pipeline-reveal = Показать в файловом менеджере
pipeline-luaEvent = Уведомить скрипты Lua
...
stream-session-report = По окончании сессии записывать отчёт (HTML + Markdown) рядом с записью
stream-simulator-title = Симулятор сети (репетиции)
stream-simulator-note = Формирует только локальные приёмники репетиции — отрабатывает переподключения и слабый аплинк. Настоящий эфир никогда не деградирует.
stream-simulator-profile = Профиль
stream-simulator-off = Выкл
stream-simulator-hotel-wifi = Отельный Wi-Fi
stream-simulator-mobile-hotspot = Мобильная точка доступа
stream-simulator-custom = Свой
stream-simulator-bandwidth = Полоса (кбит/с, 0 = без лимита)
stream-simulator-latency = Задержка (мс)
stream-simulator-jitter = Джиттер (± мс)
stream-simulator-outage-every = Обрыв каждые (с, 0 = никогда)
stream-simulator-outage-len = Длительность обрыва (с)
...
workspace-pack-title = Пакет коллекции сцен
workspace-pack-export = Экспортировать пакет…
workspace-pack-exporting = Экспорт…
workspace-pack-import = Импортировать пакет…
workspace-pack-importing = Импорт…
workspace-pack-hint = Файл .fcappack упаковывает активную коллекцию вместе с её локальными ресурсами в один переносимый файл — поделитесь целым макетом без сервера. Импорт добавляет его как новую коллекцию и переключается на неё.
workspace-pack-exported = «{ $name }» экспортировано — упаковано ресурсов: { $bundled }, внешних: { $external }.
workspace-pack-imported = «{ $name }» импортировано — сцен: { $scenes }, повторно связано ресурсов: { $relinked }, внешних: { $external }.
workspace-compare = Сравнить и объединить…
compare-title = Сравнить и объединить
compare-intro = Сравните активную коллекцию с другой и перенесите только выбранные изменения. Ничто не покидает этот компьютер.
compare-target-label = Сравнить с
compare-target-none = Выберите коллекцию…
compare-target-pack = Из файла пакета…
compare-against = против { $name }
compare-comparing = Сравнение…
compare-no-diff = Различий нет — коллекции совпадают.
compare-select-all = Выбрать все
compare-clear = Очистить
compare-merge-hint = Выбор сцены также переносит используемые ею источники.
compare-sources-title = Источники
compare-scenes-title = Сцены
compare-kind-added = Добавлено
compare-kind-removed = Удалено
compare-kind-modified = Изменено
compare-renamed = было «{ $from }»
compare-reordered = переупорядочено
compare-apply = Применить { $count }
compare-apply-none = Выберите изменения для применения
compare-applying = Применение…
compare-aspect-source = источник
compare-aspect-transform = позиция
compare-aspect-visibility = видимость
compare-aspect-outputs = выходы
compare-aspect-filters = фильтры
compare-aspect-lock = блокировка
compare-aspect-blend = смешивание
compare-aspect-scaling = масштабирование
compare-aspect-backdrop = фон
compare-aspect-reveal = проявление
compare-aspect-name = имя
compare-aspect-settings = настройки
compare-aspect-audio = звук
workspace-snapshots = Снимки…
snapshots-title = Снимки
snapshots-intro = Именованные контрольные точки этой коллекции, к которым можно вернуться — сохраняются намеренно, помимо автосохранения и отмены. Хранятся локально.
snapshots-name-placeholder = Назовите эту контрольную точку…
snapshots-create = Сохранить снимок
snapshots-empty = Пока нет снимков — сохраните один, чтобы оставить именованную контрольную точку, к которой можно вернуться.
snapshots-usage = { $count } из { $cap } сохранено · { $size }
snapshots-scenes = сцен: { $scenes } · источников: { $sources }
snapshots-restore = Восстановить
snapshots-compare = Сравнить
snapshots-delete = Удалить снимок
snapshots-delete-aria = Удалить снимок «{ $name }»
snapshots-restore-confirm = Восстановить этот снимок? Текущий макет сначала сохраняется как снимок.

# --- Phase 8 (backup / theme editor / dock presets / settings search / quick actions) ---
workspace-backup = Резервная копия и восстановление…
backup-title = Резервная копия и восстановление
backup-intro = Сохраните всю студию — настройки, профили, коллекции сцен — в один файл и восстановите её здесь или на новой машине.
backup-export = Экспортировать резервную копию…
backup-exporting = Экспорт…
backup-exported = Сохранено коллекций: { $collections }, профилей: { $profiles } ({ $size }).
backup-restore = Восстановить из резервной копии…
backup-secrets-note = Ключи трансляции и пароли никогда не включаются в резервную копию — введите их заново после восстановления.
backup-restore-from = Резервная копия создана { $created } (v{ $version })
backup-restore-settings = Настройки
backup-restore-collections = Коллекции сцен ({ $count })
backup-restore-profiles = Профили ({ $count })
backup-restore-apply = Восстановить выбранное
backup-restoring = Восстановление…
backup-restored = Восстановлено.
backup-restart-note = Перезапустите Freally Capture, чтобы загрузить восстановленные коллекции и профили.
backup-cancel = Отмена
theme-editor-title = Пользовательская палитра
theme-color-bg = Фон
theme-color-panel = Панель
theme-color-text = Текст
theme-color-muted = Приглушённый
theme-color-accent = Акцент
theme-color-accent2 = Акцент 2
theme-contrast-text-bg = Текст на фоне
theme-contrast-text-panel = Текст на панели
theme-contrast-muted-bg = Приглушённый на фоне
theme-contrast-accent-bg = Акцент на фоне
theme-contrast-low = (цель ≥ { $min }:1)
theme-reset = Сбросить на тёмную
theme-export = Экспорт .fctheme…
theme-import = Импорт .fctheme…
workspace-dock-presets = Макеты панелей
workspace-dock-preset-placeholder = Сохранить текущий макет как…
workspace-dock-preset-save = Сохранить
workspace-dock-preset-apply = Переключиться на «{ $name }»
workspace-dock-preset-delete = Удалить макет «{ $name }»
workspace-dock-presets-hint = Макет запоминает панель статистики и ориентацию микшера. Нажмите на макет, чтобы переключиться на него.
...
menu-tools-quick-actions = Быстрые действия…
menu-tools-featured-chat = Избранное сообщение чата…
quick-actions-title = Быстрые действия
quick-actions-empty = Пока нет кнопок — нажмите «Изменить», чтобы добавить.
quick-actions-edit = Изменить
quick-actions-done = Готово
quick-actions-add-page = Страница
quick-actions-label = Подпись кнопки
quick-actions-color = Цвет кнопки
quick-actions-add = Добавить кнопку
quick-actions-remove = Удалить «{ $name }»
quick-actions-delete-page = Удалить «{ $name }»
quick-actions-hint = Кнопки запускают те же команды студии, что и горячие клавиши и панель LAN — сцены, макросы и пэды саундборда тоже. Командные кнопки также отображаются на панели LAN.
quick-actions-cmd-transition = Переход
quick-actions-cmd-startStream = В эфир
quick-actions-cmd-stopStream = Завершить трансляцию
quick-actions-cmd-startRecording = Начать запись
quick-actions-cmd-stopRecording = Остановить запись
quick-actions-cmd-pauseRecording = Приостановить запись
quick-actions-cmd-addMarker = Добавить маркер
quick-actions-cmd-armReplay = Включить повтор
quick-actions-cmd-saveReplay = Сохранить повтор
quick-actions-cmd-setStudioMode = Переключить студийный режим
quick-actions-cmd-scene = Переключиться на сцену…
quick-actions-cmd-macro = Запустить макрос…
quick-actions-cmd-soundboard = Пэд саундборда…
quick-actions-value-scene = Название сцены
quick-actions-value-macro = Название макроса
quick-actions-value-soundboard = ID пэда
teleprompter-stop = Стоп
about-portable-on = Портативный режим: включён — все данные приложения хранятся рядом с приложением.
about-portable-off = Портативный режим: выключен. Добавьте файл «{ $marker }» рядом с приложением, чтобы запускать его полностью автономно (режим USB-накопителя).
about-portable-data = Папка данных: { $path }
...
history-toggleOutputVisibility = Переключить видимость на выходах
...
palette-featured-chat = Избранное сообщение чата…
featured-chat-title = Избранное сообщение чата
featured-chat-intro = Закрепите любую недавнюю строку чата как баннер внизу программы — зрители трансляции и записи его увидят. Закрепление сбрасывается при перезапуске; цвета сохраняются.
featured-chat-empty = Чата пока нет — добавьте источник «Оверлей чата» и укажите свой канал; строки появятся здесь по мере поступления.
featured-chat-pinned = В программе:
featured-chat-pin = Закрепить
featured-chat-clear = Убрать
featured-chat-bg = Цвет баннера
featured-chat-text = Цвет текста
featured-chat-note = Баннер находится внизу по центру, поверх всех сцен — уберите его, чтобы снять с эфира.
...
properties-stats-show-timecode = Показывать тайм-код (LTC)
...
sources-visualizer-classic = Классические цвета
...
menu-collection-clear = Очистить историю…
menu-collection-clear-confirm = Безвозвратно удалить эти коллекции сцен и их файлы? { $names } — активная коллекция «{ $active }» будет сохранена. Это действие нельзя отменить.
...
# --- Telestrator (CAP-N57) ---
telestrator-group = Телестратор
telestrator-draw = Рисовать
telestrator-tool-pen = Ручка
telestrator-tool-highlight = Маркер
telestrator-tool-arrow = Стрелка
telestrator-tool-ellipse = Эллипс
telestrator-color = Цвет
telestrator-width = Толщина
telestrator-whiteboard = Режим доски
telestrator-persist = Оставить
telestrator-fade = Исчезание
telestrator-undo = Отменить последнюю метку
telestrator-clear = Очистить метки
hotkeys-telestrator-clear = Телестратор: очистить метки

# --- Teleprompter (CAP-N58) ---
teleprompter-title = Телесуфлёр
teleprompter-loading = Загрузка…
teleprompter-empty = Сценария пока нет — добавьте его в панели телесуфлёра.
teleprompter-script = Сценарий
teleprompter-script-placeholder = Введите или вставьте сценарий…
teleprompter-top = В начало
teleprompter-slower = Медленнее
teleprompter-play = Пуск
teleprompter-pause = Пауза
teleprompter-faster = Быстрее
teleprompter-step-back = Шаг назад
teleprompter-step-forward = Шаг вперёд
teleprompter-est-time = Время чтения
teleprompter-caesura-hint = Введите -- для паузы
teleprompter-caesura-pause = Пауза цезуры — Введите -- для паузы
teleprompter-countdown = Запустить обратный отсчёт
teleprompter-countdown-secs = Обратный отсчёт (секунды)
teleprompter-speed = Скорость (символов/с)
teleprompter-speed-bpm = Скорость (BPM)
teleprompter-bpm-mode = Режим BPM (пение)
teleprompter-font = Размер шрифта
teleprompter-mirror = Зеркало (стекло)
teleprompter-open-projector = Открыть проектор
teleprompter-preview = Предпросмотр
teleprompter-remote-hint = Управляйте прокруткой горячей клавишей, MIDI или LAN-панелью, пока это окно закрыто.
teleprompter-read-aloud = Читать вслух средствами синтеза речи ОС
menu-tools-teleprompter = Телесуфлёр
hotkeys-teleprompter-toggle = Телесуфлёр: пуск / пауза

# --- Remote guests: green room / cues / QoS / auto-grid (CAP-N54–N56, N59) ---
remote-hosting-count = Подключено гостей: { $count }
remote-green-room-default = Комната ожидания
remote-green-room-default-title = Новые гости ждут в комнате ожидания, пока вы их не выведете
remote-auto-grid = Автосетка
remote-auto-grid-title = Держать гостей в сетке по мере входа и выхода
remote-arrange-grid = Расставить сетку
remote-arrange-grid-title = Перестроить выведенных гостей в сетку сейчас
remote-green-room-monitor = Просмотр комнаты ожидания
remote-tech-cam-ok = Камера ✓
remote-tech-cam-no = Нет камеры
remote-tech-mic-ok = Микрофон ✓
remote-tech-mic-no = Нет микрофона
remote-seat-on-air = Вывести в эфир
remote-cues-label = Сигналы
remote-cue = Сигнал
remote-cue-thirty = 30 секунд
remote-cue-wrap = Завершайте
remote-cue-next = Вы следующий
remote-cue-speak = Говорите громче
remote-qos-good = Связь хорошая
remote-qos-fair = Связь средняя
remote-qos-poor = Связь плохая
remote-green-room-guest = Вы в комнате ожидания — ведущий скоро выведет вас в эфир.

# --- Hotkey audit — Phase 7 actions ---
hotkey-audit-action-telestrator-clear = Телестратор: очистить метки
hotkey-audit-action-teleprompter-toggle = Телесуфлёр: пуск / пауза
hotkey-audit-feature-telestrator = Телестратор
hotkey-audit-feature-teleprompter = Телесуфлёр

# V1-C — Starting Soon countdown slate
sources-add-starting-soon = Скоро начнём…
sources-starting-soon-title = Скоро начнём
sources-starting-soon-default = Скоро начнём
sources-starting-soon-message = Сообщение
sources-starting-soon-minutes = Минуты
sources-starting-soon-hours = Часы
sources-starting-soon-start-at = Начало в
sources-starting-soon-music = Фоновая музыка…
sources-starting-soon-music-name = Фоновая музыка
sources-starting-soon-background = Фон
sources-starting-soon-note = Полноэкранный обратный отсчёт, который на нуле мигает красным и останавливается — очистите его и вручную переключитесь на свою прямую сцену, когда будете готовы.
sources-starting-soon-add = Добавить
sources-slate-solid = Сплошной цвет
sources-slate-gradient = Градиент
sources-slate-transparent = Прозрачный
sources-slate-image = Изображение
sources-slate-file = Изображение / Видео / GIF
sources-slate-browse = Обзор…
sources-starting-soon-choose-image = Выбрать изображение…
sources-slate-media-note = Статичные изображения встраиваются здесь. Для зацикленного видео или GIF в качестве фона выберите «Прозрачный» и задайте фон сцены (🖼 на панели сцен) — обратный отсчёт будет поверх.
properties-timer-slate = Заставка «Скоро начнём»
properties-timer-slate-off = Выкл. (обычный текст)
properties-timer-message = Сообщение
properties-timer-slate-color = Цвет заставки
properties-timer-slate-from = От
properties-timer-slate-to = До
properties-timer-slate-note = Прозрачность позволяет просвечивать изображению, видео или фону сцены под заставкой.
...
sources-browser-component-missing = Требуется компонент Browser Runtime — установите его в разделе Инструменты → Компоненты.
