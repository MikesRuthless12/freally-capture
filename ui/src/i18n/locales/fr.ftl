...
controls-automation = Automatisation
...
hotkeys-split-placeholder = ex. Numpad1
...
hotkeys-playlist-placeholder = ex. Ctrl+Alt+Right
...
hotkeys-replay-roll-placeholder = ex. Ctrl+Shift+I
