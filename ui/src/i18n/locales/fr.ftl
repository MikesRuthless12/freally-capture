...
sources-add-background-music = Musique de fond…
sources-background-music-note = Joue en boucle, audible dans l'aperçu et enregistré/diffusé. Pour utiliser la musique au lieu du son d'une vidéo, coupez la piste Backdrop de la vidéo.
sources-background-music-count = { $n } pistes
sources-background-music-shuffle = Aléatoire
...
sources-stream-hide = Masquer sur le stream
sources-stream-show = Afficher sur le stream
sources-stream-hide-item = Masquer { $name } sur le stream
sources-stream-show-item = Afficher { $name } sur le stream
sources-record-hide = Masquer dans l'enregistrement
sources-record-show = Afficher dans l'enregistrement
sources-record-hide-item = Masquer { $name } dans l'enregistrement
sources-record-show-item = Afficher { $name } dans l'enregistrement
...
sources-game-accept = Accepter le risque et choisir un jeu
sources-game-pick = Choisissez la fenêtre du jeu à capturer. Elle reste accrochée seulement pendant que vous jouez.
...
controls-iso-lanes = Pistes ISO enregistrées en parallèle du programme : { $count }
...
mixer-routing = Routage
mixer-routing-title = Routage de la sortie audio

# --- RoutingMatrixDialog.tsx (CAP-N30) ---
routing-title = Routage audio
routing-intro = Affectez les tranches aux bus de pistes, puis envoyez n'importe quel bus vers une sortie physique — une alimentation pour un enregistreur matériel, des enceintes dans une autre pièce ou un retour casque sur une piste libre. Le monitoring conserve son propre périphérique ; ces routages s'ajoutent par-dessus, donc sans aucun défini le mixage reste inchangé.
routing-sends-title = Envois vers les pistes
routing-no-strips = Aucune source audio dans cette scène.
routing-source = Source
routing-track = Piste { $n }
routing-send-aria = Envoyer { $source } vers la piste { $n }
routing-outputs-title = Sorties physiques
routing-master = Master
routing-off = Désactivé
routing-default-output = Sortie par défaut
routing-device-aria = Périphérique de sortie pour { $bus }
routing-trim-aria = Trim de sortie pour { $bus }
routing-trim-db = { $db } dB
routing-muted = Muet
routing-device-error = Périphérique indisponible

# --- DuckingMatrixDialog.tsx (CAP-N31) ---
mixer-ducking = Ducking
mixer-ducking-title = Matrice de ducking
ducking-title = Matrice de ducking
ducking-intro = Chaque source peut atténuer toutes les autres. Une cellule abaisse la cible (colonne) dès que le déclencheur (ligne) parle — choisissez une cellule pour régler sa profondeur, son seuil et son timing. Chaque paire est son propre ducking, donc une tranche peut être atténuée par plusieurs déclencheurs à la fois.
ducking-need-two = Ajoutez au moins deux sources audio pour les atténuer l'une par l'autre.
ducking-trigger-target = Déclencheur ↓ / Cible →
ducking-cell-aria = { $trigger } atténue { $target }
ducking-pair = { $trigger } → { $target }
ducking-remove = Retirer
ducking-amount = Quantité
ducking-threshold = Seuil
ducking-attack = Attaque
ducking-release = Relâchement
ducking-unit-db = dB
ducking-unit-ms = ms

# --- Loudness normalization (CAP-N34) ---
loudness-title = Normalisation du loudness
loudness-intro = Amène progressivement le programme vers une cible de loudness avec un plafond de crête, pour que votre flux et vos enregistrements atteignent un niveau constant. Lent et doux — il guide, sans jamais pomper.
loudness-enable = Amener le programme à la cible
loudness-target = Cible
loudness-target-option = { $target } LUFS
loudness-ceiling = Plafond de crête (dBFS)
loudness-note = −14 LUFS convient à une lecture de type YouTube ; −16 est une cible de streaming courante ; −23 correspond à la diffusion EBU R128. La même cible est utilisée par l'action Normaliser après l'enregistrement.
ltc-badge = LTC
ltc-title = Timecode SMPTE (LTC)
ltc-intro = Génère un timecode linéaire SMPTE sur une piste et lis le LTC entrant depuis n'importe quelle entrée audio — timecode audio classique pour synchroniser enregistreurs et caméras externes en post. Entièrement hors ligne.
ltc-generate = Générer le LTC sur une piste
ltc-track = Piste de timecode
ltc-track-option = Piste { $track }
ltc-fps = Cadence
ltc-read = Lire le LTC depuis
ltc-read-off = Désactivé
ltc-decoded = Timecode entrant
ltc-no-lock = aucun signal
ltc-note = Le générateur se cale sur l'heure du jour, non-drop. Enregistre sa piste (assignez-la dans les réglages de sortie) ou routez-la vers une sortie pour alimenter du matériel externe. Le lecteur alimente la ligne de timecode de l'overlay de stats et horodate les marqueurs de chapitre.
loudness-on = LUFS { $target }
loudness-off = Norm. désactivée
...
soundboard-stop-all = Tout arrêter
soundboard-edit = Modifier
soundboard-empty = Aucun pad pour l'instant — ajoutez-en un et attribuez-lui un clip audio local.
soundboard-new-pad = Nouveau pad
soundboard-no-clip = Aucun clip
soundboard-audio-files = Fichiers audio
soundboard-name = Nom
soundboard-choose-clip = Choisir un clip…
soundboard-gain = Gain
soundboard-choke = Choke
soundboard-choke-none = Aucun
soundboard-loop = Boucle
soundboard-auto-duck = Auto-ducking
soundboard-tracks = Pistes
soundboard-hotkey = Raccourci
soundboard-hotkey-placeholder = ex. Ctrl+Shift+1
soundboard-remove = Retirer

# --- PluginsDialog.tsx (CAP-N33) ---
mixer-plugins = Plugins
mixer-plugins-title = Plugins audio (CLAP / VST3)
plugins-title = Plugins audio
plugins-scanning = Recherche…
plugins-none = Aucun plugin CLAP ou VST3 trouvé dans les dossiers standard.
...
stats-disk-left = Enr. restant
stats-disk-rate = ≈ { $rate } Mo/s enregistrement
stats-vertical-fps = FPS 9:16
stats-targets-label = Cibles de diffusion
stats-rehearsal-note = Répétition — les cibles publient vers un récepteur local uniquement
stats-timeline-open = Chronologie
timeline-title = Chronologie de la session
timeline-empty = Rien d'enregistré pour l'instant — la chronologie s'enregistre pendant le stream ou l'enregistrement.
timeline-live = EN DIRECT — enregistrement en cours
timeline-fit = Ajuster
timeline-legend-fps = fps
timeline-legend-behind = file de l'encodeur (images de retard)
...
scenes-recent-title = Récentes
scenes-recent-clear = Effacer
scenes-recent-clear-confirm = Effacer la liste des scènes récentes ?
...
channelstrip-automix-label = Auto-mix (partage de gain)
channelstrip-automix-note = Partage de gain : le mixeur maintient stable le niveau combiné de toutes les tranches en auto-mix et le confie à celui qui parle — idéal pour les panels multi-micros et les podcasts. Inactif tant que vous n'avez pas ajouté de tranche.
channelstrip-mix-minus-label = Mix-minus (N−1)
channelstrip-mix-minus-note = Produit un retour sans écho pour cette source — tout le monde dans le programme sauf cette source elle-même. Utilisez-le pour un invité distant afin qu'il n'entende pas sa propre voix retardée.
...
livebutton-rehearse = Répéter
livebutton-rehearse-record-confirm = Enregistrer aussi cette répétition dans un fichier vidéo ?
livebutton-rehearse-title = Jouer tout le show vers un récepteur local — rien n'est envoyé
livebutton-end-rehearsal = Terminer la répétition
livebutton-title-rehearsing = Une répétition est en cours — rien ne quitte cette machine
livebutton-badge-rehearsal = RÉPÉTITION
livebutton-aria-rehearsal = Répétition en cours
livebutton-rehearsal-banner = Répétition — rien ne quitte cette machine
...
properties-timer-clock = Compte à rebours jusqu'à une heure
...
audiofilters-name-parametric-eq = Égaliseur paramétrique
audiofilters-name-de-esser = Dé-esseur
audiofilters-name-rumble-guard = Filtre anti-rumble
# --- Voice-chain presets (CAP-N39) ---
audiofilters-voice-preset = Préréglage
audiofilters-voice-preset-pick = Préréglage voix…
audiofilters-voice-broadcast = Voix broadcast
audiofilters-voice-podcast = Voix podcast
audiofilters-voice-clean = Voix nette
audiofilters-voice-none = Vider la chaîne
# --- De-esser + rumble guard params (CAP-N36) ---
audiofilters-deesser-freq = Fréquence de sibilance (Hz)
audiofilters-deesser-amount = Réduction max (dB)
audiofilters-rumble-freq = Coupe-bas (Hz)
audiofilters-title = Filtres audio — { $name }

# --- ParametricEqEditor.tsx (CAP-N35) ---
eq-graph-aria = Courbe de réponse de l'égaliseur paramétrique avec spectre en direct
eq-band-type = Type
eq-freq = Hz
eq-gain = dB
eq-q = Q
eq-add-band = + Bande
eq-remove-band = Supprimer la bande
eq-type-bell = Cloche
eq-type-lowShelf = Plateau bas
eq-type-highShelf = Plateau haut
eq-type-notch = Notch
eq-type-highPass = Passe-haut
eq-type-lowPass = Passe-bas
...
filters-name-perspective = Perspective
filters-name-fade-loop = Boucle de fondu
...
filters-tilt = Inclinaison
filters-far-fade = Fondu du bord lointain
filters-fade-in-s = Fondu d'entrée (s)
filters-visible-s = Visible (s)
filters-fade-out-s = Fondu de sortie (s)
filters-hidden-s = Masqué (s)
...
recordings-trim = Rogner
recordings-trim-title = Découpe un extrait de cet enregistrement — les coupes alignées sur les images clés s'exportent sans réencodage
recordings-verify = Vérifier
recordings-verify-title = Vérifie l'intégrité du fichier — structure du conteneur, continuité, entrelacement A/V, durée
recordings-verifying = Vérification…
verify-dismiss = Fermer
verify-verdict-pass = { $name } — intégrité OK
verify-verdict-warn = { $name } — vérifié avec des avertissements
verify-verdict-fail = { $name } — problèmes détectés
verify-container = Conteneur
verify-video-continuity = Continuité vidéo
verify-audio-continuity = Continuité audio
verify-av-interleave = Entrelacement A/V
verify-duration = Durée
recordings-alpha-label = alpha
recordings-prores-title = Exporter un master .mov ProRes 4444 préservant l'alpha (pour le montage)
recordings-qtrle-title = Exporter un .mov QuickTime Animation préservant l'alpha (compatibilité maximale)
trim-title = Rogner — { $name }
trim-loading = Lecture du fichier…
trim-preview-alt = Image d'aperçu
trim-position = Position de lecture
trim-step-second-back = Reculer d'une seconde
trim-step-frame-back = Reculer d'une image
trim-step-frame-forward = Avancer d'une image
trim-step-second-forward = Avancer d'une seconde
trim-snap = Image clé
trim-snap-title = Caler sur l'image clé la plus proche — une coupe à cet endroit s'exporte sans réencodage
trim-set-in = Point d'entrée
trim-set-out = Point de sortie
trim-range-invalid = Le point de sortie doit venir après le point d'entrée.
trim-copy-badge = ✓ Export sans réencodage — le point d'entrée tombe sur une image clé.
trim-reencode-badge = Sera réencodé : le point d'entrée est entre deux images clés (utilisez « Image clé » pour une coupe sans perte).
trim-export = Exporter l'extrait
trim-export-916 = 9:16
trim-export-916-title = Exporter en vertical recadré (recadrage centré à la taille du canevas vertical) — réencode toujours
...
recordings-normalize = Normaliser
recordings-normalizing = Normalisation…
recordings-normalize-title = Normaliser le loudness vers la cible (écrit une copie)
recordings-normalized-to = Normalisé vers { $path }

# --- Audio-only recording (CAP-N38) ---
audiorec-title = Audio uniquement
audiorec-format = Format d'enregistrement audio
audiorec-format-wav = WAV
audiorec-format-flac = FLAC
audiorec-format-opus = Opus
audiorec-start = Enregistrer l'audio
audiorec-stop = Arrêter
audiorec-pause = Pause
audiorec-resume = Reprendre
audiorec-recording = REC { $sec }s
audiorec-saved = { $count } fichier(s) de piste enregistré(s)
...
bench-open = Lancer le benchmark d'encodeurs…
bench-title = Benchmark d'encodeurs
bench-intro = Exécute de courtes échelles d'encodage mesurées (chaque encodeur détecté × préréglage × résolution) sur cette machine — environ une minute, entièrement hors ligne, rien ne quitte l'ordinateur. Les échecs sont listés, jamais cachés. Arrêtez d'abord tout stream ou enregistrement.
bench-start = Démarrer le benchmark
bench-rerun = Relancer
bench-running = Mesure… { $done } / { $total }
bench-cancel = Annuler
bench-col-encoder = Encodeur
bench-col-preset = Préréglage
bench-col-rung = Palier
bench-col-achieved = fps
bench-col-headroom = Marge
bench-failed = échec
bench-rec-title = Recommandation (mesurée)
bench-rec-body = { $encoder } en { $preset }, { $width }×{ $height } @ { $fps } fps — mesuré { $headroom }× temps réel. Bitrate de stream suggéré : { $bitrate } kbps.
bench-rec-none = Rien ne tient le temps réel sur cette machine — baissez la résolution du canevas ou les fps et relancez.
bench-apply = Appliquer aux réglages d'enregistrement
bench-applied = Appliqué ✓
...
output-iso-heading = Enregistrement ISO
output-iso-explainer = Enregistre les sources sélectionnées « propres », chacune dans son propre fichier à côté du programme — avant composition, à la taille et à la cadence du canevas, pour que chaque fichier tombe aligné sur la timeline de montage. Deux pistes passent bien sur un GPU de milieu de gamme ; chaque piste supplémentaire coûte un rendu et un encodage de plus.
output-iso-none = Aucune source dans la collection pour l'instant.
output-iso-source-on = « { $name } » est enregistrée dans son propre fichier ISO — cliquer pour arrêter
output-iso-source-off = Enregistrer « { $name } » dans son propre fichier ISO
output-iso-post-filter = Enregistrer avec les filtres de la source (post-filtre) ; décoché, la source brute est enregistrée
...
output-split-on-marker = marqueur
output-split-on-rundown = étape du conducteur
output-auto-markers = Poser automatiquement des marqueurs de chapitre sur les événements du studio (changement de scène, replay sauvegardé, reconnexion, images perdues, alarmes, règles)
output-auto-markers-title = Les marqueurs typés atterrissent dans les chapitres de l'enregistrement (mkv) ou le fichier .chapters.txt, à côté du raccourci manuel
output-pipeline-heading = Chaîne post-enregistrement
output-pipeline-explainer = À la fin d'un enregistrement, exécute ces étapes sur le fichier principal, dans l'ordre, en arrière-plan. Un jeu d'actions fermé — pas d'étape « exécuter une commande », par conception. La chaîne s'arrête au premier échec.
output-pipeline-enabled = Exécuter la chaîne après chaque enregistrement
output-pipeline-add = Ajouter une étape…
output-pipeline-up = Monter
output-pipeline-down = Descendre
output-pipeline-remove = Retirer l'étape
output-pipeline-template = Modèle de renommage (jetons CAP-M25)
output-pipeline-folder = Dossier
pipeline-queue = Chaîne post-enregistrement
pipeline-verify = Vérifier
pipeline-remux = Remuxer en MP4
pipeline-normalize = Normaliser le niveau sonore
pipeline-rename = Renommer
pipeline-move = Déplacer vers un dossier
pipeline-copy = Copier vers un dossier
pipeline-reveal = Afficher dans le gestionnaire de fichiers
pipeline-luaEvent = Notifier les scripts Lua
...
stream-session-report = Écrire un rapport de session (HTML + Markdown) à côté de l'enregistrement à la fin
stream-simulator-title = Simulateur réseau (répétitions)
stream-simulator-note = Ne façonne que les récepteurs locaux de la répétition — entraîne reconnexions et liaisons faibles. Un vrai Go Live n'est jamais dégradé.
stream-simulator-profile = Profil
stream-simulator-off = Désactivé
stream-simulator-hotel-wifi = Wi-Fi d'hôtel
stream-simulator-mobile-hotspot = Partage de connexion
stream-simulator-custom = Personnalisé
stream-simulator-bandwidth = Bande passante (kbps, 0 = illimitée)
stream-simulator-latency = Latence (ms)
stream-simulator-jitter = Gigue (± ms)
stream-simulator-outage-every = Coupure toutes les (s, 0 = jamais)
stream-simulator-outage-len = Durée de coupure (s)
...
workspace-pack-title = Pack de collection de scènes
workspace-pack-export = Exporter le pack…
workspace-pack-exporting = Exportation…
workspace-pack-import = Importer un pack…
workspace-pack-importing = Importation…
workspace-pack-hint = Un .fcappack regroupe la collection active et ses ressources locales dans un seul fichier portable — partagez une mise en page entière, sans serveur. L'import le pose comme une nouvelle collection et bascule dessus.
workspace-pack-exported = « { $name } » exportée — { $bundled } ressource(s) incluse(s), { $external } externe(s).
workspace-pack-imported = « { $name } » importée — { $scenes } scène(s), { $relinked } ressource(s) reliée(s) à nouveau, { $external } externe(s).
workspace-compare = Comparer et fusionner…
compare-title = Comparer et fusionner
compare-intro = Comparez la collection active à une autre et n'importez que les changements que vous choisissez. Rien ne quitte cette machine.
compare-target-label = Comparer avec
compare-target-none = Choisir une collection…
compare-target-pack = Depuis un fichier de pack…
compare-against = vs { $name }
compare-comparing = Comparaison…
compare-no-diff = Aucune différence — les collections sont identiques.
compare-select-all = Tout sélectionner
compare-clear = Effacer
compare-merge-hint = Choisir une scène importe aussi les sources qu'elle utilise.
compare-sources-title = Sources
compare-scenes-title = Scènes
compare-kind-added = Ajouté
compare-kind-removed = Supprimé
compare-kind-modified = Modifié
compare-renamed = était « { $from } »
compare-reordered = réempilé
compare-apply = Appliquer { $count }
compare-apply-none = Sélectionnez des changements à appliquer
compare-applying = Application…
compare-aspect-source = source
compare-aspect-transform = position
compare-aspect-visibility = visibilité
compare-aspect-outputs = sorties
compare-aspect-filters = filtres
compare-aspect-lock = verrou
compare-aspect-blend = fusion
compare-aspect-scaling = mise à l'échelle
compare-aspect-backdrop = arrière-plan
compare-aspect-reveal = révélation
compare-aspect-name = nom
compare-aspect-settings = réglages
compare-aspect-audio = audio
workspace-snapshots = Instantanés…
snapshots-title = Instantanés
snapshots-intro = Des points de contrôle nommés de cette collection auxquels revenir — conservés à dessein, au-delà de l'enregistrement automatique et de l'annulation. Stockés en local.
snapshots-name-placeholder = Nommer ce point de contrôle…
snapshots-create = Enregistrer l'instantané
snapshots-empty = Aucun instantané pour l'instant — enregistrez-en un pour garder un point de contrôle nommé auquel revenir.
snapshots-usage = { $count } sur { $cap } conservés · { $size }
snapshots-scenes = { $scenes } scènes · { $sources } sources
snapshots-restore = Restaurer
snapshots-compare = Comparer
snapshots-delete = Supprimer l'instantané
snapshots-delete-aria = Supprimer l'instantané « { $name } »
snapshots-restore-confirm = Restaurer cet instantané ? Votre mise en page actuelle est d'abord enregistrée comme instantané.

# --- Phase 8 (backup / theme editor / dock presets / settings search / quick actions) ---
workspace-backup = Sauvegarde et restauration…
backup-title = Sauvegarde et restauration
backup-intro = Enregistrez tout votre studio — paramètres, profils, collections de scènes — dans un seul fichier, et restaurez-le ici ou sur une nouvelle machine.
backup-export = Exporter la sauvegarde…
backup-exporting = Exportation…
backup-exported = { $collections } collection(s) et { $profiles } profil(s) sauvegardés ({ $size }).
backup-restore = Restaurer depuis une sauvegarde…
backup-secrets-note = Les clés de diffusion et les mots de passe ne sont jamais inclus dans une sauvegarde — ressaisissez-les après la restauration.
backup-restore-from = Sauvegarde effectuée le { $created } (v{ $version })
backup-restore-settings = Paramètres
backup-restore-collections = Collections de scènes ({ $count })
backup-restore-profiles = Profils ({ $count })
backup-restore-apply = Restaurer la sélection
backup-restoring = Restauration…
backup-restored = Restauré.
backup-restart-note = Redémarrez Freally Capture pour charger les collections et profils restaurés.
backup-cancel = Annuler
theme-editor-title = Palette personnalisée
theme-color-bg = Arrière-plan
theme-color-panel = Panneau
theme-color-text = Texte
theme-color-muted = Atténué
theme-color-accent = Accent
theme-color-accent2 = Accent 2
theme-contrast-text-bg = Texte sur l'arrière-plan
theme-contrast-text-panel = Texte sur le panneau
theme-contrast-muted-bg = Atténué sur l'arrière-plan
theme-contrast-accent-bg = Accent sur l'arrière-plan
theme-contrast-low = (visez ≥ { $min }:1)
theme-reset = Réinitialiser au thème sombre
theme-export = Exporter .fctheme…
theme-import = Importer .fctheme…
workspace-dock-presets = Dispositions des docks
workspace-dock-preset-placeholder = Enregistrer la disposition actuelle sous…
workspace-dock-preset-save = Enregistrer
workspace-dock-preset-apply = Basculer vers « { $name } »
workspace-dock-preset-delete = Supprimer la disposition « { $name } »
workspace-dock-presets-hint = Une disposition mémorise le dock des statistiques et l'orientation du mélangeur. Cliquez sur l'une d'elles pour y basculer.
...
menu-tools-quick-actions = Actions rapides…
menu-tools-featured-chat = Message de chat en vedette…
quick-actions-title = Actions rapides
quick-actions-empty = Aucun bouton pour l'instant — cliquez sur Modifier pour en ajouter.
quick-actions-edit = Modifier
quick-actions-done = Terminé
quick-actions-add-page = Page
quick-actions-label = Libellé du bouton
quick-actions-color = Couleur du bouton
quick-actions-add = Ajouter un bouton
quick-actions-remove = Supprimer « { $name } »
quick-actions-delete-page = Supprimer « { $name } »
quick-actions-hint = Les boutons déclenchent les mêmes commandes du studio que les raccourcis et le panneau LAN — scènes, macros et pads du soundboard compris. Les boutons de commande apparaissent aussi sur le panneau LAN.
quick-actions-cmd-transition = Transition
quick-actions-cmd-startStream = Passer en direct
quick-actions-cmd-stopStream = Terminer le direct
quick-actions-cmd-startRecording = Démarrer l'enregistrement
quick-actions-cmd-stopRecording = Arrêter l'enregistrement
quick-actions-cmd-pauseRecording = Mettre l'enregistrement en pause
quick-actions-cmd-addMarker = Ajouter un marqueur
quick-actions-cmd-armReplay = Armer le replay
quick-actions-cmd-saveReplay = Enregistrer le replay
quick-actions-cmd-setStudioMode = Basculer le mode studio
quick-actions-cmd-scene = Basculer vers la scène…
quick-actions-cmd-macro = Exécuter la macro…
quick-actions-cmd-soundboard = Pad du soundboard…
quick-actions-value-scene = Nom de la scène
quick-actions-value-macro = Nom de la macro
quick-actions-value-soundboard = ID du pad
teleprompter-stop = Arrêter
about-portable-on = Mode portable : activé — toutes les données de l'app sont stockées à côté de l'app.
about-portable-off = Mode portable : désactivé. Ajoutez un fichier « { $marker } » à côté de l'app pour la lancer en totale autonomie (mode clé USB).
about-portable-data = Dossier de données : { $path }
...
history-toggleOutputVisibility = Basculer la visibilité par sortie
...
palette-featured-chat = Message de chat en vedette…
featured-chat-title = Message de chat en vedette
featured-chat-intro = Épinglez une ligne de chat récente comme bannière en bas du programme — les spectateurs du direct et de l'enregistrement la voient. L'épingle disparaît au redémarrage ; les couleurs sont conservées.
featured-chat-empty = Pas encore de chat — ajoutez une source Superposition de chat et pointez-la vers votre chaîne ; les lignes apparaîtront ici à leur arrivée.
featured-chat-pinned = À l'antenne :
featured-chat-pin = Mettre en vedette
featured-chat-clear = Retirer
featured-chat-bg = Couleur de la bannière
featured-chat-text = Couleur du texte
featured-chat-note = La bannière se place en bas au centre, au-dessus de chaque scène — retirez-la pour la sortir de l'antenne.
...
# =============================================================
scenes-backdrop = Arrière-plan
scenes-backdrop-aria = Arrière-plan de { $name }
backdrop-title = Arrière-plan — { $name }
backdrop-hint = Un fond épinglé derrière tout dans cette scène : une image, un GIF animé ou une vidéo en boucle. Votre capture reste toujours au-dessus ; faites défiler sur le canevas pour zoomer.
backdrop-choose = Choisir une image ou une vidéo…
backdrop-remove = Retirer l’arrière-plan
backdrop-none = Aucun arrière-plan.
backdrop-position = Position
backdrop-split-full = Canevas entier
backdrop-split-fit = Ajuster
backdrop-split-left = Moitié gauche
backdrop-split-right = Moitié droite
backdrop-split-top = Moitié haute
backdrop-split-bottom = Moitié basse
backdrop-sync = Démarrer la lecture avec l’enregistrement
backdrop-sync-hint = Reste sur la première image jusqu’à l’enregistrement ; chaque prise relance la vidéo du début.
backdrop-preview-play = Lire l’aperçu
backdrop-preview-pause = Mettre l’aperçu en pause
backdrop-filter-all = Arrière-plans (images et vidéo)
backdrop-filter-images = Images
backdrop-filter-media = Vidéo et GIF
sources-backdrop-badge = Fond d’écran (épinglé tout en bas)
sources-backdrop-pinned = L’arrière-plan reste épinglé tout en bas
filters-name-flip = Miroir
filters-flip-horizontal = Horizontal
filters-flip-vertical = Vertical
history-setSceneBackdrop = Définir l’arrière-plan
history-setBackdropSplit = Déplacer l’arrière-plan
history-setBackdropSync = Synchro enregistrement de l’arrière-plan
backdrop-scrub = Position de lecture
backdrop-loop = Boucle
backdrop-reverse = Lire à l’envers
backdrop-reverse-hint = L’inversion génère une copie inversée une seule fois (les vidéos nécessitent le composant ffmpeg ; les GIF s’inversent instantanément) — le premier basculement peut prendre du temps sur les gros fichiers.
filters-scaling = Mise à l’échelle
filters-scaling-hint = Modes pixel-perfect pour le contenu rétro/pixel ; Entier cale aussi la taille dessinée sur des multiples exacts (les poignées montrent la taille logique).
filters-scaling-auto = Lisse
filters-scaling-nearest = Plus proche voisin
filters-scaling-integer = Entier (× exacts)
filters-scaling-sharp = Bilinéaire net
history-setScaling = Changer la mise à l’échelle
hotkeys-zoom-100 = Zoom : réinitialiser (100 %)
hotkeys-zoom-150 = Zoom : rapprocher à 150 %
hotkeys-zoom-200 = Zoom : rapprocher 2×
sources-follow-title = Suivre le curseur pendant le zoom (Windows ; faites défiler sur le canevas pour zoomer)
sources-follow-item = Basculer le suivi du curseur pour { $name }
filters-autocrop = ✂ Rogner les bandes noires
filters-autocrop-title = Analyse l’image suivante à la recherche de bandes noires et les rogne (annulable). Les scènes sombres ne sont jamais rognées.
filters-autocrop-follow = Revérifier au changement de résolution
history-autoCrop = Rognage auto des bandes noires
sources-link-audio = Capturer aussi l’audio de cette appli (lié : masquer coupe le son, retirer la fenêtre le retire)
history-addLinkedWindow = Ajouter fenêtre + audio lié
sources-hdr-title = Cet écran est HDR — ouvrir le tone-mapping (le canevas reste SDR)
sources-hdr-item = Tone-mapping HDR de { $name }
sources-hdr-dialog-title = HDR → SDR — { $name }
sources-hdr-hint = Cet écran émet du HDR. Sans tone-mapping, les hautes lumières saturent et la capture paraît délavée sur le canevas SDR. Les changements s’appliquent à l’image suivante.
sources-hdr-enable-suggested = Activer la suggestion (maxRGB, 200 nits)
sources-hdr-operator = Opérateur
sources-hdr-op-clip = Écrêtage (désactivé)
sources-hdr-op-maxrgb = maxRGB (teinte préservée)
sources-hdr-op-reinhard = Reinhard
sources-hdr-op-bt2408 = Coude BT.2408 (SDR exact)
sources-hdr-paper-white = Blanc papier
sources-hdr-nits = nits
projector-target-passthrough = Moniteur direct (faible latence)
projector-which-device = Périphérique
projector-passthrough-none = Ajoutez d’abord un écran, une fenêtre ou un périphérique de capture.
projector-passthrough-about = Images brutes du périphérique — sans scènes, sans filtres, sans compositeur. Affiche une latence mesurée ; l’audio reste monitoré via la tranche du mixeur.
projector-passthrough-hint = Direct — Échap ferme
projector-latency = { $ms } ms
projector-latency-measuring = mesure…
automation-title = Automatisation — règles, macros et variables
...
automation-variables = Variables du studio
...
rundown-title = Conducteur de l’émission
...
rundown-start = Démarrer
rundown-next = Suivant ▸
rundown-stop = Arrêter
rundown-idle = À l’arrêt
rundown-next-up = Ensuite : { $name }
...
automation-layer = Couche
automation-layer-hint = Ne se déclenche que si cette couche est active (vide = toutes). Les couches sont persistantes : une touche de couche bascule et y reste (l’API globale de l’OS n’offre pas de couche maintenue).
automation-chord-hint = Une touche simple (Ctrl+Shift+M) ou un accord à deux frappes (Ctrl+K, 3). La deuxième touche n’est réservée que pendant l’accord.
panel-title = Panneau LAN et tally
...
osc-title = Surface de contrôle OSC
...
midi-title = Surface de contrôle MIDI
...
midi-input = Entrée
midi-output = Sortie (retour)
midi-none = (none)
midi-learn = Apprendre
...
panel-lan-warning = ⚠ Le trafic LAN n’est pas chiffré — le mot de passe circule dans l’URL en HTTP. À utiliser uniquement sur un réseau de confiance.
osc-lan-warning = ⚠ OSC n’a pas de mot de passe — tout appareil du réseau peut envoyer ces commandes. Mode LAN uniquement sur un réseau de confiance.

# System-stats HUD source (CAP-N14)
sources-badge-stats = Stats
sources-add-system-stats = Statistiques de performance (HUD)
sources-stats-title = Ajouter un HUD de performance
sources-stats-note = Affiche dans le programme les vrais chiffres mesurés du studio pour vos spectateurs — fps, CPU, mémoire, temps de rendu, images perdues et débit en direct. Le choix des lignes, la taille et la couleur se règlent dans les Propriétés de la source. L'utilisation GPU n'est pas affichée car elle n'est pas mesurée.
sources-stats-add = Ajouter le HUD de stats
properties-stats-show-fps = Afficher les FPS
properties-stats-show-cpu = Afficher le CPU
properties-stats-show-memory = Afficher la mémoire
properties-stats-show-render = Afficher le temps de rendu
properties-stats-show-dropped = Afficher les images perdues
properties-stats-show-bitrate = Afficher le débit
properties-stats-show-timecode = Afficher le timecode (LTC)
properties-stats-size = Taille (px)
properties-stats-note = Le HUD rend des libellés compacts universels (FPS, CPU, MEM, RENDER, DROPPED, BITRATE) directement dans le programme ; hors diffusion, la ligne de débit affiche « — ».

# Audio visualizer source (CAP-N15)
sources-badge-visualizer = Visualiseur
sources-add-visualizer = Visualiseur audio
sources-visualizer-title = Ajouter un visualiseur audio
sources-visualizer-style-label = Style
sources-visualizer-style-bars = Barres de spectre
sources-visualizer-style-scope = Oscilloscope
sources-visualizer-style-vu = Vumètres
sources-visualizer-target-label = Écoute
sources-visualizer-target-master = Mixage master
sources-visualizer-target-track = Piste { $n }
sources-visualizer-note = Dessine le signal réellement mixé (post-fader) — une source coupée reste plate, exactement comme elle sonne. Taille, couleur, nombre de barres et vitesse de chute se règlent dans les Propriétés de la source.
sources-visualizer-classic = Couleurs classiques
sources-visualizer-add = Ajouter le visualiseur
properties-vis-bands = Barres
properties-vis-decay = Vitesse de chute (dB/s)
properties-vis-peak-hold = Marqueurs de crête
properties-vis-missing-source = (source manquante)

# Speedrun split timer source (CAP-N18)
sources-badge-splits = Splits
sources-add-split-timer = Chronomètre de splits (speedrun)
sources-splits-title = Ajouter un chronomètre de splits
sources-splits-file-label = Fichier .lss LiveSplit
sources-splits-comparison-label = Comparer à
sources-splits-comparison-pb = Record personnel
sources-splits-comparison-best = Meilleurs segments
sources-splits-comparison-average = Moyenne
sources-splits-note = Le fichier est importé en lecture seule — rien n'y est jamais réécrit. Assignez les touches globales Split / Undo / Skip / Reset dans Réglages → Raccourcis. Les auto-splitters par mémoire de processus ne sont volontairement pas pris en charge.
sources-splits-add = Ajouter le chronomètre
properties-splits-size = Taille (px)
properties-splits-ahead = En avance
properties-splits-behind = En retard
properties-splits-gold = Or
properties-splits-split = Split
properties-splits-undo = Annuler
properties-splits-skip = Passer
properties-splits-reset = Réinitialiser
properties-splits-note = Les boutons pilotent le chronomètre en direct (les raccourcis globaux font de même depuis n'importe quelle app). La course n'est jamais écrite dans le fichier .lss.
hotkeys-split-split = Chrono splits : démarrer / split
hotkeys-split-undo = Chrono splits : annuler le split
hotkeys-split-skip = Chrono splits : passer le segment
hotkeys-split-reset = Chrono splits : réinitialiser
hotkey-audit-action-split-split = Split (chrono splits)
hotkey-audit-action-split-undo = Annuler le split
hotkey-audit-action-split-skip = Passer le segment
hotkey-audit-action-split-reset = Réinitialiser le chrono
hotkey-audit-feature-split-timer = Chrono de splits

# Media playlist source (CAP-N17)
sources-badge-playlist = Playlist
sources-add-playlist = Playlist média (sans coupure)
sources-playlist-title = Ajouter une playlist média
sources-playlist-files-label = Fichiers (un par ligne, lus de haut en bas)
sources-playlist-browse = Parcourir…
sources-playlist-loop = Boucle
sources-playlist-shuffle = Aléatoire (un tirage par démarrage ; en boucle, l'ordre se répète)
sources-playlist-hold-last = Conserver la dernière image à la fin
sources-playlist-note = Lit toute la liste rognée sans coupure via le composant ffmpeg étiqueté (formats wire uniquement — .frec et images passent par Média/Diaporama). Les éléments sont tous vidéo ou tous audio, jamais mélangés. Rognages, points de cue et variable « now playing » dans les Propriétés.
sources-playlist-add = Ajouter la playlist
properties-playlist-items = Éléments (lus de haut en bas)
properties-playlist-up = Monter
properties-playlist-down = Descendre
properties-playlist-remove = Retirer l'élément
properties-playlist-in = Début (s)
properties-playlist-out = Fin (s)
properties-playlist-cues = Cues (s, séparés par des virgules)
properties-playlist-add-item = + Ajouter un élément
properties-playlist-loop = Boucle
properties-playlist-shuffle = Aléatoire
properties-playlist-hold-last = Conserver la dernière image
properties-playlist-hw = Décodage matériel
properties-playlist-variable = Variable « now playing » (vide = désactivé)
properties-playlist-previous = ⏮ Précédent
properties-playlist-next = ⏭ Suivant
properties-playlist-note = Les boutons de cue et Suivant/Précédent pilotent la playlist EN DIRECT ; les modifications d'éléments s'appliquent avec Appliquer (la playlist redémarre). Placez {"{{"}yourVariable{"}}"} dans une source Texte pour afficher l'élément en cours.
hotkeys-playlist-next = Playlist : élément suivant
hotkeys-playlist-previous = Playlist : élément précédent
hotkey-audit-action-playlist-next = Playlist suivant
hotkey-audit-action-playlist-previous = Playlist précédent
hotkey-audit-feature-playlist = Playlist

# Instant replay source (CAP-N10)
sources-badge-replay = Replay
sources-add-replay = Replay instantané
sources-replay-title = Ajouter un replay instantané
sources-replay-seconds-label = Durée du roll (secondes)
sources-replay-speed-label = Vitesse
sources-replay-speed-full = 100 % (avec le son)
sources-replay-speed-half = Ralenti 50 % (muet)
sources-replay-speed-quarter = Ralenti 25 % (muet)
sources-replay-note = Reste transparent jusqu'au déclenchement. Armez le tampon de replay (Contrôles) et assignez la touche Roll — un roll capture les derniers instants du tampon, les joue dans le programme puis redevient transparent.
sources-replay-add = Ajouter le replay
properties-replay-roll = ⏵ Lancer le replay
properties-replay-note = Roll capture le tampon ARMÉ dans un clip et le joue à la vitesse choisie — recadencé, jamais interpolé. Le ralenti est muet par choix. Scrub et pause fonctionnent pendant la lecture ; à la fin la source redevient transparente.
hotkeys-replay-roll = Replay instantané : lancer
hotkey-audit-action-replay-roll = Lancer le replay

# Input overlay source (CAP-N13)
sources-badge-input = Entrée
sources-add-input-overlay = Overlay d'entrée (touches/manette)
sources-input-title = Ajouter un overlay d'entrée
sources-input-layout-label = Disposition
sources-input-layout-wasd = WASD + souris
sources-input-layout-keyboard = Clavier compact + souris
sources-input-layout-gamepad = Manette (deux sticks)
sources-input-layout-fightstick = Stick arcade
sources-input-color-label = Touches
sources-input-accent-label = Appuyé
sources-input-privacy-note = Confidentialité : l'entrée n'est lue que pendant que cette source est en direct dans une scène, et seules les touches fixes de la disposition sont interrogées — un simple « est-elle enfoncée ? » instantané, jamais un hook. Rien n'est journalisé, stocké ni envoyé nulle part ; le texte tapé n'est jamais capturé.
sources-input-os-note = L'état du clavier et de la souris n'est lu que sous Windows aujourd'hui — les autres systèmes dessinent les touches non enfoncées (dit honnêtement, jamais simulé). Les manettes fonctionnent partout via la bibliothèque gilrs ; la première manette connectée est dessinée, et sans manette la disposition reste non enfoncée.
sources-input-add = Ajouter l'overlay d'entrée

# Cursor highlight & click effects (CAP-N19)
filters-cursorfx-header = Effets du curseur
filters-cursorfx-hint = Sous Windows (qui dessine lui-même le curseur), ils sont peints directement dans la capture et apparaissent donc dans les enregistrements et les streams. macOS et Linux composent le curseur côté système : ces effets sont donc réservés à Windows. Les changements s'appliquent en direct.
filters-cursorfx-halo = Halo du curseur
filters-cursorfx-halo-color = Couleur
filters-cursorfx-halo-radius = Rayon (px)
filters-cursorfx-ripples = Ondes de clic
filters-cursorfx-left-color = Clic gauche
filters-cursorfx-right-color = Clic droit
filters-cursorfx-keystrokes = Affichage des touches
filters-cursorfx-keystrokes-hint = Affiche un jeu de touches fixe (lettres, chiffres, modificateurs, flèches) près du curseur tant qu'elles sont enfoncées. Les touches ne sont lues que lorsque cette option est active, dessinées directement dans l'image, et jamais enregistrées ni journalisées.

# Title & scoreboard designer source (CAP-N16)
sources-badge-title = Titre
sources-add-title = Titre / Tableau de score
sources-title-title = Ajouter un titre
sources-title-template-label = Partir de
sources-title-template-lower-third = Bandeau bas (barre + nom + sous-titre)
sources-title-template-scoreboard = Tableau de score (plaque + 4 cases)
sources-title-template-blank = Toile vide
sources-title-width-label = Largeur de la toile
sources-title-height-label = Hauteur de la toile
sources-title-template-name = Nom
sources-title-template-subtitle = Titre
sources-title-template-home = DOMICILE
sources-title-template-away = VISITEUR
sources-title-note = Titres en couches (texte / image / boîte) avec animation d'entrée/sortie, composés en local — pas de source navigateur. Les couches, les liaisons aux fichiers et {"{{"}variables{"}}"} et les contrôles en direct sont dans les Propriétés de la source.
sources-title-add = Ajouter le titre
properties-title-layers = Couches (dessinées dans l'ordre — les lignes suivantes passent dessus)
properties-title-kind-text = Texte
properties-title-kind-image = Image
properties-title-kind-rect = Boîte
properties-title-x = X
properties-title-y = Y
properties-title-outline = Contour (px)
properties-title-outline-color = Contour
properties-title-shadow = Ombre
properties-title-animation = Animation entrée/sortie
properties-title-anim-none = Aucune (coupe)
properties-title-anim-fade = Fondu
properties-title-anim-slide-left = Glisser vers la gauche
properties-title-anim-slide-up = Glisser vers le haut
properties-title-anim-wipe = Balayage
properties-title-duration = Durée (ms)
properties-title-fire-in = ▶ Lancer l'entrée
properties-title-fire-out = ◼ Lancer la sortie
properties-title-set-live = Envoyer en direct
properties-title-set-live-note = Pousse ce texte dans le titre EN DIRECT maintenant — sans Appliquer, sans redémarrage
properties-title-up = Monter la couche
properties-title-down = Descendre la couche
properties-title-remove = Supprimer la couche
properties-title-add-text = + Texte
properties-title-add-image = + Image
properties-title-add-rect = + Boîte
properties-title-note = Lancer l'entrée/sortie et « Envoyer en direct » pilotent le titre EN COURS ; les modifications de couches s'appliquent avec Appliquer (le titre redémarre et rejoue son entrée). Les cases de texte peuvent se lier à un fichier surveillé (cellule CSV / valeur JSON / fichier entier) et interpoler {"{{"}variables{"}}"} — « Envoyer en direct » l'emporte sur les deux.

# LAN ingest source (CAP-N11)
sources-badge-lan-ingest = LAN
sources-add-lan-ingest = Ingest LAN (écouteur SRT/RTMP)
sources-lan-title = Ajouter un écouteur d'ingest LAN
sources-lan-protocol-label = Protocole
sources-lan-protocol-srt = SRT (chiffrable — recommandé)
sources-lan-protocol-rtmp = RTMP (aucune authentification)
sources-lan-port-label = Port (1024–65535)
sources-lan-passphrase-label = Phrase secrète (vide = ouvert)
sources-lan-passphrase-hint = Les phrases secrètes SRT font 10 à 79 caractères ; l'émetteur doit utiliser la même.
sources-lan-open-warning = Sans phrase secrète : n'importe qui sur ce réseau peut alimenter cette source, sans chiffrement. Définissez-en une sauf si le réseau n'appartient qu'à vous.
sources-lan-rtmp-warning = RTMP n'a aucune authentification — n'importe qui sur ce réseau peut envoyer vers ce port. Préférez SRT avec une phrase secrète.
sources-lan-url-label = Pointez l'app de l'émetteur vers
sources-lan-qr-aria = Code QR de l'URL d'ingest
sources-lan-note = LAN uniquement : écoute sur l'adresse locale de cette machine, seulement tant que la source existe, et ne touche jamais Internet — rien ne quitte la machine tant qu'un émetteur de votre réseau n'envoie pas en premier. Le décodage passe par le composant ffmpeg clairement étiqueté. Le canevas affiche cette URL jusqu'à la connexion d'un émetteur.
sources-lan-add = Commencer l'écoute
properties-lan-note = Appliquer un changement de protocole, de port ou de phrase secrète redémarre l'écouteur — l'émetteur doit se reconnecter. Le flux est ajusté sur un canevas 1920×1080.

# Freally Link source & output (CAP-N12)
sources-badge-link = Lien
sources-add-freally-link = Freally Link (autre instance)
sources-link-title = Ajouter un Freally Link
sources-link-about = Reçoit le programme d'une autre instance de Freally Capture — vidéo et audio master — via votre propre réseau. Activez d'abord « Sortie Freally Link » sur l'instance émettrice. v1 diffuse du motion-JPEG en TCP : parfait en LAN filaire ou bon Wi-Fi, honnête sur la bande passante des liaisons faibles.
sources-link-scan = Scanner le réseau local
sources-link-scanning = Recherche…
sources-link-none = Aucune sortie Freally Link trouvée. Activez « Sortie Freally Link » sur l'autre instance (Contrôles → Panneau LAN) ou saisissez son adresse ci-dessous.
sources-link-host = Adresse
sources-link-port = Port
sources-link-key = Clé d'appairage
sources-link-key-hint = La clé des réglages « Sortie Freally Link » de l'émetteur — sans elle, l'émetteur ne sert pas la moindre image.
sources-link-add = Ajouter le lien
properties-link-note = Sans connexion, la source affiche un écran « connexion » et réessaie d'elle-même avec temporisation croissante — elle ne fige jamais sur une image obsolète. Un récepteur par émetteur ; un émetteur occupé est retenté poliment.
link-title = Sortie Freally Link
link-about = Partagez le programme de cette instance — vidéo et audio master — avec UNE seule autre instance de Freally Capture sur votre propre réseau ; il y apparaît comme source « Freally Link » (streaming à deux PC, moniteurs d'appoint). Désactivé par défaut ; rien ne s'annonce ni n'écoute avant l'activation. v1 diffuse du motion-JPEG + audio non compressé en TCP — conçu pour un LAN filaire ou un bon Wi-Fi, jamais pour Internet.
link-enable = Partager le programme sur mon réseau
link-name = Nom de l'instance
link-key = Clé d'appairage
link-key-hint = Au moins 8 caractères — les récepteurs doivent saisir cette clé avant qu'une seule image ne soit servie.
link-lan-warning = ⚠ Les récepteurs doivent présenter la clé d'appairage avant de recevoir quoi que ce soit, mais le flux lui-même n'est pas chiffré en v1 — à n'utiliser que sur un réseau de confiance.
link-serving = Les récepteurs trouvent cette instance avec « Scanner le réseau local » ou l'ajoutent manuellement à :
link-off-hint = Activez le partage pour ouvrir le port et annoncer cette instance aux scans du réseau local.

# In-app menu bar (OBS-style chrome)
menu-bar-label = Menu de l'application
menu-file = Fichier
menu-edit = Édition
menu-view = Affichage
menu-docks = Docks
menu-profile = Profil
menu-collection = Collection de scènes
menu-tools = Outils
menu-help = Aide
...
menu-file-show-recordings = Afficher les enregistrements
menu-file-remux = Remux vers MP4…
menu-file-settings = Paramètres…
menu-file-show-settings-folder = Afficher le dossier des paramètres
menu-file-exit = Quitter
menu-edit-undo = Annuler
menu-edit-redo = Rétablir
menu-edit-history = Historique des modifications…
menu-edit-copy-transform = Copier la transformation
menu-edit-paste-transform = Coller la transformation
menu-edit-copy-filters = Copier les filtres
menu-edit-paste-filters = Coller les filtres
menu-edit-transform = Transformation…
menu-edit-lock-preview = Verrouiller l'aperçu
menu-view-fullscreen = Interface en plein écran
menu-stats-dock = Panneau de statistiques
menu-view-multiview = Moniteur multiview…
menu-view-projectors = Projecteurs…
menu-view-source-health = Santé des sources…
menu-view-still = Capturer une image
menu-docks-browser = Docks de navigateur…
menu-docks-lock = Verrouiller les docks
menu-docks-reset = Réinitialiser la disposition des docks
menu-profile-manage = Gérer les profils…
menu-collection-manage = Gérer les collections de scènes…
menu-collection-import-obs = Importer depuis OBS…
menu-collection-missing = Vérifier les fichiers manquants…
menu-collection-clear = Effacer l'historique…
menu-collection-clear-confirm = Supprimer définitivement ces collections de scènes et leurs fichiers ? { $names } — la collection active « { $active } » est conservée. Cette action est irréversible.
menu-tools-wizard = Lancer l'assistant de configuration
menu-tools-wizard-title = L'assistant de configuration s'exécute au premier lancement ; il n'est pas encore possible de le relancer.
menu-tools-automation = Règles d'automatisation et macros…
menu-tools-rundown = Afficher le conducteur…
menu-tools-hotkeys = Carte des raccourcis…
menu-tools-av-sync = Calibrage de synchro A/V…
menu-tools-scripts = Scripts Lua…
menu-tools-components = Composants…
menu-tools-midi = Contrôle MIDI…
menu-tools-ptz = Caméras PTZ…
menu-tools-remote = API de contrôle à distance…
menu-tools-panel = Panneau LAN et tally…
menu-help-portal = Portail d'aide
menu-help-website = Visiter le site web
menu-help-discord = Rejoindre le serveur Discord
menu-help-bug = Signaler un bug…
menu-help-updates = Vérifier les mises à jour…
menu-help-whats-new = Nouveautés
...
settings-cat-streaming = Diffusion
settings-cat-output = Sortie
settings-cat-replay = Relecture
settings-cat-hotkeys = Raccourcis
settings-cat-network = Réseau
settings-cat-accessibility = Accessibilité
...
settings-hotkeys-filter = Filtrer les raccourcis
settings-hotkeys-filter-placeholder = Saisissez pour filtrer les actions ou les touches…
settings-hotkeys-no-match = Aucun raccourci ne correspond à “{ $query }”.
settings-hotkey-none = Aucun
settings-hotkey-group-ctrl = Ctrl + touche
settings-hotkey-group-ctrl-shift = Ctrl + Shift + touche
settings-hotkey-group-ctrl-alt = Ctrl + Alt + touche
settings-hotkey-group-function = Touches de fonction
settings-hotkey-group-numpad = Pavé numérique
settings-panic-section = Écran de panique
settings-meter-section = Vumètres du mixeur
settings-meter-note = Les couleurs que parcourent les vumètres du mixeur audio, du silence à la saturation. Le préréglage adapté au daltonisme utilise un dégradé bleu → orange qui reste lisible avec une déficience rouge-vert.
settings-meter-preset = Couleurs du vumètre
settings-meter-preset-default = Vert / jaune / rouge
settings-meter-preset-colorblind = Adapté au daltonisme (bleu / orange)
settings-meter-preset-custom = Personnalisé
settings-meter-low = Normal
settings-meter-mid = Fort
settings-meter-high = Saturation
settings-meter-preview = Aperçu
...
whats-new-empty = Aucune note de version pour cette version.
filters-name-directional-blur = Flou directionnel
filters-name-radial-blur = Flou radial
filters-name-zoom-blur = Flou de zoom
filters-name-pixelate = Pixelliser
filters-angle = Angle (°)
filters-center-x = Centre X
filters-center-y = Centre Y
filters-block-size = Taille de bloc (px)
filters-name-freeze = Figer
filters-freeze-hint = Une fois activée, cette source conserve sa dernière image — le programme, l'aperçu, l'enregistrement et le flux se figent tous ensemble. Basculez ce filtre pour figer ou libérer.
transform-3d = Inclinaison 3D
...
dsk-enable = Activer cette incrustation
dsk-move-up = Monter (au premier plan)
dsk-move-down = Descendre
dsk-remove = Supprimer l'incrustation
dsk-opacity = Opacité
dsk-x = X (px)
dsk-y = Y (px)
dsk-scale = Échelle
...
telestrator-draw = Dessiner
telestrator-tool-pen = Stylo
telestrator-tool-highlight = Surligneur
telestrator-tool-arrow = Flèche
telestrator-tool-ellipse = Ellipse
telestrator-color = Couleur
telestrator-width = Épaisseur
telestrator-whiteboard = Mode tableau blanc
telestrator-persist = Conserver
telestrator-fade = Estomper
telestrator-undo = Annuler la dernière marque
telestrator-clear = Effacer les marques
hotkeys-telestrator-clear = Telestrator : effacer les marques

# --- Teleprompter (CAP-N58) ---
teleprompter-title = Prompteur
teleprompter-loading = Chargement…
teleprompter-empty = Aucun script — ajoutez-en un dans le panneau du prompteur.
teleprompter-script = Script
teleprompter-script-placeholder = Saisissez ou collez votre script…
teleprompter-top = Début
teleprompter-slower = Plus lent
teleprompter-play = Lecture
teleprompter-pause = Pause
teleprompter-faster = Plus rapide
teleprompter-step-back = Reculer
teleprompter-step-forward = Avancer
teleprompter-est-time = Temps de lecture
teleprompter-caesura-hint = Tapez -- pour une pause
teleprompter-caesura-pause = Pause de césure — Tapez -- pour une pause
teleprompter-countdown = Démarrer le compte à rebours
teleprompter-countdown-secs = Compte à rebours (secondes)
teleprompter-speed = Vitesse (caractères/s)
teleprompter-speed-bpm = Vitesse (BPM)
teleprompter-bpm-mode = Mode BPM (chant)
teleprompter-font = Taille de police
teleprompter-mirror = Miroir (verre)
teleprompter-open-projector = Ouvrir le projecteur
teleprompter-preview = Aperçu
teleprompter-remote-hint = Contrôlez le défilement via un raccourci, le MIDI ou le panneau LAN lorsque ceci est fermé.
teleprompter-read-aloud = Lire à voix haute avec la synthèse vocale du système
menu-tools-teleprompter = Prompteur
hotkeys-teleprompter-toggle = Prompteur : lecture / pause

# --- Remote guests: green room / cues / QoS / auto-grid (CAP-N54–N56, N59) ---
remote-hosting-count = Hébergement de { $count } invité(s)
remote-green-room-default = Salle d'attente
remote-green-room-default-title = Les nouveaux invités patientent en salle d'attente jusqu'à ce que vous les placiez
remote-auto-grid = Grille auto
remote-auto-grid-title = Garder les invités en grille à mesure qu'ils arrivent et partent
remote-arrange-grid = Organiser la grille
remote-arrange-grid-title = Réorganiser maintenant les invités placés en grille
remote-green-room-monitor = Aperçu de la salle d'attente
remote-tech-cam-ok = Caméra ✓
remote-tech-cam-no = Pas de caméra
remote-tech-mic-ok = Micro ✓
remote-tech-mic-no = Pas de micro
remote-seat-on-air = Mettre à l'antenne
remote-cues-label = Signaux
remote-cue = Signal
remote-cue-thirty = 30 secondes
remote-cue-wrap = Concluez
remote-cue-next = C'est bientôt à vous
remote-cue-speak = Parlez plus fort
remote-qos-good = Bonne connexion
remote-qos-fair = Connexion moyenne
remote-qos-poor = Mauvaise connexion
remote-green-room-guest = Vous êtes en salle d'attente — l'hôte vous mettra à l'antenne sous peu.

# --- Hotkey audit — Phase 7 actions ---
hotkey-audit-action-telestrator-clear = Telestrator : effacer les marques
hotkey-audit-action-teleprompter-toggle = Prompteur : lecture / pause
hotkey-audit-feature-telestrator = Telestrator
hotkey-audit-feature-teleprompter = Prompteur

# V1-C — Starting Soon countdown slate
sources-add-starting-soon = Bientôt en direct…
sources-starting-soon-title = Bientôt en direct
sources-starting-soon-default = Bientôt en direct
sources-starting-soon-message = Message
sources-starting-soon-minutes = Minutes
sources-starting-soon-hours = Heures
sources-starting-soon-start-at = Commence à
sources-starting-soon-music = Musique de fond…
sources-starting-soon-music-name = Musique de fond
sources-starting-soon-background = Arrière-plan
sources-starting-soon-note = Un compte à rebours en plein écran qui clignote en rouge et s'arrête à zéro — effacez-le et basculez vers votre scène en direct manuellement quand vous êtes prêt.
sources-starting-soon-add = Ajouter
sources-slate-solid = Couleur unie
sources-slate-gradient = Dégradé
sources-slate-transparent = Transparent
sources-slate-image = Image
sources-slate-file = Image / Vidéo / GIF
sources-slate-browse = Parcourir…
sources-starting-soon-choose-image = Choisir une image…
sources-slate-media-note = Les images fixes sont intégrées ici. Pour une vidéo ou un GIF en fond en boucle, choisissez « Transparent » et définissez l'arrière-plan de la scène (le 🖼 dans la barre des scènes) — le compte à rebours se place au-dessus.
properties-timer-slate = Écran « Bientôt en direct »
properties-timer-slate-off = Désactivé (texte en ligne)
properties-timer-message = Message
properties-timer-slate-color = Couleur de l'écran
properties-timer-slate-from = De
properties-timer-slate-to = À
properties-timer-slate-note = Transparent laisse voir une image, une vidéo ou un fond de scène sous l'écran.
...
sources-browser-component-missing = Nécessite le composant Browser Runtime — installez-le depuis Outils → Composants.
