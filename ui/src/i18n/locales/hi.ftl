...
properties-timer-target = इस समय तक काउंटडाउन (HH:MM)
properties-timer-target-note = दीवार-घड़ी लक्ष्य अपने आप चलता है और रोज़ दोहराता है; अवधि + शुरू/रोकें/रीसेट के लिए खाली छोड़ें।
...
hotkeys-timer-toggle-placeholder = जैसे Ctrl+Shift+T
hotkeys-timer-reset = सभी टाइमर रीसेट करें
hotkeys-timer-reset-placeholder = जैसे Ctrl+Shift+0
...
hotkeys-split-placeholder = जैसे Numpad1
...
hotkeys-playlist-placeholder = जैसे Ctrl+Alt+Right
...
hotkeys-replay-roll-placeholder = जैसे Ctrl+Shift+I
