...
sources-add-background-music = Фонова музика…
sources-background-music-note = Грає по колу, чутно в попередньому перегляді та записується/транслюється. Щоб узяти музику замість звуку відео, вимкніть доріжку Backdrop відео.
sources-background-music-count = { $n } треків
sources-background-music-shuffle = Перемішати
...
sources-stream-hide = Приховати у стрімі
sources-stream-show = Показати у стрімі
sources-stream-hide-item = Приховати { $name } у стрімі
sources-stream-show-item = Показати { $name } у стрімі
sources-record-hide = Приховати в записі
sources-record-show = Показати в записі
sources-record-hide-item = Приховати { $name } в записі
sources-record-show-item = Показати { $name } в записі
...
sources-game-accept = Прийняти ризик і вибрати гру
sources-game-pick = Виберіть вікно гри для захоплення. Прив'язка зберігається лише під час гри.
...
controls-virtual-camera-stop = ⌁ Зупинити віртуальну камеру
controls-virtual-camera-ready = Публікує програму як камеру, яку можуть вибрати інші застосунки.
...
stats-rehearsal-note = Репетиція — цілі публікують лише в локальний приймач
stats-timeline-open = Часова шкала
timeline-title = Часова шкала сесії
timeline-empty = Ще нічого не записано — шкала пишеться, поки триває стрім або запис.
timeline-live = LIVE — ще записується
timeline-fit = Вписати
timeline-legend-fps = fps
timeline-legend-behind = черга кодера (кадрів позаду)
...
scenes-recent-title = Останні
scenes-recent-clear = Очистити
scenes-recent-clear-confirm = Очистити список останніх сцен?
...
livebutton-rehearse = Репетиція
livebutton-rehearse-record-confirm = Записати цю репетицію також у відеофайл?
livebutton-rehearse-title = Прогнати все шоу на локальний приймач — нічого не надсилається
livebutton-end-rehearsal = Завершити репетицію
livebutton-title-rehearsing = Триває репетиція — ніщо не покидає цей комп'ютер
livebutton-badge-rehearsal = РЕПЕТИЦІЯ
livebutton-aria-rehearsal = Триває репетиція
livebutton-rehearsal-banner = Репетиція — ніщо не покидає цей комп'ютер
...
properties-timer-clock = Відлік до певного часу
...
filters-name-fade-loop = Цикл згасання
...
filters-tilt = Нахил
filters-far-fade = Згасання дальнього краю
filters-fade-in-s = Поява (с)
filters-visible-s = Видимий (с)
filters-fade-out-s = Зникнення (с)
filters-hidden-s = Прихований (с)
...
bench-open = Запустити бенчмарк кодерів…
bench-title = Бенчмарк кодерів
bench-intro = Проганяє короткі виміряні драбинки кодування (кожен знайдений кодер × пресет × роздільність) на цій машині — близько хвилини, повністю офлайн, ніщо не покидає комп'ютер. Збої перелічуються, а не приховуються. Спершу зупиніть стрім чи запис.
bench-start = Почати бенчмарк
bench-rerun = Запустити знову
bench-running = Вимірювання… { $done } / { $total }
bench-cancel = Скасувати
bench-col-encoder = Кодер
bench-col-preset = Пресет
bench-col-rung = Щабель
bench-col-achieved = fps
bench-col-headroom = Запас
bench-failed = збій
bench-rec-title = Рекомендація (виміряна)
bench-rec-body = { $encoder } з { $preset }, { $width }×{ $height } @ { $fps } fps — виміряно { $headroom }× реального часу. Рекомендований бітрейт стріму: { $bitrate } кбіт/с.
bench-rec-none = Ніщо не тримає реальний час на цій машині — зменшіть роздільність полотна або fps і повторіть.
bench-apply = Застосувати до налаштувань запису
bench-applied = Застосовано ✓
...
output-auto-export = Також зберігати MP4 для поширення поруч із майстром
output-auto-export-title = Коли запис .frec завершується, фоновий експорт записує поруч MP4-копію, що відкривається подвійним клацанням (видно у фоновій черзі). Майстер без втрат лишається майстром.
...
stream-session-report = Після завершення сесії записувати звіт (HTML + Markdown) поруч із записом
stream-simulator-title = Симулятор мережі (репетиції)
stream-simulator-note = Формує лише локальні приймачі репетиції — відпрацьовує перепідключення та слабкий аплінк. Справжній ефір ніколи не деградує.
stream-simulator-profile = Профіль
stream-simulator-off = Вимк
stream-simulator-hotel-wifi = Готельний Wi-Fi
stream-simulator-mobile-hotspot = Мобільна точка доступу
stream-simulator-custom = Власний
stream-simulator-bandwidth = Смуга (кбіт/с, 0 = без ліміту)
stream-simulator-latency = Затримка (мс)
stream-simulator-jitter = Джитер (± мс)
stream-simulator-outage-every = Обрив кожні (с, 0 = ніколи)
stream-simulator-outage-len = Тривалість обриву (с)
...
workspace-pack-title = Пакунок колекції сцен
workspace-pack-export = Експортувати пакунок…
workspace-pack-exporting = Експортування…
workspace-pack-import = Імпортувати пакунок…
workspace-pack-importing = Імпортування…
workspace-pack-hint = Файл .fcappack пакує активну колекцію разом з її локальними ресурсами в один переносний файл — поділіться цілим макетом без сервера. Імпорт додає його як нову колекцію та перемикається на неї.
workspace-pack-exported = «{ $name }» експортовано — упаковано ресурсів: { $bundled }, зовнішніх: { $external }.
workspace-pack-imported = «{ $name }» імпортовано — сцен: { $scenes }, повторно пов’язано ресурсів: { $relinked }, зовнішніх: { $external }.
workspace-compare = Порівняти та об’єднати…
compare-title = Порівняти та об’єднати
compare-intro = Порівняйте активну колекцію з іншою та перенесіть лише вибрані зміни. Ніщо не залишає цей комп’ютер.
compare-target-label = Порівняти з
compare-target-none = Виберіть колекцію…
compare-target-pack = З файлу пакунка…
compare-against = проти { $name }
compare-comparing = Порівняння…
compare-no-diff = Відмінностей немає — колекції збігаються.
compare-select-all = Вибрати все
compare-clear = Очистити
compare-merge-hint = Вибір сцени також переносить джерела, які вона використовує.
compare-sources-title = Джерела
compare-scenes-title = Сцени
compare-kind-added = Додано
compare-kind-removed = Видалено
compare-kind-modified = Змінено
compare-renamed = було «{ $from }»
compare-reordered = переупорядковано
compare-apply = Застосувати { $count }
compare-apply-none = Виберіть зміни для застосування
compare-applying = Застосування…
compare-aspect-source = джерело
compare-aspect-transform = позиція
compare-aspect-visibility = видимість
compare-aspect-outputs = виходи
compare-aspect-filters = фільтри
compare-aspect-lock = блокування
compare-aspect-blend = змішування
compare-aspect-scaling = масштабування
compare-aspect-backdrop = тло
compare-aspect-reveal = проявлення
compare-aspect-name = назва
compare-aspect-settings = налаштування
compare-aspect-audio = звук
workspace-snapshots = Знімки…
snapshots-title = Знімки
snapshots-intro = Іменовані контрольні точки цієї колекції, до яких можна повернутися — зберігаються навмисно, поза автозбереженням і скасуванням. Зберігаються локально.
snapshots-name-placeholder = Назвіть цю контрольну точку…
snapshots-create = Зберегти знімок
snapshots-empty = Ще немає знімків — збережіть один, щоб залишити іменовану контрольну точку, до якої можна повернутися.
snapshots-usage = { $count } з { $cap } збережено · { $size }
snapshots-scenes = сцен: { $scenes } · джерел: { $sources }
snapshots-restore = Відновити
snapshots-compare = Порівняти
snapshots-delete = Видалити знімок
snapshots-delete-aria = Видалити знімок «{ $name }»
snapshots-restore-confirm = Відновити цей знімок? Ваш поточний макет спочатку зберігається як знімок.

# --- Phase 8 (backup / theme editor / dock presets / settings search / quick actions) ---
workspace-backup = Резервна копія та відновлення…
backup-title = Резервна копія та відновлення
backup-intro = Збережіть усю студію — налаштування, профілі, колекції сцен — в один файл і відновіть її тут або на новій машині.
backup-export = Експортувати резервну копію…
backup-exporting = Експортування…
backup-exported = Збережено колекцій: { $collections }, профілів: { $profiles } ({ $size }).
backup-restore = Відновити з резервної копії…
backup-secrets-note = Ключі трансляції та паролі ніколи не входять до резервної копії — введіть їх знову після відновлення.
backup-restore-from = Резервну копію створено { $created } (v{ $version })
backup-restore-settings = Налаштування
backup-restore-collections = Колекції сцен ({ $count })
backup-restore-profiles = Профілі ({ $count })
backup-restore-apply = Відновити вибране
backup-restoring = Відновлення…
backup-restored = Відновлено.
backup-restart-note = Перезапустіть Freally Capture, щоб завантажити відновлені колекції та профілі.
backup-cancel = Скасувати
theme-editor-title = Власна палітра
theme-color-bg = Тло
theme-color-panel = Панель
theme-color-text = Текст
theme-color-muted = Приглушений
theme-color-accent = Акцент
theme-color-accent2 = Акцент 2
theme-contrast-text-bg = Текст на тлі
theme-contrast-text-panel = Текст на панелі
theme-contrast-muted-bg = Приглушений на тлі
theme-contrast-accent-bg = Акцент на тлі
theme-contrast-low = (ціль ≥ { $min }:1)
theme-reset = Скинути до темної
theme-export = Експорт .fctheme…
theme-import = Імпорт .fctheme…
workspace-dock-presets = Макети панелей
workspace-dock-preset-placeholder = Зберегти поточний макет як…
workspace-dock-preset-save = Зберегти
workspace-dock-preset-apply = Перемкнутися на «{ $name }»
workspace-dock-preset-delete = Видалити макет «{ $name }»
workspace-dock-presets-hint = Макет запам’ятовує панель статистики та орієнтацію мікшера. Натисніть на макет, щоб перемкнутися на нього.
...
menu-tools-quick-actions = Швидкі дії…
menu-tools-featured-chat = Вибране повідомлення чату…
quick-actions-title = Швидкі дії
quick-actions-empty = Ще немає кнопок — натисніть «Змінити», щоб додати.
quick-actions-edit = Змінити
quick-actions-done = Готово
quick-actions-add-page = Сторінка
quick-actions-label = Підпис кнопки
quick-actions-color = Колір кнопки
quick-actions-add = Додати кнопку
quick-actions-remove = Видалити «{ $name }»
quick-actions-delete-page = Видалити «{ $name }»
quick-actions-hint = Кнопки запускають ті самі команди студії, що й гарячі клавіші та панель LAN — сцени, макроси й педи саундборда теж. Командні кнопки також показуються на панелі LAN.
quick-actions-cmd-transition = Перехід
quick-actions-cmd-startStream = В ефір
quick-actions-cmd-stopStream = Завершити трансляцію
quick-actions-cmd-startRecording = Почати запис
quick-actions-cmd-stopRecording = Зупинити запис
quick-actions-cmd-pauseRecording = Призупинити запис
quick-actions-cmd-addMarker = Додати маркер
quick-actions-cmd-armReplay = Увімкнути повтор
quick-actions-cmd-saveReplay = Зберегти повтор
quick-actions-cmd-setStudioMode = Перемкнути студійний режим
quick-actions-cmd-scene = Перемкнутися на сцену…
quick-actions-cmd-macro = Запустити макрос…
quick-actions-cmd-soundboard = Пед саундборда…
quick-actions-value-scene = Назва сцени
quick-actions-value-macro = Назва макроса
quick-actions-value-soundboard = ID педа
teleprompter-stop = Стоп
about-portable-on = Портативний режим: увімкнено — усі дані застосунку зберігаються поряд із застосунком.
about-portable-off = Портативний режим: вимкнено. Додайте файл «{ $marker }» поряд із застосунком, щоб запускати його повністю автономно (режим USB-накопичувача).
about-portable-data = Папка даних: { $path }
...
history-toggleOutputVisibility = Перемкнути видимість на виходах
...
palette-featured-chat = Вибране повідомлення чату…
featured-chat-title = Вибране повідомлення чату
featured-chat-intro = Закріпіть будь-який недавній рядок чату як банер унизу програми — глядачі трансляції та запису його бачать. Закріплення зникає після перезапуску; кольори зберігаються.
featured-chat-empty = Чату поки немає — додайте джерело «Оверлей чату» і вкажіть свій канал; рядки з'являтимуться тут у міру надходження.
featured-chat-pinned = У програмі:
featured-chat-pin = Закріпити
featured-chat-clear = Прибрати
featured-chat-bg = Колір банера
featured-chat-text = Колір тексту
featured-chat-note = Банер розташований унизу по центру, поверх усіх сцен — приберіть його, щоб зняти з ефіру.
...
sources-visualizer-classic = Класичні кольори
...
menu-collection-clear = Очистити історію…
menu-collection-clear-confirm = Остаточно видалити ці колекції сцен та їхні файли? { $names } — активна колекція «{ $active }» залишиться. Цю дію не можна скасувати.
...
telestrator-draw = Малювати
telestrator-tool-pen = Ручка
telestrator-tool-highlight = Маркер
telestrator-tool-arrow = Стрілка
telestrator-tool-ellipse = Еліпс
telestrator-color = Колір
telestrator-width = Товщина
telestrator-whiteboard = Режим дошки
telestrator-persist = Залишити
telestrator-fade = Згасання
telestrator-undo = Скасувати останню позначку
telestrator-clear = Очистити позначки
hotkeys-telestrator-clear = Телестратор: очистити позначки

# --- Teleprompter (CAP-N58) ---
teleprompter-title = Телесуфлер
teleprompter-loading = Завантаження…
teleprompter-empty = Сценарію ще немає — додайте його в панелі телесуфлера.
teleprompter-script = Сценарій
teleprompter-script-placeholder = Введіть або вставте сценарій…
teleprompter-top = На початок
teleprompter-slower = Повільніше
teleprompter-play = Пуск
teleprompter-pause = Пауза
teleprompter-faster = Швидше
teleprompter-step-back = Крок назад
teleprompter-step-forward = Крок вперед
teleprompter-est-time = Час читання
teleprompter-caesura-hint = Введіть -- для паузи
teleprompter-caesura-pause = Пауза цезури — Введіть -- для паузи
teleprompter-countdown = Почати зворотний відлік
teleprompter-countdown-secs = Зворотний відлік (секунди)
teleprompter-speed = Швидкість (символів/с)
teleprompter-speed-bpm = Швидкість (BPM)
teleprompter-bpm-mode = Режим BPM (спів)
teleprompter-font = Розмір шрифту
teleprompter-mirror = Дзеркало (скло)
teleprompter-open-projector = Відкрити проєктор
teleprompter-preview = Перегляд
teleprompter-remote-hint = Керуйте прокручуванням гарячою клавішею, MIDI або LAN-панеллю, поки це вікно закрите.
teleprompter-read-aloud = Читати вголос за допомогою синтезу мовлення ОС
menu-tools-teleprompter = Телесуфлер
hotkeys-teleprompter-toggle = Телесуфлер: пуск / пауза

# --- Remote guests: green room / cues / QoS / auto-grid (CAP-N54–N56, N59) ---
remote-hosting-count = Підключено гостей: { $count }
remote-green-room-default = Кімната очікування
remote-green-room-default-title = Нові гості чекають у кімнаті очікування, поки ви їх не виведете
remote-auto-grid = Автосітка
remote-auto-grid-title = Тримати гостей у сітці, коли вони заходять і виходять
remote-arrange-grid = Розставити сітку
remote-arrange-grid-title = Перебудувати виведених гостей у сітку зараз
remote-green-room-monitor = Перегляд кімнати очікування
remote-tech-cam-ok = Камера ✓
remote-tech-cam-no = Немає камери
remote-tech-mic-ok = Мікрофон ✓
remote-tech-mic-no = Немає мікрофона
remote-seat-on-air = Вивести в ефір
remote-cues-label = Сигнали
remote-cue = Сигнал
remote-cue-thirty = 30 секунд
remote-cue-wrap = Завершуйте
remote-cue-next = Ви наступний
remote-cue-speak = Говоріть гучніше
remote-qos-good = Зв'язок добрий
remote-qos-fair = Зв'язок середній
remote-qos-poor = Зв'язок поганий
remote-green-room-guest = Ви в кімнаті очікування — ведучий скоро виведе вас в ефір.

# --- Hotkey audit — Phase 7 actions ---
hotkey-audit-action-telestrator-clear = Телестратор: очистити позначки
hotkey-audit-action-teleprompter-toggle = Телесуфлер: пуск / пауза
hotkey-audit-feature-telestrator = Телестратор
hotkey-audit-feature-teleprompter = Телесуфлер

# V1-C — Starting Soon countdown slate
sources-add-starting-soon = Скоро почнемо…
sources-starting-soon-title = Скоро почнемо
sources-starting-soon-default = Скоро почнемо
sources-starting-soon-message = Повідомлення
sources-starting-soon-minutes = Хвилини
sources-starting-soon-hours = Години
sources-starting-soon-start-at = Початок о
sources-starting-soon-music = Фонова музика…
sources-starting-soon-music-name = Фонова музика
sources-starting-soon-background = Фон
sources-starting-soon-note = Повноекранний зворотний відлік, що на нулі блимає червоним і зупиняється — очистіть його й вручну перемкніться на свою пряму сцену, коли будете готові.
sources-starting-soon-add = Додати
sources-slate-solid = Суцільний колір
sources-slate-gradient = Градієнт
sources-slate-transparent = Прозорий
sources-slate-image = Зображення
sources-slate-file = Зображення / Відео / GIF
sources-slate-browse = Огляд…
sources-starting-soon-choose-image = Вибрати зображення…
sources-slate-media-note = Статичні зображення вбудовуються тут. Для зацикленого відео чи GIF як фону виберіть «Прозорий» і задайте фон сцени (🖼 на панелі сцен) — відлік буде згори.
properties-timer-slate = Заставка «Скоро почнемо»
properties-timer-slate-off = Вимк. (звичайний текст)
properties-timer-message = Повідомлення
properties-timer-slate-color = Колір заставки
properties-timer-slate-from = Від
properties-timer-slate-to = До
properties-timer-slate-note = Прозорість дає змогу просвічувати зображенню, відео чи фону сцени під заставкою.
...
sources-add-browser = Браузер (вебсторінка)
sources-browser-title = Додати джерело «Браузер»
sources-browser-add = Додати джерело браузера
sources-browser-url = URL сторінки (http:// або https://)
sources-browser-url-invalid = Введіть URL із http:// або https:// — локальні файли відтворюються через джерела «Медіа» чи «Зображення».
sources-browser-width = Ширина (px)
sources-browser-height = Висота (px)
sources-browser-fps = FPS
sources-browser-transparent = Прозоре тло сторінки (альфа-канал зберігається)
sources-browser-note = Рендерить http/https-сторінки поза екраном через завантажуваний на вимогу компонент середовища виконання браузера — ніколи не вбудований і не працює всередині процесу. Локальні файли відтворюються через Медіа/Зображення.
sources-browser-component-missing = Потрібен компонент Browser Runtime — установіть його в Інструменти → Компоненти.
sources-browser-component-unsupported = CEF не публікує збірку Browser Runtime для цієї платформи, тож це джерело тут не відтвориться.
sources-browser-component-installing = Установлення компонента Browser Runtime… джерело відтвориться після завершення.
sources-browser-component-error = Не вдалося встановити компонент Browser Runtime: { $message }

# Shown when a dialog or dock hits a render error (ErrorBoundary).
panel-error-title = Цю панель зупинено
panel-error-hint = Запис і трансляція не постраждали. Закрийте та відкрийте знову.
