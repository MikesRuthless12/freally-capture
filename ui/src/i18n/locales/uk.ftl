...
controls-automation = Автоматизація
...
hotkeys-split-placeholder = напр. Numpad1
...
hotkeys-playlist-placeholder = напр. Ctrl+Alt+Right
...
hotkeys-replay-roll-placeholder = напр. Ctrl+Shift+I
