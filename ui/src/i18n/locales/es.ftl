...
sources-add-background-music = Música de fondo…
sources-background-music-note = Se reproduce en bucle, se oye en la vista previa y se graba/transmite. Para usar música en vez del sonido de un vídeo, silencia la pista Backdrop del vídeo.
sources-background-music-count = { $n } pistas
sources-background-music-shuffle = Aleatorio
...
sources-game-accept = Aceptar el riesgo y elegir un juego
sources-game-pick = Elige la ventana del juego a capturar. Solo queda enganchada mientras juegas.
...
scenes-recent-title = Recientes
scenes-recent-clear = Borrar
scenes-recent-clear-confirm = ¿Borrar la lista de escenas recientes?
...
livebutton-rehearse-record-confirm = ¿Grabar también este ensayo en un archivo de vídeo?
...
properties-timer-clock = Cuenta atrás hasta una hora
...
workspace-pack-title = Paquete de colección de escenas
workspace-pack-export = Exportar paquete…
workspace-pack-exporting = Exportando…
workspace-pack-import = Importar paquete…
workspace-pack-importing = Importando…
workspace-pack-hint = Un .fcappack empaqueta la colección activa junto con sus recursos locales en un único archivo portátil — comparte un diseño completo, sin servidor. Importar lo carga como una nueva colección y cambia a ella.
workspace-pack-exported = «{ $name }» exportada — { $bundled } recurso(s) empaquetado(s), { $external } externo(s).
workspace-pack-imported = «{ $name }» importada — { $scenes } escena(s), { $relinked } recurso(s) revinculado(s), { $external } externo(s).
workspace-compare = Comparar y combinar…
compare-title = Comparar y combinar
compare-intro = Compara la colección activa con otra e incorpora solo los cambios que elijas. Nada sale de este equipo.
compare-target-label = Comparar con
compare-target-none = Elige una colección…
compare-target-pack = Desde un archivo de paquete…
compare-against = vs { $name }
compare-comparing = Comparando…
compare-no-diff = Sin diferencias — las colecciones coinciden.
compare-select-all = Seleccionar todo
compare-clear = Borrar
compare-merge-hint = Elegir una escena también incorpora las fuentes que usa.
compare-sources-title = Fuentes
compare-scenes-title = Escenas
compare-kind-added = Añadido
compare-kind-removed = Eliminado
compare-kind-modified = Cambiado
compare-renamed = era «{ $from }»
compare-reordered = reordenado
compare-apply = Aplicar { $count }
compare-apply-none = Selecciona cambios para aplicar
compare-applying = Aplicando…
compare-aspect-source = fuente
compare-aspect-transform = posición
compare-aspect-visibility = visibilidad
compare-aspect-outputs = salidas
compare-aspect-filters = filtros
compare-aspect-lock = bloqueo
compare-aspect-blend = fusión
compare-aspect-scaling = escalado
compare-aspect-backdrop = fondo
compare-aspect-reveal = revelado
compare-aspect-name = nombre
compare-aspect-settings = ajustes
compare-aspect-audio = audio
workspace-snapshots = Instantáneas…
snapshots-title = Instantáneas
snapshots-intro = Puntos de control con nombre de esta colección a los que puedes volver — conservados a propósito, más allá del guardado automático y de deshacer. Almacenados localmente.
snapshots-name-placeholder = Nombra este punto de control…
snapshots-create = Guardar instantánea
snapshots-empty = Aún no hay instantáneas — guarda una para conservar un punto de control con nombre al que puedas volver.
snapshots-usage = { $count } de { $cap } conservadas · { $size }
snapshots-scenes = { $scenes } escenas · { $sources } fuentes
snapshots-restore = Restaurar
snapshots-compare = Comparar
snapshots-delete = Eliminar instantánea
snapshots-delete-aria = Eliminar instantánea «{ $name }»
snapshots-restore-confirm = ¿Restaurar esta instantánea? Tu diseño actual se guarda primero como una instantánea.

# --- Phase 8 (backup / theme editor / dock presets / settings search / quick actions) ---
workspace-backup = Copia de seguridad y restauración…
backup-title = Copia de seguridad y restauración
backup-intro = Guarda todo tu estudio — ajustes, perfiles, colecciones de escenas — en un archivo, y restáuralo aquí o en un equipo nuevo.
backup-export = Exportar copia de seguridad…
backup-exporting = Exportando…
backup-exported = Copia de { $collections } colección(es) y { $profiles } perfil(es) ({ $size }).
backup-restore = Restaurar desde copia de seguridad…
backup-secrets-note = Las claves de emisión y las contraseñas nunca se incluyen en una copia de seguridad — vuelve a introducirlas tras restaurar.
backup-restore-from = Copia creada el { $created } (v{ $version })
backup-restore-settings = Ajustes
backup-restore-collections = Colecciones de escenas ({ $count })
backup-restore-profiles = Perfiles ({ $count })
backup-restore-apply = Restaurar seleccionados
backup-restoring = Restaurando…
backup-restored = Restaurado.
backup-restart-note = Reinicia Freally Capture para cargar las colecciones y perfiles restaurados.
backup-cancel = Cancelar
theme-editor-title = Paleta personalizada
theme-color-bg = Fondo
theme-color-panel = Panel
theme-color-text = Texto
theme-color-muted = Atenuado
theme-color-accent = Acento
theme-color-accent2 = Acento 2
theme-contrast-text-bg = Texto sobre fondo
theme-contrast-text-panel = Texto sobre panel
theme-contrast-muted-bg = Atenuado sobre fondo
theme-contrast-accent-bg = Acento sobre fondo
theme-contrast-low = (objetivo ≥ { $min }:1)
theme-reset = Restablecer a oscuro
theme-export = Exportar .fctheme…
theme-import = Importar .fctheme…
workspace-dock-presets = Diseños de paneles
workspace-dock-preset-placeholder = Guardar diseño actual como…
workspace-dock-preset-save = Guardar
workspace-dock-preset-apply = Cambiar a «{ $name }»
workspace-dock-preset-delete = Eliminar diseño «{ $name }»
workspace-dock-presets-hint = Un diseño recuerda el panel de estadísticas y la orientación del mezclador. Haz clic en uno para cambiar a él.
...
menu-tools-quick-actions = Acciones rápidas…
menu-tools-featured-chat = Mensaje de chat destacado…
quick-actions-title = Acciones rápidas
quick-actions-empty = Aún no hay botones — haz clic en Editar para añadir algunos.
quick-actions-edit = Editar
quick-actions-done = Listo
quick-actions-add-page = Página
quick-actions-label = Etiqueta del botón
quick-actions-color = Color del botón
quick-actions-add = Añadir botón
quick-actions-remove = Quitar «{ $name }»
quick-actions-delete-page = Eliminar «{ $name }»
quick-actions-hint = Los botones ejecutan los mismos comandos del estudio que las teclas rápidas y el panel LAN — también escenas, macros y pads del soundboard. Los botones de comando también aparecen en el panel LAN.
quick-actions-cmd-transition = Transición
quick-actions-cmd-startStream = En directo
quick-actions-cmd-stopStream = Finalizar emisión
quick-actions-cmd-startRecording = Iniciar grabación
quick-actions-cmd-stopRecording = Detener grabación
quick-actions-cmd-pauseRecording = Pausar grabación
quick-actions-cmd-addMarker = Añadir marcador
quick-actions-cmd-armReplay = Preparar repetición
quick-actions-cmd-saveReplay = Guardar repetición
quick-actions-cmd-setStudioMode = Alternar modo estudio
quick-actions-cmd-scene = Cambiar a escena…
quick-actions-cmd-macro = Ejecutar macro…
quick-actions-cmd-soundboard = Pad del soundboard…
quick-actions-value-scene = Nombre de escena
quick-actions-value-macro = Nombre de macro
quick-actions-value-soundboard = ID del pad
teleprompter-stop = Detener
about-portable-on = Modo portátil: activado — todos los datos de la app se guardan junto a la app.
about-portable-off = Modo portátil: desactivado. Añade un archivo «{ $marker }» junto a la app para ejecutarla de forma totalmente autónoma (modo memoria USB).
about-portable-data = Carpeta de datos: { $path }
...
palette-featured-chat = Mensaje de chat destacado…
featured-chat-title = Mensaje de chat destacado
featured-chat-intro = Fija cualquier línea de chat reciente como un banner inferior en el programa; los espectadores del directo y la grabación lo ven. La fijación se borra al reiniciar; los colores se conservan.
featured-chat-empty = Aún no hay chat: añade una fuente de superposición de chat y apúntala a tu canal; las líneas aparecerán aquí al llegar.
featured-chat-pinned = En el programa:
featured-chat-pin = Destacar
featured-chat-clear = Quitar
featured-chat-bg = Color del banner
featured-chat-text = Color del texto
featured-chat-note = El banner se sitúa abajo al centro, sobre todas las escenas; quítalo para sacarlo del aire.
...
sources-visualizer-classic = Colores clásicos
...
menu-collection-clear = Borrar historial…
menu-collection-clear-confirm = ¿Eliminar permanentemente estas colecciones de escenas y sus archivos? { $names }: se conserva la colección activa «{ $active }». Esto no se puede deshacer.
...
telestrator-draw = Dibujar
telestrator-tool-pen = Bolígrafo
telestrator-tool-highlight = Marcador
telestrator-tool-arrow = Flecha
telestrator-tool-ellipse = Elipse
telestrator-color = Color
telestrator-width = Grosor
telestrator-whiteboard = Modo pizarra
telestrator-persist = Mantener
telestrator-fade = Desvanecer
telestrator-undo = Deshacer última marca
telestrator-clear = Borrar marcas
hotkeys-telestrator-clear = Telestrator: borrar marcas

# --- Teleprompter (CAP-N58) ---
teleprompter-title = Teleprónter
teleprompter-loading = Cargando…
teleprompter-empty = Aún no hay guion — añade uno en el panel del teleprónter.
teleprompter-script = Guion
teleprompter-script-placeholder = Escribe o pega tu guion…
teleprompter-top = Inicio
teleprompter-slower = Más lento
teleprompter-play = Reproducir
teleprompter-pause = Pausa
teleprompter-faster = Más rápido
teleprompter-step-back = Retroceder
teleprompter-step-forward = Avanzar
teleprompter-est-time = Tiempo de lectura
teleprompter-caesura-hint = Escribe -- para una pausa
teleprompter-caesura-pause = Pausa de cesura — Escribe -- para una pausa
teleprompter-countdown = Iniciar cuenta atrás
teleprompter-countdown-secs = Cuenta atrás (segundos)
teleprompter-speed = Velocidad (caracteres/s)
teleprompter-speed-bpm = Velocidad (BPM)
teleprompter-bpm-mode = Modo BPM (canto)
teleprompter-font = Tamaño de fuente
teleprompter-mirror = Espejo (cristal)
teleprompter-open-projector = Abrir proyector
teleprompter-preview = Vista previa
teleprompter-remote-hint = Controla el desplazamiento con un atajo, MIDI o el panel LAN mientras esto está cerrado.
teleprompter-read-aloud = Leer en voz alta con la síntesis de voz del sistema operativo
menu-tools-teleprompter = Teleprónter
hotkeys-teleprompter-toggle = Teleprónter: reproducir / pausar

# --- Remote guests: green room / cues / QoS / auto-grid (CAP-N54–N56, N59) ---
remote-hosting-count = Alojando { $count } invitado(s)
remote-green-room-default = Sala de espera
remote-green-room-default-title = Los nuevos invitados esperan en la sala hasta que los sientes
remote-auto-grid = Cuadrícula automática
remote-auto-grid-title = Mantén a los invitados en cuadrícula al entrar y salir
remote-arrange-grid = Organizar cuadrícula
remote-arrange-grid-title = Reorganizar ahora a los invitados sentados en cuadrícula
remote-green-room-monitor = Vista de la sala de espera
remote-tech-cam-ok = Cámara ✓
remote-tech-cam-no = Sin cámara
remote-tech-mic-ok = Micro ✓
remote-tech-mic-no = Sin micro
remote-seat-on-air = Poner al aire
remote-cues-label = Indicaciones
remote-cue = Aviso
remote-cue-thirty = 30 segundos
remote-cue-wrap = Ve terminando
remote-cue-next = Eres el siguiente
remote-cue-speak = Habla más alto
remote-qos-good = Conexión buena
remote-qos-fair = Conexión regular
remote-qos-poor = Conexión mala
remote-green-room-guest = Estás en la sala de espera — el anfitrión te pondrá al aire en breve.

# --- Hotkey audit — Phase 7 actions ---
hotkey-audit-action-telestrator-clear = Telestrator: borrar marcas
hotkey-audit-action-teleprompter-toggle = Teleprónter: reproducir / pausar
hotkey-audit-feature-telestrator = Telestrator
hotkey-audit-feature-teleprompter = Teleprónter

# V1-C — Starting Soon countdown slate
sources-add-starting-soon = Empezamos pronto…
sources-starting-soon-title = Empezamos pronto
sources-starting-soon-default = Empezamos pronto
sources-starting-soon-message = Mensaje
sources-starting-soon-minutes = Minutos
sources-starting-soon-hours = Horas
sources-starting-soon-start-at = Empezar a las
sources-starting-soon-music = Música de fondo…
sources-starting-soon-music-name = Música de fondo
sources-starting-soon-background = Fondo
sources-starting-soon-note = Una cuenta atrás a pantalla completa que parpadea en rojo y se detiene en cero: bórrala y corta a tu escena en directo a mano cuando estés listo.
sources-starting-soon-add = Añadir
sources-slate-solid = Color sólido
sources-slate-gradient = Degradado
sources-slate-transparent = Transparente
sources-slate-image = Imagen
sources-slate-file = Imagen / Vídeo / GIF
sources-slate-browse = Examinar…
sources-starting-soon-choose-image = Elegir imagen…
sources-slate-media-note = Las imágenes fijas se incrustan aquí. Para un vídeo o GIF de fondo en bucle, elige «Transparente» y define el fondo de la escena (el 🖼 en la barra de escenas): la cuenta atrás queda encima.
properties-timer-slate = Pantalla «Empezamos pronto»
properties-timer-slate-off = Desactivado (texto en línea)
properties-timer-message = Mensaje
properties-timer-slate-color = Color de la pantalla
properties-timer-slate-from = Desde
properties-timer-slate-to = Hasta
properties-timer-slate-note = Transparente deja ver una imagen, un vídeo o un fondo de escena por debajo de la pantalla.
...
sources-browser-component-missing = Necesita el componente Browser Runtime: instálalo en Herramientas → Componentes.
