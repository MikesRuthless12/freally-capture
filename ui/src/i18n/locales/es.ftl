...
hotkeys-timer-toggle-placeholder = p. ej. Ctrl+Shift+T
hotkeys-timer-reset = Reiniciar todos los temporizadores
hotkeys-timer-reset-placeholder = p. ej. Ctrl+Shift+0
...
controls-automation = Automatización
...
hotkeys-split-placeholder = p. ej. Numpad1
...
hotkeys-playlist-placeholder = p. ej. Ctrl+Alt+Right
...
hotkeys-replay-roll-placeholder = p. ej. Ctrl+Shift+I
