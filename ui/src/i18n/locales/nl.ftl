...
sources-add-background-music = Achtergrondmuziek…
sources-background-music-note = Herhaalt, hoorbaar in preview en opgenomen/gestreamd. Gebruik muziek in plaats van videogeluid door de Backdrop-strip van de video te dempen.
...
sources-stream-hide = Verbergen in stream
sources-stream-show = Tonen in stream
sources-stream-hide-item = { $name } verbergen in stream
sources-stream-show-item = { $name } tonen in stream
sources-record-hide = Verbergen in opname
sources-record-show = Tonen in opname
sources-record-hide-item = { $name } verbergen in opname
sources-record-show-item = { $name } tonen in opname
...
controls-iso-lanes = ISO-lanes die naast het programma opnemen: { $count }
...
ltc-intro = Genereer lineaire SMPTE-timecode op een track en lees binnenkomende LTC van elke audio-ingang — klassieke audiotimecode om externe recorders en camera's in de post te synchroniseren. Volledig offline.
ltc-generate = LTC op een track genereren
ltc-track = Timecode-track
ltc-track-option = Track { $track }
ltc-fps = Framerate
ltc-read = LTC lezen van
ltc-read-off = Uit
ltc-decoded = Binnenkomende timecode
ltc-no-lock = geen signaal
ltc-note = De generator jam-synct op de tijd van de dag, non-drop. Neem zijn track op (wijs die toe in Uitvoer) of route hem naar een uitgang voor externe apparatuur. De lezer voedt de timecode-regel van de statistiek-overlay en stempelt hoofdstukmarkers.
...
stats-rehearsal-note = Repetitie — doelen publiceren alleen naar een lokale sink
stats-timeline-open = Tijdlijn
timeline-title = Sessietijdlijn
timeline-empty = Nog niets opgenomen — de tijdlijn registreert terwijl je streamt of opneemt.
timeline-live = LIVE — neemt nog op
timeline-fit = Passend
timeline-legend-fps = fps
timeline-legend-behind = encoderwachtrij (frames achter)
...
scenes-recent-clear = Wissen
scenes-recent-clear-confirm = Lijst met recente scènes wissen?
...
livebutton-rehearse = Repeteren
livebutton-rehearse-record-confirm = Deze repetitie ook opnemen als videobestand?
livebutton-rehearse-title = Draai de hele show tegen een lokale sink — er wordt niets verzonden
livebutton-end-rehearsal = Repetitie beëindigen
livebutton-title-rehearsing = Er loopt een repetitie — niets verlaat deze machine
livebutton-badge-rehearsal = REPETITIE
livebutton-aria-rehearsal = Repetitie bezig
livebutton-rehearsal-banner = Repetitie — niets verlaat deze machine
...
properties-timer-clock = Aftellen naar een kloktijd
...
filters-name-perspective = Perspectief
filters-name-fade-loop = Fade-lus
...
filters-tilt = Kanteling
filters-far-fade = Vervagen in de verte
filters-fade-in-s = Infaden (s)
filters-visible-s = Zichtbaar (s)
filters-fade-out-s = Uitfaden (s)
...
recordings-trim-title = Knip een clip uit deze opname — keyframe-uitgelijnde sneden exporteren zonder heren­coderen
recordings-verify = Verifiëren
recordings-verify-title = Controleer de integriteit van het bestand — containerstructuur, continuïteit, A/V-interleave, duur
recordings-verifying = Verifiëren…
verify-dismiss = Sluiten
verify-verdict-pass = { $name } — integriteit in orde
verify-verdict-warn = { $name } — geverifieerd met waarschuwingen
verify-verdict-fail = { $name } — problemen gevonden
verify-container = Container
verify-video-continuity = Videocontinuïteit
verify-audio-continuity = Audiocontinuïteit
verify-av-interleave = A/V-interleave
verify-duration = Duur
recordings-alpha-label = alfa
recordings-prores-title = Een alfa-behoudend ProRes 4444 .mov-master exporteren (voor montage)
recordings-qtrle-title = Een alfa-behoudende QuickTime Animation .mov exporteren (maximale compatibiliteit)
trim-title = Trimmen — { $name }
trim-loading = Bestand wordt gelezen…
trim-preview-alt = Voorbeeldframe
trim-position = Afspeelpositie
trim-step-second-back = Één seconde terug
trim-step-frame-back = Één frame terug
trim-step-frame-forward = Één frame vooruit
trim-step-second-forward = Één seconde vooruit
trim-snap = Keyframe
trim-snap-title = Uitlijnen op het dichtstbijzijnde keyframe — een snede daar exporteert zonder herencoderen
trim-set-in = In-punt
trim-set-out = Uit-punt
trim-range-invalid = Het uit-punt moet na het in-punt komen.
trim-copy-badge = ✓ Exporteert zonder herencoderen — het in-punt ligt op een keyframe.
trim-reencode-badge = Wordt opnieuw gecodeerd: het in-punt ligt tussen keyframes (gebruik "Keyframe" voor een verliesvrije snede).
trim-export = Clip exporteren
trim-export-916 = 9:16
trim-export-916-title = Verticaal hergekadreerd exporteren (gecentreerde bijsnijding op de verticale canvasgrootte) — codeert altijd opnieuw
...
bench-open = Encoder-benchmark uitvoeren…
bench-title = Encoder-benchmark
bench-intro = Draait korte gemeten encode-ladders (elke gedetecteerde encoder × preset × resolutie) op deze machine — ongeveer een minuut, volledig offline, niets verlaat je computer. Mislukkingen worden getoond, nooit verborgen. Stop eerst stream of opname.
bench-start = Benchmark starten
bench-rerun = Opnieuw draaien
bench-running = Meten… { $done } / { $total }
bench-cancel = Annuleren
bench-col-encoder = Encoder
bench-col-preset = Preset
bench-col-rung = Trede
bench-col-achieved = fps
bench-col-headroom = Marge
bench-failed = mislukt
bench-rec-title = Aanbeveling (gemeten)
bench-rec-body = { $encoder } op { $preset }, { $width }×{ $height } @ { $fps } fps — gemeten { $headroom }× realtime. Voorgestelde stream-bitrate: { $bitrate } kbps.
bench-rec-none = Niets houdt realtime vol op deze machine — verlaag de canvasresolutie of fps en meet opnieuw.
bench-apply = Toepassen op opname-instellingen
bench-applied = Toegepast ✓
...
output-iso-heading = ISO-opname
output-iso-explainer = Neem geselecteerde bronnen schoon op, elk in een eigen bestand naast het programma — vóór compositing, op canvasgrootte en -framerate, zodat elk bestand uitgelijnd op een montagetijdlijn valt. Twee lanes zijn comfortabel op een midrange GPU; elke extra lane kost een extra render en encode.
output-iso-none = Nog geen bronnen in de collectie.
output-iso-source-on = “{ $name }” wordt als eigen ISO-bestand opgenomen — klik om te stoppen
output-iso-source-off = “{ $name }” als eigen ISO-bestand opnemen
output-iso-post-filter = Opnemen met de filters van de bron (post-filter); uitgevinkt wordt de ruwe bron opgenomen
...
output-split-on-rundown = rundown-stap
output-auto-markers = Automatisch hoofdstukmarkers plaatsen bij studiogebeurtenissen (scènewissel, replay opgeslagen, reconnect, gevallen frames, alarmen, regels)
output-auto-markers-title = Getypeerde markers landen in de hoofdstukken van de opname (mkv) of het .chapters.txt-bestand, naast de handmatige marker-sneltoets
output-pipeline-heading = Pipeline na opname
output-pipeline-explainer = Na het afronden van een opname draaien deze stappen op het hoofdbestand, op volgorde, op de achtergrond. Een gesloten actieset — er is bewust geen stap "voer een commando uit". De keten stopt bij de eerste fout.
output-pipeline-enabled = Pipeline na elke opname uitvoeren
output-pipeline-add = Stap toevoegen…
output-pipeline-up = Omhoog
output-pipeline-down = Omlaag
output-pipeline-remove = Stap verwijderen
output-pipeline-template = Hernoemsjabloon (CAP-M25-tokens)
output-pipeline-folder = Map
pipeline-queue = Pipeline na opname
pipeline-verify = Verifiëren
pipeline-remux = Remuxen naar MP4
pipeline-normalize = Luidheid normaliseren
pipeline-rename = Hernoemen
pipeline-move = Verplaatsen naar map
pipeline-copy = Kopiëren naar map
pipeline-reveal = Tonen in bestandsbeheer
pipeline-luaEvent = Lua-scripts melden
...
stream-session-report = Schrijf bij het einde een sessierapport (HTML + Markdown) naast de opname
stream-simulator-title = Netwerksimulator (repetities)
stream-simulator-note = Vormt alleen de lokale sinks van de repetitie — oefent reconnects en trage uplinks. Een echte Go Live wordt nooit belemmerd.
stream-simulator-profile = Profiel
stream-simulator-off = Uit
stream-simulator-hotel-wifi = Hotel-wifi
stream-simulator-mobile-hotspot = Mobiele hotspot
stream-simulator-custom = Aangepast
stream-simulator-bandwidth = Bandbreedte (kbps, 0 = onbeperkt)
stream-simulator-latency = Latentie (ms)
stream-simulator-jitter = Jitter (± ms)
stream-simulator-outage-every = Storing elke (s, 0 = nooit)
stream-simulator-outage-len = Storingsduur (s)
...
workspace-pack-title = Scènecollectie-pakket
workspace-pack-export = Pakket exporteren…
workspace-pack-exporting = Exporteren…
workspace-pack-import = Pakket importeren…
workspace-pack-importing = Importeren…
workspace-pack-hint = Een .fcappack bundelt de actieve collectie plus de lokale assets in één draagbaar bestand — deel een hele lay-out, zonder server. Importeren zet het neer als een nieuwe collectie en schakelt ernaartoe.
workspace-pack-exported = "{ $name }" geëxporteerd — { $bundled } asset(s) gebundeld, { $external } extern.
workspace-pack-imported = "{ $name }" geïmporteerd — { $scenes } scène(s), { $relinked } asset(s) opnieuw gekoppeld, { $external } extern.
workspace-compare = Vergelijken & samenvoegen…
compare-title = Vergelijken & samenvoegen
compare-intro = Vergelijk de actieve verzameling met een andere en neem alleen de wijzigingen over die je kiest. Niets verlaat deze machine.
compare-target-label = Vergelijken met
compare-target-none = Kies een verzameling…
compare-target-pack = Uit een pakketbestand…
compare-against = vs { $name }
compare-comparing = Vergelijken…
compare-no-diff = Geen verschillen — de verzamelingen komen overeen.
compare-select-all = Alles selecteren
compare-clear = Wissen
compare-merge-hint = Een scène kiezen neemt ook de bronnen mee die deze gebruikt.
compare-sources-title = Bronnen
compare-scenes-title = Scènes
compare-kind-added = Toegevoegd
compare-kind-removed = Verwijderd
compare-kind-modified = Gewijzigd
compare-renamed = was "{ $from }"
compare-reordered = herschikt
compare-apply = { $count } toepassen
compare-apply-none = Selecteer wijzigingen om toe te passen
compare-applying = Toepassen…
compare-aspect-source = bron
compare-aspect-transform = positie
compare-aspect-visibility = zichtbaarheid
compare-aspect-outputs = uitgangen
compare-aspect-filters = filters
compare-aspect-lock = vergrendeling
compare-aspect-blend = overvloeien
compare-aspect-scaling = schaling
compare-aspect-backdrop = achtergrond
compare-aspect-reveal = onthullen
compare-aspect-name = naam
compare-aspect-settings = instellingen
compare-aspect-audio = audio
workspace-snapshots = Momentopnamen…
snapshots-title = Momentopnamen
snapshots-intro = Benoemde controlepunten van deze verzameling waarnaar je kunt terugkeren — bewust bewaard, buiten automatisch opslaan en ongedaan maken om. Lokaal opgeslagen.
snapshots-name-placeholder = Geef dit controlepunt een naam…
snapshots-create = Momentopname opslaan
snapshots-empty = Nog geen momentopnamen — sla er een op om een benoemd controlepunt te bewaren waarnaar je kunt terugkeren.
snapshots-usage = { $count } van { $cap } bewaard · { $size }
snapshots-scenes = { $scenes } scènes · { $sources } bronnen
snapshots-restore = Herstellen
snapshots-compare = Vergelijken
snapshots-delete = Momentopname verwijderen
snapshots-delete-aria = Momentopname "{ $name }" verwijderen
snapshots-restore-confirm = Deze momentopname herstellen? Je huidige lay-out wordt eerst als momentopname opgeslagen.

# --- Phase 8 (backup / theme editor / dock presets / settings search / quick actions) ---
workspace-backup = Back-up en herstel…
backup-title = Back-up en herstel
backup-intro = Sla je hele studio — instellingen, profielen, scèneverzamelingen — op in één bestand en herstel het hier of op een nieuwe machine.
backup-export = Back-up exporteren…
backup-exporting = Exporteren…
backup-exported = Back-up gemaakt van { $collections } verzameling(en) en { $profiles } profiel(en) ({ $size }).
backup-restore = Herstellen vanuit back-up…
backup-secrets-note = Streamsleutels en wachtwoorden zitten nooit in een back-up — voer ze na het herstellen opnieuw in.
backup-restore-from = Back-up gemaakt op { $created } (v{ $version })
backup-restore-settings = Instellingen
backup-restore-collections = Scèneverzamelingen ({ $count })
backup-restore-profiles = Profielen ({ $count })
backup-restore-apply = Geselecteerde herstellen
backup-restoring = Herstellen…
backup-restored = Hersteld.
backup-restart-note = Start Freally Capture opnieuw op om de herstelde verzamelingen en profielen te laden.
backup-cancel = Annuleren
theme-editor-title = Aangepast palet
theme-color-bg = Achtergrond
theme-color-panel = Paneel
theme-color-text = Tekst
theme-color-muted = Gedempt
theme-color-accent = Accent
theme-color-accent2 = Accent 2
theme-contrast-text-bg = Tekst op achtergrond
theme-contrast-text-panel = Tekst op paneel
theme-contrast-muted-bg = Gedempt op achtergrond
theme-contrast-accent-bg = Accent op achtergrond
theme-contrast-low = (streef naar ≥ { $min }:1)
theme-reset = Terug naar donker
theme-export = .fctheme exporteren…
theme-import = .fctheme importeren…
workspace-dock-presets = Dockindelingen
workspace-dock-preset-placeholder = Huidige indeling opslaan als…
workspace-dock-preset-save = Opslaan
workspace-dock-preset-apply = Overschakelen naar "{ $name }"
workspace-dock-preset-delete = Indeling "{ $name }" verwijderen
workspace-dock-presets-hint = Een indeling onthoudt het statistiekenpaneel en de mixerstand. Klik op een indeling om ernaar over te schakelen.
...
menu-tools-quick-actions = Snelacties…
menu-tools-featured-chat = Uitgelicht chatbericht…
quick-actions-title = Snelacties
quick-actions-empty = Nog geen knoppen — klik op Bewerken om er toe te voegen.
quick-actions-edit = Bewerken
quick-actions-done = Klaar
quick-actions-add-page = Pagina
quick-actions-label = Knoplabel
quick-actions-color = Knopkleur
quick-actions-add = Knop toevoegen
quick-actions-remove = "{ $name }" verwijderen
quick-actions-delete-page = "{ $name }" verwijderen
quick-actions-hint = Knoppen activeren dezelfde studiocommando's als sneltoetsen en het LAN-paneel — ook scènes, macro's en soundboardpads. Commandoknoppen verschijnen ook op het LAN-paneel.
quick-actions-cmd-transition = Overgang
quick-actions-cmd-startStream = Ga live
quick-actions-cmd-stopStream = Stream beëindigen
quick-actions-cmd-startRecording = Opname starten
quick-actions-cmd-stopRecording = Opname stoppen
quick-actions-cmd-pauseRecording = Opname pauzeren
quick-actions-cmd-addMarker = Marker toevoegen
quick-actions-cmd-armReplay = Replay activeren
quick-actions-cmd-saveReplay = Replay opslaan
quick-actions-cmd-setStudioMode = Studiomodus schakelen
quick-actions-cmd-scene = Overschakelen naar scène…
quick-actions-cmd-macro = Macro uitvoeren…
quick-actions-cmd-soundboard = Soundboardpad…
quick-actions-value-scene = Scènenaam
quick-actions-value-macro = Macronaam
quick-actions-value-soundboard = Pad-id
teleprompter-stop = Stoppen
about-portable-on = Draagbare modus: aan — alle app-gegevens worden naast de app opgeslagen.
about-portable-off = Draagbare modus: uit. Zet een bestand "{ $marker }" naast de app om deze volledig zelfstandig te draaien (USB-stickmodus).
about-portable-data = Gegevensmap: { $path }
...
history-toggleOutputVisibility = Uitvoer-zichtbaarheid wisselen
...
palette-featured-chat = Uitgelicht chatbericht…
featured-chat-title = Uitgelicht chatbericht
featured-chat-intro = Zet een recente chatregel vast als banner onderaan het programma — kijkers van de stream en opname zien hem. De pin verdwijnt bij herstart; de kleuren blijven.
featured-chat-empty = Nog geen chat — voeg een Chat-overlaybron toe en richt hem op je kanaal; regels verschijnen hier zodra ze binnenkomen.
featured-chat-pinned = In het programma:
featured-chat-pin = Uitlichten
featured-chat-clear = Weghalen
featured-chat-bg = Bannerkleur
featured-chat-text = Tekstkleur
featured-chat-note = De banner staat onder in het midden, boven elke scène — haal hem weg om hem uit beeld te nemen.
...
properties-stats-show-timecode = Timecode tonen (LTC)
...
sources-visualizer-classic = Klassieke kleuren
...
menu-collection-clear = Geschiedenis wissen…
menu-collection-clear-confirm = Deze scèneverzamelingen en hun bestanden definitief verwijderen? { $names } — de actieve verzameling "{ $active }" blijft behouden. Dit kan niet ongedaan worden gemaakt.
...
telestrator-draw = Tekenen
telestrator-tool-pen = Pen
telestrator-tool-highlight = Markeerstift
telestrator-tool-arrow = Pijl
telestrator-tool-ellipse = Ellips
telestrator-color = Kleur
telestrator-width = Dikte
telestrator-whiteboard = Whiteboardmodus
telestrator-persist = Behouden
telestrator-fade = Vervagen
telestrator-undo = Laatste markering ongedaan maken
telestrator-clear = Markeringen wissen
hotkeys-telestrator-clear = Telestrator: markeringen wissen

# --- Teleprompter (CAP-N58) ---
teleprompter-title = Teleprompter
teleprompter-loading = Laden…
teleprompter-empty = Nog geen script — voeg er een toe in het teleprompterpaneel.
teleprompter-script = Script
teleprompter-script-placeholder = Typ of plak je script…
teleprompter-top = Begin
teleprompter-slower = Langzamer
teleprompter-play = Afspelen
teleprompter-pause = Pauze
teleprompter-faster = Sneller
teleprompter-step-back = Stap terug
teleprompter-step-forward = Stap vooruit
teleprompter-est-time = Leestijd
teleprompter-caesura-hint = Typ -- voor een pauze
teleprompter-caesura-pause = Cesuurpauze — Typ -- voor een pauze
teleprompter-countdown = Aftellen starten
teleprompter-countdown-secs = Aftellen (seconden)
teleprompter-speed = Snelheid (tekens/s)
teleprompter-speed-bpm = Snelheid (BPM)
teleprompter-bpm-mode = BPM-modus (zang)
teleprompter-font = Tekengrootte
teleprompter-mirror = Spiegelen (glas)
teleprompter-open-projector = Projector openen
teleprompter-preview = Voorbeeld
teleprompter-remote-hint = Bedien het scrollen met een sneltoets, MIDI of het LAN-paneel terwijl dit gesloten is.
teleprompter-read-aloud = Hardop voorlezen met de spraaksynthese van het besturingssysteem
menu-tools-teleprompter = Teleprompter
hotkeys-teleprompter-toggle = Teleprompter: afspelen / pauze

# --- Remote guests: green room / cues / QoS / auto-grid (CAP-N54–N56, N59) ---
remote-hosting-count = { $count } gast(en) hosten
remote-green-room-default = Wachtruimte
remote-green-room-default-title = Nieuwe gasten wachten in de wachtruimte tot je ze plaatst
remote-auto-grid = Auto-raster
remote-auto-grid-title = Gasten automatisch in een raster houden bij komen en gaan
remote-arrange-grid = Raster schikken
remote-arrange-grid-title = De geplaatste gasten nu in een raster herschikken
remote-green-room-monitor = Wachtruimte-voorbeeld
remote-tech-cam-ok = Cam ✓
remote-tech-cam-no = Geen cam
remote-tech-mic-ok = Mic ✓
remote-tech-mic-no = Geen mic
remote-seat-on-air = In de uitzending zetten
remote-cues-label = Cues
remote-cue = Cue
remote-cue-thirty = 30 seconden
remote-cue-wrap = Rond af
remote-cue-next = Jij bent zo aan de beurt
remote-cue-speak = Spreek luider
remote-qos-good = Verbinding goed
remote-qos-fair = Verbinding matig
remote-qos-poor = Verbinding slecht
remote-green-room-guest = Je bent in de wachtruimte — de host zet je zo in de uitzending.

# --- Hotkey audit — Phase 7 actions ---
hotkey-audit-action-telestrator-clear = Telestrator: markeringen wissen
hotkey-audit-action-teleprompter-toggle = Teleprompter: afspelen / pauze
...
sources-add-starting-soon = Begint zo…
sources-starting-soon-title = Begint zo
sources-starting-soon-default = Begint zo
sources-starting-soon-message = Bericht
sources-starting-soon-minutes = Minuten
sources-starting-soon-hours = Uren
sources-starting-soon-start-at = Begint om
sources-starting-soon-music = Achtergrondmuziek…
sources-starting-soon-music-name = Achtergrondmuziek
sources-starting-soon-background = Achtergrond
sources-starting-soon-note = Een schermvullende aftelling die bij nul rood knippert en blijft staan — wis hem en schakel handmatig naar je live-scène wanneer je klaar bent.
sources-starting-soon-add = Toevoegen
sources-slate-solid = Effen kleur
sources-slate-gradient = Verloop
sources-slate-transparent = Transparant
sources-slate-image = Afbeelding
sources-slate-file = Afbeelding / Video / GIF
sources-slate-browse = Bladeren…
sources-starting-soon-choose-image = Afbeelding kiezen…
sources-slate-media-note = Stilstaande afbeeldingen worden hier ingesloten. Voor een lopende video of GIF als achtergrond kies je 'Transparant' en stel je de scène-achtergrond in (de 🖼 in de scènebalk) — de aftelling staat erbovenop.
properties-timer-slate = 'Begint zo'-scherm
properties-timer-slate-off = Uit (inline-tekst)
properties-timer-message = Bericht
properties-timer-slate-color = Schermkleur
properties-timer-slate-from = Van
properties-timer-slate-to = Tot
properties-timer-slate-note = Transparant laat een afbeelding, video of scène-achtergrond onder het scherm doorschijnen.
