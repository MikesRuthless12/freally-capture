...
hotkeys-timer-toggle-placeholder = bijv. Ctrl+Shift+T
hotkeys-timer-reset = Alle timers resetten
hotkeys-timer-reset-placeholder = bijv. Ctrl+Shift+0
...
controls-automation = Automatisering
...
hotkeys-split-placeholder = bijv. Numpad1
...
hotkeys-playlist-placeholder = bijv. Ctrl+Alt+Right
...
hotkeys-replay-roll-placeholder = bijv. Ctrl+Shift+I
