...
sources-add-background-music = Arka plan müziği…
sources-background-music-note = Döngüde çalar, önizlemede duyulur ve kayda/yayına alınır. Video sesi yerine müzik için, mikserde videonun Backdrop kanalını susturun.
sources-background-music-count = { $n } parça
sources-background-music-shuffle = Karıştır
...
scenes-recent-title = Son
scenes-recent-clear = Temizle
scenes-recent-clear-confirm = Son sahneler listesi temizlensin mi?
...
livebutton-rehearse-record-confirm = Bu provayı bir video dosyasına da kaydet?
...
properties-timer-clock = Bir saate geri sayım
...
workspace-pack-title = Sahne koleksiyonu paketi
workspace-pack-export = Paketi dışa aktar…
workspace-pack-exporting = Dışa aktarılıyor…
workspace-pack-import = Paket içe aktar…
workspace-pack-importing = İçe aktarılıyor…
workspace-pack-hint = Bir .fcappack, etkin koleksiyonu ve yerel varlıklarını tek bir taşınabilir dosyada bir araya getirir — sunucu olmadan tüm bir düzeni paylaşın. İçe aktarma, bunu yeni bir koleksiyon olarak yerleştirir ve ona geçer.
workspace-pack-exported = "{ $name }" dışa aktarıldı — { $bundled } varlık paketlendi, { $external } harici.
workspace-pack-imported = "{ $name }" içe aktarıldı — { $scenes } sahne, { $relinked } varlık yeniden bağlandı, { $external } harici.
workspace-compare = Karşılaştır ve birleştir…
compare-title = Karşılaştır ve birleştir
compare-intro = Etkin koleksiyonu bir başkasıyla karşılaştırın ve yalnızca seçtiğiniz değişiklikleri alın. Hiçbir şey bu makineden çıkmaz.
compare-target-label = Şununla karşılaştır
compare-target-none = Bir koleksiyon seçin…
compare-target-pack = Bir paket dosyasından…
compare-against = { $name } ile
compare-comparing = Karşılaştırılıyor…
compare-no-diff = Fark yok — koleksiyonlar eşleşiyor.
compare-select-all = Tümünü seç
compare-clear = Temizle
compare-merge-hint = Bir sahne seçmek, kullandığı kaynakları da getirir.
compare-sources-title = Kaynaklar
compare-scenes-title = Sahneler
compare-kind-added = Eklendi
compare-kind-removed = Kaldırıldı
compare-kind-modified = Değiştirildi
compare-renamed = eskiden "{ $from }"
compare-reordered = yeniden sıralandı
compare-apply = { $count } uygula
compare-apply-none = Uygulanacak değişiklikleri seçin
compare-applying = Uygulanıyor…
compare-aspect-source = kaynak
compare-aspect-transform = konum
compare-aspect-visibility = görünürlük
compare-aspect-outputs = çıkışlar
compare-aspect-filters = filtreler
compare-aspect-lock = kilit
compare-aspect-blend = karışım
compare-aspect-scaling = ölçekleme
compare-aspect-backdrop = arka plan
compare-aspect-reveal = ortaya çıkarma
compare-aspect-name = ad
compare-aspect-settings = ayarlar
compare-aspect-audio = ses
workspace-snapshots = Anlık görüntüler…
snapshots-title = Anlık görüntüler
snapshots-intro = Bu koleksiyonun dönebileceğiniz adlandırılmış kontrol noktaları — otomatik kaydetme ve geri almanın ötesinde, bilerek saklanır. Yerel olarak depolanır.
snapshots-name-placeholder = Bu kontrol noktasını adlandırın…
snapshots-create = Anlık görüntü kaydet
snapshots-empty = Henüz anlık görüntü yok — dönebileceğiniz adlandırılmış bir kontrol noktası tutmak için bir tane kaydedin.
snapshots-usage = { $cap } içinden { $count } tutuldu · { $size }
snapshots-scenes = { $scenes } sahne · { $sources } kaynak
snapshots-restore = Geri yükle
snapshots-compare = Karşılaştır
snapshots-delete = Anlık görüntüyü sil
snapshots-delete-aria = "{ $name }" anlık görüntüsünü sil
snapshots-restore-confirm = Bu anlık görüntü geri yüklensin mi? Mevcut düzeniniz önce anlık görüntü olarak kaydedilir.

# --- Phase 8 (backup / theme editor / dock presets / settings search / quick actions) ---
workspace-backup = Yedekle ve geri yükle…
backup-title = Yedekle ve geri yükle
backup-intro = Tüm stüdyonuzu — ayarlar, profiller, sahne koleksiyonları — tek bir dosyaya kaydedin, burada ya da yeni bir makinede geri yükleyin.
backup-export = Yedeği dışa aktar…
backup-exporting = Dışa aktarılıyor…
backup-exported = { $collections } koleksiyon ve { $profiles } profil yedeklendi ({ $size }).
backup-restore = Yedekten geri yükle…
backup-secrets-note = Yayın anahtarları ve parolalar bir yedeğe asla dahil edilmez — geri yükledikten sonra bunları yeniden girin.
backup-restore-from = Yedek { $created } tarihinde alındı (v{ $version })
backup-restore-settings = Ayarlar
backup-restore-collections = Sahne koleksiyonları ({ $count })
backup-restore-profiles = Profiller ({ $count })
backup-restore-apply = Seçileni geri yükle
backup-restoring = Geri yükleniyor…
backup-restored = Geri yüklendi.
backup-restart-note = Geri yüklenen koleksiyonları ve profilleri yüklemek için Freally Capture'ı yeniden başlatın.
backup-cancel = İptal
theme-editor-title = Özel palet
theme-color-bg = Arka plan
theme-color-panel = Panel
theme-color-text = Metin
theme-color-muted = Soluk
theme-color-accent = Vurgu
theme-color-accent2 = Vurgu 2
theme-contrast-text-bg = Arka planda metin
theme-contrast-text-panel = Panelde metin
theme-contrast-muted-bg = Arka planda soluk
theme-contrast-accent-bg = Arka planda vurgu
theme-contrast-low = (hedef ≥ { $min }:1)
theme-reset = Koyuya sıfırla
theme-export = .fctheme dışa aktar…
theme-import = .fctheme içe aktar…
workspace-dock-presets = Panel düzenleri
workspace-dock-preset-placeholder = Geçerli düzeni farklı kaydet…
workspace-dock-preset-save = Kaydet
workspace-dock-preset-apply = "{ $name }" düzenine geç
workspace-dock-preset-delete = "{ $name }" düzenini sil
workspace-dock-presets-hint = Bir düzen, istatistik panelini ve mikser yönünü hatırlar. Geçmek için birine tıklayın.
settings-search-placeholder = Ayarlarda ara…
settings-search-none = Eşleşen ayar yok.
settings-changed = Açıldığından beri değişti
menu-tools-quick-actions = Hızlı eylemler…
menu-tools-featured-chat = Öne çıkan sohbet mesajı…
quick-actions-title = Hızlı eylemler
quick-actions-empty = Henüz düğme yok — eklemek için Düzenle'ye tıklayın.
quick-actions-edit = Düzenle
quick-actions-done = Bitti
quick-actions-add-page = Sayfa
quick-actions-label = Düğme etiketi
quick-actions-color = Düğme rengi
quick-actions-add = Düğme ekle
quick-actions-remove = "{ $name }" kaldır
quick-actions-delete-page = "{ $name }" sil
quick-actions-hint = Düğmeler, kısayollar ve LAN paneliyle aynı stüdyo komutlarını çalıştırır — sahneler, makrolar ve ses tahtası pedleri de dahil. Komut düğmeleri LAN panelinde de görünür.
quick-actions-cmd-transition = Geçiş
quick-actions-cmd-startStream = Yayına başla
quick-actions-cmd-stopStream = Yayını bitir
quick-actions-cmd-startRecording = Kaydı başlat
quick-actions-cmd-stopRecording = Kaydı durdur
quick-actions-cmd-pauseRecording = Kaydı duraklat
quick-actions-cmd-addMarker = İşaretçi ekle
quick-actions-cmd-armReplay = Tekrarı hazırla
quick-actions-cmd-saveReplay = Tekrarı kaydet
quick-actions-cmd-setStudioMode = Stüdyo modunu değiştir
quick-actions-cmd-scene = Sahneye geç…
quick-actions-cmd-macro = Makro çalıştır…
quick-actions-cmd-soundboard = Ses tahtası pedi…
quick-actions-value-scene = Sahne adı
quick-actions-value-macro = Makro adı
quick-actions-value-soundboard = Ped kimliği
teleprompter-stop = Durdur
about-portable-on = Taşınabilir mod: açık — tüm uygulama verileri uygulamanın yanında saklanır.
about-portable-off = Taşınabilir mod: kapalı. Uygulamayı tümüyle kendi kendine yeter şekilde çalıştırmak için uygulamanın yanına bir "{ $marker }" dosyası ekleyin (USB bellek modu).
about-portable-data = Veri klasörü: { $path }
...
palette-featured-chat = Öne çıkan sohbet mesajı…
featured-chat-title = Öne çıkan sohbet mesajı
featured-chat-intro = Herhangi bir son sohbet satırını programın altına şık bir banner olarak sabitleyin — yayın ve kayıt izleyicileri görür. Sabitleme yeniden başlatınca silinir; renkler kalır.
featured-chat-empty = Henüz sohbet yok — bir Sohbet Katmanı kaynağı ekleyip kanalınıza yönlendirin; satırlar geldikçe burada görünür.
featured-chat-pinned = Programda:
featured-chat-pin = Öne çıkar
featured-chat-clear = Kaldır
featured-chat-bg = Banner rengi
featured-chat-text = Metin rengi
featured-chat-note = Banner tüm sahnelerin üstünde, alt ortada durur — yayından kaldırmak için temizleyin.
...
sources-visualizer-classic = Klasik renkler
...
menu-collection-clear = Geçmişi Temizle…
menu-collection-clear-confirm = Bu sahne koleksiyonlarını ve dosyalarını kalıcı olarak silmek istiyor musunuz? { $names } — etkin koleksiyon "{ $active }" korunur. Bu işlem geri alınamaz.
...
teleprompter-script-placeholder = Metninizi yazın veya yapıştırın…
...
teleprompter-step-back = Geri
teleprompter-step-forward = İleri
teleprompter-est-time = Okuma süresi
teleprompter-caesura-hint = Duraklama için -- yazın
teleprompter-caesura-pause = Duraklama — Duraklama için -- yazın
teleprompter-countdown = Geri sayımı başlat
teleprompter-countdown-secs = Geri sayım (saniye)
teleprompter-speed = Hız (karakter/sn)
teleprompter-speed-bpm = Hız (BPM)
teleprompter-bpm-mode = BPM modu (şarkı)
...
teleprompter-read-aloud = İşletim sistemi konuşma sentezi ile sesli oku
...
sources-add-starting-soon = Birazdan başlıyor…
sources-starting-soon-title = Birazdan başlıyor
sources-starting-soon-default = Birazdan başlıyor
sources-starting-soon-message = Mesaj
sources-starting-soon-minutes = Dakika
sources-starting-soon-hours = Saat
sources-starting-soon-start-at = Başlangıç saati
sources-starting-soon-music = Arka plan müziği…
sources-starting-soon-music-name = Arka plan müziği
sources-starting-soon-background = Arka plan
sources-starting-soon-note = Sıfırda kırmızı yanıp sönerek duran tam ekran geri sayım — hazır olduğunuzda temizleyip canlı sahnenize elle geçin.
sources-starting-soon-add = Ekle
sources-slate-solid = Düz renk
sources-slate-gradient = Degrade
sources-slate-transparent = Saydam
sources-slate-image = Görüntü
sources-slate-file = Görüntü / Video / GIF
sources-slate-browse = Gözat…
sources-starting-soon-choose-image = Görüntü seç…
sources-slate-media-note = Sabit görüntüler buraya gömülür. Döngülü bir video veya GIF arka planı için 'Saydam' seçin ve sahnenin arka planını (Sahneler çubuğundaki 🖼) ayarlayın — geri sayım üstte kalır.
properties-timer-slate = «Birazdan başlıyor» ekranı
properties-timer-slate-off = Kapalı (satır içi metin)
properties-timer-message = Mesaj
properties-timer-slate-color = Ekran rengi
properties-timer-slate-from = Başlangıç
properties-timer-slate-to = Bitiş
properties-timer-slate-note = Saydam, ekranın altındaki bir görüntünün, videonun veya sahne arka planının görünmesini sağlar.
