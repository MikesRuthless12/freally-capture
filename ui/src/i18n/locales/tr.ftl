...
hotkeys-timer-toggle-placeholder = örn. Ctrl+Shift+T
hotkeys-timer-reset = Tüm zamanlayıcıları sıfırla
hotkeys-timer-reset-placeholder = örn. Ctrl+Shift+0
...
hotkeys-split-placeholder = örn. Numpad1
...
hotkeys-playlist-placeholder = örn. Ctrl+Alt+Right
...
hotkeys-replay-roll-placeholder = örn. Ctrl+Shift+I
