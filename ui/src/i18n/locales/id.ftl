...
hotkeys-timer-toggle-placeholder = mis. Ctrl+Shift+T
hotkeys-timer-reset = Reset semua timer
hotkeys-timer-reset-placeholder = mis. Ctrl+Shift+0
...
hotkeys-split-placeholder = mis. Numpad1
...
hotkeys-playlist-placeholder = mis. Ctrl+Alt+Right
...
hotkeys-replay-roll-placeholder = mis. Ctrl+Shift+I
