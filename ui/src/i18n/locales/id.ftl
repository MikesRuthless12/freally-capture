...
properties-timer-target = Hitung mundur ke (HH:MM)
properties-timer-target-note = Target jam dinding berjalan sendiri dan berulang harian; kosongkan untuk memakai durasi dengan Mulai/Jeda/Reset.
...
teleprompter-caesura-pause = Jeda
