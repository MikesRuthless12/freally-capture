...
sources-add-background-music = Música de fundo…
sources-background-music-note = Toca em loop, ouvida na prévia e gravada/transmitida. Para usar música no lugar do som de um vídeo, silencie a faixa Backdrop do vídeo.
sources-background-music-count = { $n } faixas
sources-background-music-shuffle = Aleatório
...
sources-stream-hide = Ocultar na transmissão
sources-stream-show = Mostrar na transmissão
sources-stream-hide-item = Ocultar { $name } na transmissão
sources-stream-show-item = Mostrar { $name } na transmissão
sources-record-hide = Ocultar na gravação
sources-record-show = Mostrar na gravação
sources-record-hide-item = Ocultar { $name } na gravação
sources-record-show-item = Mostrar { $name } na gravação
...
sources-game-accept = Aceitar o risco e escolher um jogo
sources-game-pick = Escolha a janela do jogo para capturar. Fica conectada apenas enquanto você joga.
...
controls-iso-lanes = Faixas ISO gravando junto ao programa: { $count }
...
controls-virtual-camera-stop = ⌁ Parar câmera virtual
controls-virtual-camera-ready = Publica o programa como uma câmera que outros apps podem escolher.
...
mixer-routing = Roteamento
mixer-routing-title = Roteamento da saída de áudio

# --- RoutingMatrixDialog.tsx (CAP-N30) ---
routing-title = Roteamento de áudio
routing-intro = Atribua as faixas aos buses de trilha e depois envie qualquer bus para uma saída física — um sinal para um gravador de hardware, alto-falantes em outra sala ou um retorno de fone em uma trilha sobressalente. O monitor mantém seu próprio dispositivo; essas rotas são adicionadas por cima, então, sem nenhuma definida, a mixagem permanece inalterada.
routing-sends-title = Envios para trilhas
routing-no-strips = Nenhuma fonte de áudio nesta cena.
routing-source = Fonte
routing-track = Trilha { $n }
routing-send-aria = Enviar { $source } para a trilha { $n }
routing-outputs-title = Saídas físicas
routing-master = Master
routing-off = Desligado
routing-default-output = Saída padrão
routing-device-aria = Dispositivo de saída para { $bus }
routing-trim-aria = Trim de saída para { $bus }
routing-trim-db = { $db } dB
routing-muted = Silenciado
routing-device-error = Dispositivo indisponível

# --- DuckingMatrixDialog.tsx (CAP-N31) ---
mixer-ducking = Ducking
mixer-ducking-title = Matriz de ducking
ducking-title = Matriz de ducking
ducking-intro = Qualquer fonte pode abaixar todas as outras. Uma célula abaixa o destino (coluna) sempre que o disparador (linha) fala — escolha uma célula para definir sua profundidade, limiar e tempos. Cada par é um ducking próprio, então um canal pode ser abaixado por vários disparadores ao mesmo tempo.
ducking-need-two = Adicione pelo menos duas fontes de áudio para aplicar ducking entre elas.
ducking-trigger-target = Disparador ↓ / Destino →
ducking-cell-aria = { $trigger } abaixa { $target }
ducking-pair = { $trigger } → { $target }
ducking-remove = Remover
ducking-amount = Quantidade
ducking-threshold = Limiar
ducking-attack = Ataque
ducking-release = Liberação
ducking-unit-db = dB
ducking-unit-ms = ms

# --- Loudness normalization (CAP-N34) ---
loudness-title = Normalização de loudness
loudness-intro = Conduz o programa gradualmente em direção a uma meta de loudness com um teto de pico, para que sua transmissão e gravações fiquem em um nível consistente. Lento e suave — ele guia, nunca bombeia.
loudness-enable = Conduzir o programa até a meta
loudness-target = Meta
loudness-target-option = { $target } LUFS
loudness-ceiling = Teto de pico (dBFS)
loudness-note = −14 LUFS combina com reprodução no estilo YouTube; −16 é uma meta comum de streaming; −23 é transmissão EBU R128. A mesma meta é usada pela ação Normalizar após a gravação.
ltc-badge = LTC
ltc-title = Timecode SMPTE (LTC)
ltc-intro = Gere timecode linear SMPTE em uma faixa e leia o LTC recebido de qualquer entrada de áudio — timecode de áudio clássico para sincronizar gravadores e câmeras externas na pós. Totalmente offline.
ltc-generate = Gerar LTC em uma faixa
ltc-track = Faixa de timecode
ltc-track-option = Faixa { $track }
ltc-fps = Taxa de quadros
ltc-read = Ler LTC de
ltc-read-off = Desligado
ltc-decoded = Timecode recebido
ltc-no-lock = sem sinal
ltc-note = O gerador sincroniza com a hora do dia, non-drop. Grave a faixa dele (atribua em Saída) ou roteie para uma saída a fim de alimentar equipamentos externos. O leitor alimenta a linha de timecode do overlay de estatísticas e carimba os marcadores de capítulo.
loudness-on = LUFS { $target }
loudness-off = Norm. desligada
...
soundboard-stop-all = Parar tudo
soundboard-edit = Editar
soundboard-empty = Nenhum pad ainda — adicione um e atribua um clipe de áudio local.
soundboard-new-pad = Novo pad
soundboard-no-clip = Sem clipe
soundboard-audio-files = Arquivos de áudio
soundboard-name = Nome
soundboard-choose-clip = Escolher clipe…
soundboard-gain = Ganho
soundboard-choke = Choke
soundboard-choke-none = Nenhum
soundboard-loop = Loop
soundboard-auto-duck = Auto-ducking
soundboard-tracks = Trilhas
soundboard-hotkey = Atalho
soundboard-hotkey-placeholder = ex.: Ctrl+Shift+1
soundboard-remove = Remover

# --- PluginsDialog.tsx (CAP-N33) ---
mixer-plugins = Plugins
mixer-plugins-title = Plugins de áudio (CLAP / VST3)
plugins-title = Plugins de áudio
plugins-scanning = Buscando…
plugins-none = Nenhum plugin CLAP ou VST3 encontrado nas pastas padrão.
...
stats-disk = Disco
stats-disk-free = livre
stats-disk-left = Grav. restante
stats-disk-rate = ≈ { $rate } MB/s gravando
stats-vertical-fps = FPS 9:16
stats-targets-label = Destinos de transmissão
stats-rehearsal-note = Ensaio — os destinos publicam apenas em um receptor local
stats-timeline-open = Linha do tempo
timeline-title = Linha do tempo da sessão
timeline-empty = Nada gravado ainda — a linha do tempo registra enquanto você transmite ou grava.
timeline-live = AO VIVO — ainda gravando
timeline-fit = Ajustar
timeline-legend-fps = fps
timeline-legend-behind = fila do codificador (quadros de atraso)
...
scenes-recent-title = Recentes
scenes-recent-clear = Limpar
scenes-recent-clear-confirm = Limpar a lista de cenas recentes?
...
channelstrip-automix-label = Auto-mix (compartilhamento de ganho)
channelstrip-automix-note = Compartilhamento de ganho: o mixer mantém estável o nível combinado de todas as faixas em auto-mix e o entrega a quem estiver falando — ideal para painéis com vários microfones e podcasts. Desligado até você adicionar uma faixa.
channelstrip-mix-minus-label = Mix-minus (N−1)
channelstrip-mix-minus-note = Gera um retorno sem eco para esta fonte — todos no programa exceto a própria fonte. Use-o para um convidado remoto para que ele não ouça a própria voz atrasada.
...
livebutton-rehearse = Ensaiar
livebutton-rehearse-record-confirm = Gravar também este ensaio em um arquivo de vídeo?
livebutton-rehearse-title = Rode o show inteiro contra um receptor local — nada é enviado
livebutton-end-rehearsal = Encerrar ensaio
livebutton-title-rehearsing = Um ensaio está em andamento — nada sai desta máquina
livebutton-badge-rehearsal = ENSAIO
livebutton-aria-rehearsal = Ensaiando
livebutton-rehearsal-banner = Ensaio — nada sai desta máquina
...
properties-timer-clock = Contagem regressiva até um horário
...
audiofilters-name-parametric-eq = EQ paramétrico
audiofilters-name-de-esser = De-esser
audiofilters-name-rumble-guard = Filtro anti-rumble
# --- Voice-chain presets (CAP-N39) ---
audiofilters-voice-preset = Predefinição
audiofilters-voice-preset-pick = Predefinição de voz…
audiofilters-voice-broadcast = Voz de transmissão
audiofilters-voice-podcast = Voz de podcast
audiofilters-voice-clean = Voz limpa
audiofilters-voice-none = Limpar cadeia
# --- De-esser + rumble guard params (CAP-N36) ---
audiofilters-deesser-freq = Frequência de sibilância (Hz)
audiofilters-deesser-amount = Redução máx. (dB)
audiofilters-rumble-freq = Corte de graves (Hz)
audiofilters-title = Filtros de áudio — { $name }

# --- ParametricEqEditor.tsx (CAP-N35) ---
eq-graph-aria = Curva de resposta do EQ paramétrico com espectro ao vivo
eq-band-type = Tipo
eq-freq = Hz
eq-gain = dB
eq-q = Q
eq-add-band = + Banda
eq-remove-band = Remover banda
eq-type-bell = Sino
eq-type-lowShelf = Shelf grave
eq-type-highShelf = Shelf agudo
eq-type-notch = Notch
eq-type-highPass = Passa-alta
eq-type-lowPass = Passa-baixa
...
filters-name-fade-loop = Ciclo de fade
...
filters-tilt = Inclinação
filters-far-fade = Fade da borda distante
filters-fade-in-s = Surgir (s)
filters-visible-s = Visível (s)
...
recordings-trim = Aparar
recordings-trim-title = Corte um clipe desta gravação — cortes alinhados a quadros-chave exportam sem recodificar
recordings-verify = Verificar
recordings-verify-title = Confira a integridade do arquivo — estrutura do contêiner, continuidade, intercalação A/V, duração
recordings-verifying = Verificando…
verify-dismiss = Fechar
verify-verdict-pass = { $name } — integridade OK
verify-verdict-warn = { $name } — verificado com avisos
verify-verdict-fail = { $name } — problemas encontrados
verify-container = Contêiner
verify-video-continuity = Continuidade de vídeo
verify-audio-continuity = Continuidade de áudio
verify-av-interleave = Intercalação A/V
verify-duration = Duração
recordings-alpha-label = alfa
recordings-prores-title = Exportar um master .mov ProRes 4444 que preserva o alfa (para edição)
recordings-qtrle-title = Exportar um .mov QuickTime Animation que preserva o alfa (compatibilidade máxima)
trim-title = Aparar — { $name }
trim-loading = Lendo o arquivo…
trim-preview-alt = Quadro de pré-visualização
trim-position = Posição de reprodução
trim-step-second-back = Um segundo para trás
trim-step-frame-back = Um quadro para trás
trim-step-frame-forward = Um quadro para frente
trim-step-second-forward = Um segundo para frente
trim-snap = Quadro-chave
trim-snap-title = Ajustar ao quadro-chave mais próximo — um corte ali exporta sem recodificar
trim-set-in = Ponto de entrada
trim-set-out = Ponto de saída
trim-range-invalid = O ponto de saída deve vir depois do de entrada.
trim-copy-badge = ✓ Exporta sem recodificar — o ponto de entrada cai em um quadro-chave.
trim-reencode-badge = Será recodificado: o ponto de entrada está entre quadros-chave (use "Quadro-chave" para um corte sem perdas).
trim-export = Exportar clipe
trim-export-916 = 9:16
trim-export-916-title = Exportar vertical reenquadrado (corte centralizado no tamanho da tela vertical) — sempre recodifica
...
recordings-normalize-title = Normalizar o loudness até a meta (grava uma cópia)
recordings-normalized-to = Normalizado para { $path }

# --- Audio-only recording (CAP-N38) ---
audiorec-title = Somente áudio
audiorec-format = Formato de gravação de áudio
audiorec-format-wav = WAV
audiorec-format-flac = FLAC
audiorec-format-opus = Opus
audiorec-start = Gravar áudio
audiorec-stop = Parar
audiorec-pause = Pausar
audiorec-resume = Retomar
audiorec-recording = REC { $sec }s
audiorec-saved = { $count } arquivo(s) de faixa salvo(s)
...
bench-open = Executar benchmark de encoders…
bench-title = Benchmark de encoders
bench-intro = Roda escadas de codificação medidas (cada encoder detectado × preset × resolução) nesta máquina — cerca de um minuto, totalmente offline, nada sai do computador. Falhas são listadas, nunca ocultadas. Pare antes qualquer stream ou gravação.
bench-start = Iniciar benchmark
bench-rerun = Rodar de novo
bench-running = Medindo… { $done } / { $total }
bench-cancel = Cancelar
bench-col-encoder = Encoder
bench-col-preset = Preset
bench-col-rung = Degrau
bench-col-achieved = fps
bench-col-headroom = Folga
bench-failed = falhou
bench-rec-title = Recomendação (medida)
bench-rec-body = { $encoder } em { $preset }, { $width }×{ $height } @ { $fps } fps — medido { $headroom }× tempo real. Bitrate de stream sugerido: { $bitrate } kbps.
bench-rec-none = Nada sustenta tempo real nesta máquina — reduza a resolução do canvas ou os fps e rode de novo.
bench-apply = Aplicar às configurações de gravação
...
output-iso-heading = Gravação ISO
output-iso-explainer = Grave as fontes selecionadas limpas, cada uma em seu próprio arquivo ao lado do programa — antes da composição, no tamanho e taxa de quadros da tela, para que cada arquivo caia alinhado na linha do tempo de edição. Duas faixas rodam bem em uma GPU intermediária; cada faixa extra custa mais um render e uma codificação.
output-iso-none = Ainda não há fontes na coleção.
output-iso-source-on = Gravando “{ $name }” como arquivo ISO próprio — clique para parar
output-iso-source-off = Gravar “{ $name }” como arquivo ISO próprio
output-iso-post-filter = Gravar com os filtros da fonte (pós-filtro); desmarcado grava a fonte bruta
...
output-split-on-rundown = passo do roteiro
output-auto-markers = Soltar marcadores de capítulo automaticamente em eventos do estúdio (troca de cena, replay salvo, reconexão, quadros perdidos, alarmes, regras)
output-auto-markers-title = Marcadores tipados vão para os capítulos da gravação (mkv) ou o arquivo .chapters.txt, junto ao atalho manual
output-pipeline-heading = Pipeline pós-gravação
output-pipeline-explainer = Quando uma gravação finaliza, executa estes passos no arquivo principal, em ordem, em segundo plano. Um conjunto de ações fechado — não há passo "executar comando", por projeto. A cadeia para na primeira falha.
output-pipeline-enabled = Executar o pipeline após cada gravação
output-pipeline-add = Adicionar um passo…
output-pipeline-up = Mover para cima
output-pipeline-down = Mover para baixo
output-pipeline-remove = Remover passo
output-pipeline-template = Modelo de renomeação (tokens CAP-M25)
output-pipeline-folder = Pasta
pipeline-queue = Pipeline pós-gravação
pipeline-verify = Verificar
pipeline-remux = Remuxar para MP4
pipeline-normalize = Normalizar volume
pipeline-rename = Renomear
pipeline-move = Mover para pasta
pipeline-copy = Copiar para pasta
pipeline-reveal = Mostrar no gerenciador de arquivos
pipeline-luaEvent = Notificar scripts Lua
...
stream-session-report = Gravar um relatório da sessão (HTML + Markdown) ao lado da gravação ao terminar
stream-simulator-title = Simulador de rede (ensaios)
stream-simulator-note = Modela apenas os receptores locais do ensaio — treina reconexões e uplinks fracos. Um Go Live real nunca é degradado.
stream-simulator-profile = Perfil
stream-simulator-off = Desligado
stream-simulator-hotel-wifi = Wi-Fi de hotel
stream-simulator-mobile-hotspot = Hotspot móvel
stream-simulator-custom = Personalizado
stream-simulator-bandwidth = Banda (kbps, 0 = sem limite)
stream-simulator-latency = Latência (ms)
stream-simulator-jitter = Jitter (± ms)
stream-simulator-outage-every = Queda a cada (s, 0 = nunca)
stream-simulator-outage-len = Duração da queda (s)
...
workspace-pack-title = Pacote de coleção de cenas
workspace-pack-export = Exportar pacote…
workspace-pack-exporting = Exportando…
workspace-pack-import = Importar pacote…
workspace-pack-importing = Importando…
workspace-pack-hint = Um .fcappack empacota a coleção ativa e seus recursos locais em um único arquivo portátil — compartilhe um layout inteiro, sem servidor. Importar o insere como uma nova coleção e alterna para ela.
workspace-pack-exported = "{ $name }" exportada — { $bundled } recurso(s) empacotado(s), { $external } externo(s).
workspace-pack-imported = "{ $name }" importada — { $scenes } cena(s), { $relinked } recurso(s) revinculado(s), { $external } externo(s).
workspace-compare = Comparar e mesclar…
compare-title = Comparar e mesclar
compare-intro = Compare a coleção ativa com outra e traga apenas as alterações que você escolher. Nada sai desta máquina.
compare-target-label = Comparar com
compare-target-none = Escolha uma coleção…
compare-target-pack = De um arquivo de pacote…
compare-against = vs { $name }
compare-comparing = Comparando…
compare-no-diff = Sem diferenças — as coleções são idênticas.
compare-select-all = Selecionar tudo
compare-clear = Limpar
compare-merge-hint = Escolher uma cena também traz as fontes que ela usa.
compare-sources-title = Fontes
compare-scenes-title = Cenas
compare-kind-added = Adicionado
compare-kind-removed = Removido
compare-kind-modified = Alterado
compare-renamed = era "{ $from }"
compare-reordered = reempilhado
compare-apply = Aplicar { $count }
compare-apply-none = Selecione alterações para aplicar
compare-applying = Aplicando…
compare-aspect-source = fonte
compare-aspect-transform = posição
compare-aspect-visibility = visibilidade
compare-aspect-outputs = saídas
compare-aspect-filters = filtros
compare-aspect-lock = bloqueio
compare-aspect-blend = mesclagem
compare-aspect-scaling = escala
compare-aspect-backdrop = plano de fundo
compare-aspect-reveal = revelação
compare-aspect-name = nome
compare-aspect-settings = configurações
compare-aspect-audio = áudio
workspace-snapshots = Instantâneos…
snapshots-title = Instantâneos
snapshots-intro = Pontos de verificação nomeados desta coleção aos quais você pode voltar — mantidos de propósito, além do salvamento automático e do desfazer. Armazenados localmente.
snapshots-name-placeholder = Dê um nome a este ponto…
snapshots-create = Salvar instantâneo
snapshots-empty = Nenhum instantâneo ainda — salve um para manter um ponto de verificação nomeado ao qual você pode voltar.
snapshots-usage = { $count } de { $cap } mantidos · { $size }
snapshots-scenes = { $scenes } cenas · { $sources } fontes
snapshots-restore = Restaurar
snapshots-compare = Comparar
snapshots-delete = Excluir instantâneo
snapshots-delete-aria = Excluir instantâneo "{ $name }"
snapshots-restore-confirm = Restaurar este instantâneo? Seu layout atual é salvo como um instantâneo primeiro.

# --- Phase 8 (backup / theme editor / dock presets / settings search / quick actions) ---
workspace-backup = Backup e restauração…
backup-title = Backup e restauração
backup-intro = Salve todo o seu estúdio — configurações, perfis, coleções de cenas — em um único arquivo e restaure-o aqui ou em uma nova máquina.
backup-export = Exportar backup…
backup-exporting = Exportando…
backup-exported = { $collections } coleção(ões) e { $profiles } perfil(is) salvos ({ $size }).
backup-restore = Restaurar de um backup…
backup-secrets-note = Chaves de transmissão e senhas nunca são incluídas em um backup — insira-as novamente após restaurar.
backup-restore-from = Backup criado em { $created } (v{ $version })
backup-restore-settings = Configurações
backup-restore-collections = Coleções de cenas ({ $count })
backup-restore-profiles = Perfis ({ $count })
backup-restore-apply = Restaurar selecionados
backup-restoring = Restaurando…
backup-restored = Restaurado.
backup-restart-note = Reinicie o Freally Capture para carregar as coleções e os perfis restaurados.
backup-cancel = Cancelar
theme-editor-title = Paleta personalizada
theme-color-bg = Fundo
theme-color-panel = Painel
theme-color-text = Texto
theme-color-muted = Suave
theme-color-accent = Destaque
theme-color-accent2 = Destaque 2
theme-contrast-text-bg = Texto sobre o fundo
theme-contrast-text-panel = Texto sobre o painel
theme-contrast-muted-bg = Suave sobre o fundo
theme-contrast-accent-bg = Destaque sobre o fundo
theme-contrast-low = (busque ≥ { $min }:1)
theme-reset = Restaurar para escuro
theme-export = Exportar .fctheme…
theme-import = Importar .fctheme…
workspace-dock-presets = Layouts de docas
workspace-dock-preset-placeholder = Salvar layout atual como…
workspace-dock-preset-save = Salvar
workspace-dock-preset-apply = Mudar para “{ $name }”
workspace-dock-preset-delete = Excluir layout “{ $name }”
workspace-dock-presets-hint = Um layout memoriza a doca de estatísticas e a orientação do mixer. Clique em um para mudar para ele.
...
menu-tools-quick-actions = Ações rápidas…
menu-tools-featured-chat = Mensagem de chat em destaque…
quick-actions-title = Ações rápidas
quick-actions-empty = Nenhum botão ainda — clique em Editar para adicionar.
quick-actions-edit = Editar
quick-actions-done = Concluído
quick-actions-add-page = Página
quick-actions-label = Rótulo do botão
quick-actions-color = Cor do botão
quick-actions-add = Adicionar botão
quick-actions-remove = Remover “{ $name }”
quick-actions-delete-page = Excluir “{ $name }”
quick-actions-hint = Os botões acionam os mesmos comandos do estúdio que os atalhos e o painel LAN — cenas, macros e pads do soundboard também. Os botões de comando também aparecem no painel LAN.
quick-actions-cmd-transition = Transição
quick-actions-cmd-startStream = Ficar ao vivo
quick-actions-cmd-stopStream = Encerrar transmissão
quick-actions-cmd-startRecording = Iniciar gravação
quick-actions-cmd-stopRecording = Parar gravação
quick-actions-cmd-pauseRecording = Pausar gravação
quick-actions-cmd-addMarker = Adicionar marcador
quick-actions-cmd-armReplay = Armar replay
quick-actions-cmd-saveReplay = Salvar replay
quick-actions-cmd-setStudioMode = Alternar modo estúdio
quick-actions-cmd-scene = Mudar para cena…
quick-actions-cmd-macro = Executar macro…
quick-actions-cmd-soundboard = Pad do soundboard…
quick-actions-value-scene = Nome da cena
quick-actions-value-macro = Nome da macro
quick-actions-value-soundboard = ID do pad
teleprompter-stop = Parar
about-portable-on = Modo portátil: ativado — todos os dados do app são armazenados ao lado do app.
about-portable-off = Modo portátil: desativado. Adicione um arquivo "{ $marker }" ao lado do app para executá-lo de forma totalmente autônoma (modo pen drive USB).
about-portable-data = Pasta de dados: { $path }
...
history-toggleOutputVisibility = Alternar visibilidade por saída
...
palette-featured-chat = Mensagem de chat em destaque…
featured-chat-title = Mensagem de chat em destaque
featured-chat-intro = Fixe qualquer linha recente do chat como um banner inferior no programa — espectadores da transmissão e da gravação o veem. A fixação some ao reiniciar; as cores permanecem.
featured-chat-empty = Nenhum chat ainda — adicione uma fonte de sobreposição de chat e aponte-a para seu canal; as linhas aparecem aqui quando chegarem.
featured-chat-pinned = No programa:
featured-chat-pin = Destacar
featured-chat-clear = Remover
featured-chat-bg = Cor do banner
featured-chat-text = Cor do texto
featured-chat-note = O banner fica embaixo, ao centro, sobre todas as cenas — remova-o para tirá-lo do ar.
...
properties-stats-show-timecode = Mostrar timecode (LTC)
...
sources-visualizer-classic = Cores clássicas
...
menu-collection-clear = Limpar histórico…
menu-collection-clear-confirm = Excluir permanentemente estas coleções de cenas e seus arquivos? { $names } — a coleção ativa «{ $active }» é mantida. Isso não pode ser desfeito.
...
whats-new-loading = Carregando notas de versão…
whats-new-version = Novidades da versão { $version }
whats-new-empty = Nenhuma nota de versão para esta versão.
filters-name-directional-blur = Desfoque direcional
filters-name-radial-blur = Desfoque radial
filters-name-zoom-blur = Desfoque de zoom
filters-name-pixelate = Pixelizar
filters-angle = Ângulo (°)
filters-center-x = Centro X
filters-center-y = Centro Y
filters-block-size = Tamanho do bloco (px)
filters-name-freeze = Congelar
filters-freeze-hint = Quando ativado, esta fonte mantém seu último quadro — programa, prévia, gravação e transmissão congelam juntos. Alterne este filtro para congelar ou descongelar.
transform-3d = Inclinação 3D
...
dsk-enable = Ativar este keyer
dsk-move-up = Mover para cima (por cima)
dsk-move-down = Mover para baixo
dsk-remove = Remover keyer
dsk-opacity = Opacidade
dsk-x = X (px)
dsk-y = Y (px)
dsk-scale = Escala
...
telestrator-draw = Desenhar
telestrator-tool-pen = Caneta
telestrator-tool-highlight = Marca-texto
telestrator-tool-arrow = Seta
telestrator-tool-ellipse = Elipse
telestrator-color = Cor
telestrator-width = Espessura
telestrator-whiteboard = Modo lousa
telestrator-persist = Manter
telestrator-fade = Esmaecer
telestrator-undo = Desfazer última marca
telestrator-clear = Limpar marcas
hotkeys-telestrator-clear = Telestrator: limpar marcas

# --- Teleprompter (CAP-N58) ---
teleprompter-title = Teleprompter
teleprompter-loading = Carregando…
teleprompter-empty = Ainda sem roteiro — adicione um no painel do teleprompter.
teleprompter-script = Roteiro
teleprompter-script-placeholder = Digite ou cole seu roteiro…
teleprompter-top = Início
teleprompter-slower = Mais lento
teleprompter-play = Reproduzir
teleprompter-pause = Pausar
teleprompter-faster = Mais rápido
teleprompter-step-back = Retroceder
teleprompter-step-forward = Avançar
teleprompter-est-time = Tempo de leitura
teleprompter-caesura-hint = Digite -- para uma pausa
teleprompter-caesura-pause = Pausa de cesura — Digite -- para uma pausa
teleprompter-countdown = Iniciar contagem regressiva
teleprompter-countdown-secs = Contagem regressiva (segundos)
teleprompter-speed = Velocidade (caracteres/s)
teleprompter-speed-bpm = Velocidade (BPM)
teleprompter-bpm-mode = Modo BPM (canto)
teleprompter-font = Tamanho da fonte
teleprompter-mirror = Espelhar (vidro)
teleprompter-open-projector = Abrir projetor
teleprompter-preview = Prévia
teleprompter-remote-hint = Controle a rolagem por atalho, MIDI ou pelo painel LAN enquanto isto estiver fechado.
teleprompter-read-aloud = Ler em voz alta com a síntese de fala do sistema operacional
menu-tools-teleprompter = Teleprompter
hotkeys-teleprompter-toggle = Teleprompter: reproduzir / pausar

# --- Remote guests: green room / cues / QoS / auto-grid (CAP-N54–N56, N59) ---
remote-hosting-count = Hospedando { $count } convidado(s)
remote-green-room-default = Sala de espera
remote-green-room-default-title = Novos convidados aguardam na sala de espera até você colocá-los
remote-auto-grid = Grade automática
remote-auto-grid-title = Manter convidados em grade conforme entram e saem
remote-arrange-grid = Organizar grade
remote-arrange-grid-title = Reorganizar agora os convidados no ar em grade
remote-green-room-monitor = Prévia da sala de espera
remote-tech-cam-ok = Câmera ✓
remote-tech-cam-no = Sem câmera
remote-tech-mic-ok = Mic ✓
remote-tech-mic-no = Sem mic
remote-seat-on-air = Colocar no ar
remote-cues-label = Deixas
remote-cue = Deixa
remote-cue-thirty = 30 segundos
remote-cue-wrap = Finalize
remote-cue-next = Você é o próximo
remote-cue-speak = Fale mais alto
remote-qos-good = Conexão boa
remote-qos-fair = Conexão razoável
remote-qos-poor = Conexão ruim
remote-green-room-guest = Você está na sala de espera — o apresentador vai colocá-lo no ar em breve.

# --- Hotkey audit — Phase 7 actions ---
hotkey-audit-action-telestrator-clear = Telestrator: limpar marcas
hotkey-audit-action-teleprompter-toggle = Teleprompter: reproduzir / pausar
...
sources-add-starting-soon = Começando em breve…
sources-starting-soon-title = Começando em breve
sources-starting-soon-default = Começando em breve
sources-starting-soon-message = Mensagem
sources-starting-soon-minutes = Minutos
sources-starting-soon-hours = Horas
sources-starting-soon-start-at = Começa às
sources-starting-soon-music = Música de fundo…
sources-starting-soon-music-name = Música de fundo
sources-starting-soon-background = Fundo
sources-starting-soon-note = Uma contagem regressiva em tela cheia que pisca em vermelho e para no zero — limpe-a e corte para sua cena ao vivo manualmente quando estiver pronto.
sources-starting-soon-add = Adicionar
sources-slate-solid = Cor sólida
sources-slate-gradient = Gradiente
sources-slate-transparent = Transparente
sources-slate-image = Imagem
sources-slate-file = Imagem / Vídeo / GIF
sources-slate-browse = Procurar…
sources-starting-soon-choose-image = Escolher imagem…
sources-slate-media-note = Imagens estáticas são incorporadas aqui. Para um vídeo ou GIF de fundo em loop, escolha «Transparente» e defina o fundo da cena (o 🖼 na barra de cenas) — a contagem regressiva fica por cima.
properties-timer-slate = Tela «Começando em breve»
properties-timer-slate-off = Desligado (texto embutido)
properties-timer-message = Mensagem
properties-timer-slate-color = Cor da tela
properties-timer-slate-from = De
properties-timer-slate-to = Até
properties-timer-slate-note = Transparente deixa uma imagem, vídeo ou fundo de cena abaixo da tela aparecer.
...
sources-browser-component-missing = Precisa do componente Browser Runtime — instale em Ferramentas → Componentes.
sources-browser-component-unsupported = O CEF não publica uma compilação do Browser Runtime para esta plataforma, então esta fonte não pode ser renderizada aqui.
sources-browser-component-installing = Instalando o componente Browser Runtime… esta fonte será renderizada quando terminar.
sources-browser-component-error = Não foi possível instalar o componente Browser Runtime: { $message }

# Shown when a dialog or dock hits a render error (ErrorBoundary).
panel-error-title = Este painel parou
panel-error-hint = Gravação e transmissão não são afetadas. Feche e abra novamente.
