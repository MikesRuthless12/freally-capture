...
hotkeys-still-placeholder = ex.: Ctrl+Shift+P
...
hotkeys-panic-placeholder = ex.: Ctrl+Shift+F12
hotkeys-timer-toggle = Iniciar/pausar todos os timers
hotkeys-timer-toggle-placeholder = ex.: Ctrl+Shift+T
hotkeys-timer-reset = Zerar todos os timers
hotkeys-timer-reset-placeholder = ex.: Ctrl+Shift+0
