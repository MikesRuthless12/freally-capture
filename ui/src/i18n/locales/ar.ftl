...
sources-add-background-music = موسيقى خلفية…
sources-background-music-note = يُشغَّل بشكل متكرر، ويُسمع في المعاينة ويُسجَّل/يُبثّ. لاستخدام الموسيقى بدلاً من صوت الفيديو، اكتم شريط Backdrop للفيديو في الخلّاط.
sources-background-music-count = { $n } مقطع
sources-background-music-shuffle = عشوائي
...
sources-stream-hide = إخفاء في البث
sources-stream-show = إظهار في البث
sources-stream-hide-item = إخفاء { $name } في البث
sources-stream-show-item = إظهار { $name } في البث
sources-record-hide = إخفاء في التسجيل
sources-record-show = إظهار في التسجيل
sources-record-hide-item = إخفاء { $name } في التسجيل
sources-record-show-item = إظهار { $name } في التسجيل
...
stats-rehearsal-note = بروفة — الوجهات تنشر إلى مستقبل محلي فقط
stats-timeline-open = الخط الزمني
timeline-title = الخط الزمني للجلسة
timeline-empty = لا شيء مسجل بعد — يسجل الخط الزمني أثناء البث أو التسجيل.
timeline-live = مباشر — ما زال يسجل
timeline-fit = ملاءمة
timeline-legend-fps = إطار/ث
timeline-legend-behind = طابور المُرمِّز (إطارات متأخرة)
...
scenes-recent-title = الأخيرة
scenes-recent-clear = مسح
scenes-recent-clear-confirm = مسح قائمة المشاهد الأخيرة؟
...
livebutton-rehearse = بروفة
livebutton-rehearse-record-confirm = هل تريد تسجيل هذه البروفة أيضًا في ملف فيديو؟
livebutton-rehearse-title = شغّل العرض كاملاً على مستقبل محلي — لا يُرسل أي شيء
livebutton-end-rehearsal = إنهاء البروفة
livebutton-title-rehearsing = بروفة جارية — لا شيء يغادر هذا الجهاز
livebutton-badge-rehearsal = بروفة
livebutton-aria-rehearsal = بروفة جارية
livebutton-rehearsal-banner = بروفة — لا شيء يغادر هذا الجهاز
...
properties-timer-clock = العد التنازلي حتى وقت محدد
...
filters-name-perspective = منظور
filters-name-fade-loop = حلقة تلاشٍ
...
filters-tilt = إمالة
filters-far-fade = تلاشي الحافة البعيدة
filters-fade-in-s = ظهور (ث)
filters-visible-s = مرئي (ث)
filters-fade-out-s = تلاشٍ (ث)
filters-hidden-s = مخفي (ث)
...
bench-open = تشغيل قياس أداء المُرمِّزات…
bench-title = قياس أداء المُرمِّزات
bench-intro = يشغّل سلالم ترميز قصيرة مُقاسة (كل مُرمِّز مكتشف × إعداد مسبق × دقة) على هذا الجهاز — نحو دقيقة، دون اتصال تمامًا، لا شيء يغادر حاسوبك. تُدرج الإخفاقات ولا تُخفى. أوقف البث أو التسجيل أولًا.
bench-start = بدء القياس
bench-rerun = تشغيل مرة أخرى
bench-running = يقيس… { $done } / { $total }
bench-cancel = إلغاء
bench-col-encoder = المُرمِّز
bench-col-preset = الإعداد المسبق
bench-col-rung = الدرجة
bench-col-achieved = إطار/ث
bench-col-headroom = الهامش
bench-failed = فشل
bench-rec-title = التوصية (مُقاسة)
bench-rec-body = { $encoder } بإعداد { $preset }، { $width }×{ $height } @ { $fps } إطار/ث — قيس { $headroom }× من الزمن الحقيقي. معدل بث مقترح: { $bitrate } كيلوبت/ث.
bench-rec-none = لا شيء يحافظ على الزمن الحقيقي على هذا الجهاز — قلّل دقة اللوحة أو الإطارات وأعد القياس.
bench-apply = تطبيق على إعدادات التسجيل
bench-applied = طُبّق ✓
...
output-auto-export = احفظ أيضًا نسخة MP4 قابلة للمشاركة بجوار الملف الأصلي
output-auto-export-title = عند اكتمال تسجيل ‎.frec، يكتب تصدير في الخلفية نسخة MP4 قابلة للتشغيل بنقرة مزدوجة بجواره (تظهر في قائمة الانتظار الخلفية). يبقى الملف الأصلي غير المضغوط هو الأصل.
...
stream-session-report = عند انتهاء الجلسة، اكتب تقرير جلسة (HTML + Markdown) بجوار التسجيل
stream-simulator-title = محاكي الشبكة (البروفات)
stream-simulator-note = يشكّل مستقبلات البروفة المحلية فقط — تدريب على إعادة الاتصال والوصلات الضعيفة. البث الحقيقي لا يتأثر أبدًا.
stream-simulator-profile = الملف
stream-simulator-off = مطفأ
stream-simulator-hotel-wifi = واي فاي فندق
stream-simulator-mobile-hotspot = نقطة اتصال جوال
stream-simulator-custom = مخصص
stream-simulator-bandwidth = عرض النطاق (كيلوبت/ث، 0 = بلا حد)
stream-simulator-latency = التأخير (مللي ث)
stream-simulator-jitter = الارتجاج (± مللي ث)
stream-simulator-outage-every = انقطاع كل (ث، 0 = أبدًا)
stream-simulator-outage-len = مدة الانقطاع (ث)
...
workspace-pack-title = حزمة مجموعة المشاهد
workspace-pack-export = تصدير الحزمة…
workspace-pack-exporting = جارٍ التصدير…
workspace-pack-import = استيراد حزمة…
workspace-pack-importing = جارٍ الاستيراد…
workspace-pack-hint = يجمع ملف ‎.fcappack المجموعة النشطة مع أصولها المحلية في ملف واحد قابل للنقل — شارك تخطيطًا كاملاً بلا خادم. الاستيراد يضعه كمجموعة جديدة ويبدّل إليها.
workspace-pack-exported = تم تصدير «{ $name }» — { $bundled } أصل مُضمَّن، { $external } خارجي.
workspace-pack-imported = تم استيراد «{ $name }» — { $scenes } مشهد، { $relinked } أصل مُعاد ربطه، { $external } خارجي.
workspace-compare = مقارنة ودمج…
compare-title = مقارنة ودمج
compare-intro = قارن المجموعة النشطة بأخرى واستورد فقط التغييرات التي تختارها. لا شيء يغادر هذا الجهاز.
compare-target-label = المقارنة مع
compare-target-none = اختر مجموعة…
compare-target-pack = من ملف حزمة…
compare-against = مقابل { $name }
compare-comparing = جارٍ المقارنة…
compare-no-diff = لا توجد فروق — المجموعتان متطابقتان.
compare-select-all = تحديد الكل
compare-clear = مسح
compare-merge-hint = اختيار مشهد يجلب أيضًا المصادر التي يستخدمها.
compare-sources-title = المصادر
compare-scenes-title = المشاهد
compare-kind-added = مُضاف
compare-kind-removed = مُزال
compare-kind-modified = مُعدّل
compare-renamed = كان «{ $from }»
compare-reordered = أُعيد ترتيبه
compare-apply = تطبيق { $count }
compare-apply-none = حدّد التغييرات للتطبيق
compare-applying = جارٍ التطبيق…
compare-aspect-source = المصدر
compare-aspect-transform = الموضع
compare-aspect-visibility = الظهور
compare-aspect-outputs = المخرجات
compare-aspect-filters = الفلاتر
compare-aspect-lock = القفل
compare-aspect-blend = المزج
compare-aspect-scaling = التحجيم
compare-aspect-backdrop = الخلفية
compare-aspect-reveal = الكشف
compare-aspect-name = الاسم
compare-aspect-settings = الإعدادات
compare-aspect-audio = الصوت
workspace-snapshots = اللقطات…
snapshots-title = اللقطات
snapshots-intro = نقاط مرجعية مسماة لهذه المجموعة يمكنك العودة إليها — تُحفظ عن قصد، بخلاف الحفظ التلقائي والتراجع. تُخزَّن محليًا.
snapshots-name-placeholder = سمِّ هذه النقطة المرجعية…
snapshots-create = حفظ اللقطة
snapshots-empty = لا لقطات بعد — احفظ واحدة للاحتفاظ بنقطة مرجعية مسماة يمكنك العودة إليها.
snapshots-usage = { $count } من { $cap } محفوظة · { $size }
snapshots-scenes = { $scenes } مشهد · { $sources } مصدر
snapshots-restore = استعادة
snapshots-compare = مقارنة
snapshots-delete = حذف اللقطة
snapshots-delete-aria = حذف اللقطة «{ $name }»
snapshots-restore-confirm = استعادة هذه اللقطة؟ يُحفظ تخطيطك الحالي كلقطة أولاً.

# --- Phase 8 (backup / theme editor / dock presets / settings search / quick actions) ---
workspace-backup = النسخ الاحتياطي والاستعادة…
backup-title = النسخ الاحتياطي والاستعادة
backup-intro = احفظ استوديوك بالكامل — الإعدادات وملفات التعريف ومجموعات المشاهد — في ملف واحد، واستعِده هنا أو على جهاز جديد.
backup-export = تصدير نسخة احتياطية…
backup-exporting = جارٍ التصدير…
backup-exported = تم نسخ { $collections } مجموعة و{ $profiles } ملف تعريف احتياطيًا ({ $size }).
backup-restore = الاستعادة من نسخة احتياطية…
backup-secrets-note = لا تُضمَّن مفاتيح البث وكلمات المرور أبدًا في النسخة الاحتياطية — أعد إدخالها بعد الاستعادة.
backup-restore-from = نسخة احتياطية أُنشئت { $created } (v{ $version })
backup-restore-settings = الإعدادات
backup-restore-collections = مجموعات المشاهد ({ $count })
backup-restore-profiles = ملفات التعريف ({ $count })
backup-restore-apply = استعادة المحدد
backup-restoring = جارٍ الاستعادة…
backup-restored = تمت الاستعادة.
backup-restart-note = أعد تشغيل Freally Capture لتحميل المجموعات وملفات التعريف المستعادة.
backup-cancel = إلغاء
theme-editor-title = لوحة ألوان مخصصة
theme-color-bg = الخلفية
theme-color-panel = اللوحة
theme-color-text = النص
theme-color-muted = الخافت
theme-color-accent = التمييز
theme-color-accent2 = التمييز 2
theme-contrast-text-bg = النص على الخلفية
theme-contrast-text-panel = النص على اللوحة
theme-contrast-muted-bg = الخافت على الخلفية
theme-contrast-accent-bg = التمييز على الخلفية
theme-contrast-low = (المستهدف ≥ { $min }:1)
theme-reset = إعادة التعيين إلى الداكن
theme-export = تصدير .fctheme…
theme-import = استيراد .fctheme…
workspace-dock-presets = تخطيطات الإرساء
workspace-dock-preset-placeholder = حفظ التخطيط الحالي باسم…
workspace-dock-preset-save = حفظ
workspace-dock-preset-apply = التبديل إلى «{ $name }»
workspace-dock-preset-delete = حذف التخطيط «{ $name }»
workspace-dock-presets-hint = يتذكّر التخطيط رصيف الإحصائيات واتجاه المازج. انقر واحدًا للتبديل إليه.
settings-search-placeholder = بحث في الإعدادات…
settings-search-none = لا توجد إعدادات مطابقة.
settings-changed = تغيّر منذ الفتح
menu-tools-quick-actions = إجراءات سريعة…
menu-tools-featured-chat = رسالة دردشة مميزة…
quick-actions-title = إجراءات سريعة
quick-actions-empty = لا أزرار بعد — انقر تحرير لإضافة بعضها.
quick-actions-edit = تحرير
quick-actions-done = تم
quick-actions-add-page = صفحة
quick-actions-label = تسمية الزر
quick-actions-color = لون الزر
quick-actions-add = إضافة زر
quick-actions-remove = إزالة «{ $name }»
quick-actions-delete-page = حذف «{ $name }»
quick-actions-hint = تُطلق الأزرار نفس أوامر الاستوديو التي تُطلقها مفاتيح الاختصار ولوحة الشبكة المحلية — بما في ذلك المشاهد والماكرو وأزرار لوحة الأصوات. تظهر أزرار الأوامر أيضًا في لوحة الشبكة المحلية.
quick-actions-cmd-transition = انتقال
quick-actions-cmd-startStream = بدء البث
quick-actions-cmd-stopStream = إنهاء البث
quick-actions-cmd-startRecording = بدء التسجيل
quick-actions-cmd-stopRecording = إيقاف التسجيل
quick-actions-cmd-pauseRecording = إيقاف التسجيل مؤقتًا
quick-actions-cmd-addMarker = إضافة علامة
quick-actions-cmd-armReplay = تجهيز الإعادة
quick-actions-cmd-saveReplay = حفظ الإعادة
quick-actions-cmd-setStudioMode = تبديل وضع الاستوديو
quick-actions-cmd-scene = التبديل إلى المشهد…
quick-actions-cmd-macro = تشغيل الماكرو…
quick-actions-cmd-soundboard = زر لوحة الأصوات…
quick-actions-value-scene = اسم المشهد
quick-actions-value-macro = اسم الماكرو
quick-actions-value-soundboard = معرّف الزر
teleprompter-stop = إيقاف
about-portable-on = الوضع المحمول: مُفعَّل — تُخزَّن جميع بيانات التطبيق بجوار التطبيق.
about-portable-off = الوضع المحمول: مُعطَّل. أضِف ملف «{ $marker }» بجوار التطبيق لتشغيله مكتفيًا ذاتيًا بالكامل (وضع عصا USB).
about-portable-data = مجلد البيانات: { $path }
...
history-toggleOutputVisibility = تبديل ظهور المخرجات
...
palette-featured-chat = رسالة دردشة مميزة…
featured-chat-title = رسالة دردشة مميزة
featured-chat-intro = ثبّت أي سطر دردشة حديث كشريط أسفل البرنامج — يراه مشاهدو البث والتسجيل. يُلغى التثبيت عند إعادة التشغيل؛ وتبقى الألوان.
featured-chat-empty = لا دردشة بعد — أضف مصدر تراكب الدردشة ووجّهه إلى قناتك؛ ستظهر الأسطر هنا فور وصولها.
featured-chat-pinned = على البرنامج:
featured-chat-pin = تمييز
featured-chat-clear = إزالة
featured-chat-bg = لون الشريط
featured-chat-text = لون النص
featured-chat-note = يقع الشريط أسفل الوسط فوق كل المشاهد — أزله لإخراجه من البث.
...
sources-visualizer-classic = ألوان كلاسيكية
...
menu-collection-clear = مسح السجل…
menu-collection-clear-confirm = حذف مجموعات المشاهد هذه وملفاتها نهائيًا؟ { $names } — يتم الاحتفاظ بالمجموعة النشطة «{ $active }». لا يمكن التراجع عن هذا الإجراء.
...
# --- Telestrator (CAP-N57) ---
telestrator-group = أداة الرسم
telestrator-draw = ارسم
telestrator-tool-pen = قلم
telestrator-tool-highlight = قلم تمييز
telestrator-tool-arrow = سهم
telestrator-tool-ellipse = قطع ناقص
telestrator-color = اللون
telestrator-width = العرض
telestrator-whiteboard = وضع السبورة
telestrator-persist = إبقاء
telestrator-fade = تلاشٍ
telestrator-undo = التراجع عن آخر علامة
telestrator-clear = مسح العلامات
hotkeys-telestrator-clear = أداة الرسم: مسح العلامات

# --- Teleprompter (CAP-N58) ---
teleprompter-title = الملقّن
teleprompter-loading = جارٍ التحميل…
teleprompter-empty = لا يوجد نص بعد — أضِف واحدًا من لوحة الملقّن.
teleprompter-script = النص
teleprompter-script-placeholder = اكتب أو الصق نصك…
teleprompter-top = البداية
teleprompter-slower = أبطأ
teleprompter-play = تشغيل
teleprompter-pause = إيقاف مؤقت
teleprompter-faster = أسرع
teleprompter-step-back = خطوة للخلف
teleprompter-step-forward = خطوة للأمام
teleprompter-est-time = وقت القراءة
teleprompter-caesura-hint = اكتب -- لإضافة وقفة
teleprompter-caesura-pause = وقفة — اكتب -- لإضافة وقفة
teleprompter-countdown = بدء العد التنازلي
teleprompter-countdown-secs = العد التنازلي (ثوانٍ)
teleprompter-speed = السرعة (أحرف/ث)
teleprompter-speed-bpm = السرعة (BPM)
teleprompter-bpm-mode = وضع BPM (غناء)
teleprompter-font = حجم الخط
teleprompter-mirror = انعكاس (الزجاج)
teleprompter-open-projector = فتح جهاز العرض
teleprompter-preview = معاينة
teleprompter-remote-hint = تحكّم في التمرير عبر اختصار أو MIDI أو لوحة الشبكة المحلية أثناء إغلاق هذا.
teleprompter-read-aloud = القراءة بصوت عالٍ باستخدام تركيب الكلام الخاص بنظام التشغيل
menu-tools-teleprompter = الملقّن
hotkeys-teleprompter-toggle = الملقّن: تشغيل / إيقاف مؤقت

# --- Remote guests: green room / cues / QoS / auto-grid (CAP-N54–N56, N59) ---
remote-hosting-count = استضافة { $count } ضيف
remote-green-room-default = غرفة الانتظار
remote-green-room-default-title = ينتظر الضيوف الجدد في غرفة الانتظار حتى تُدخلهم
remote-auto-grid = شبكة تلقائية
remote-auto-grid-title = إبقاء الضيوف في شبكة أثناء انضمامهم ومغادرتهم
remote-arrange-grid = ترتيب الشبكة
remote-arrange-grid-title = إعادة ترتيب الضيوف على الهواء في شبكة الآن
remote-green-room-monitor = معاينة غرفة الانتظار
remote-tech-cam-ok = كاميرا ✓
remote-tech-cam-no = لا كاميرا
remote-tech-mic-ok = ميكروفون ✓
remote-tech-mic-no = لا ميكروفون
remote-seat-on-air = أدخِل على الهواء
remote-cues-label = الإشارات
remote-cue = إشارة
remote-cue-thirty = 30 ثانية
remote-cue-wrap = اختم
remote-cue-next = دورك التالي
remote-cue-speak = ارفع صوتك
remote-qos-good = الاتصال جيد
remote-qos-fair = الاتصال متوسط
remote-qos-poor = الاتصال ضعيف
remote-green-room-guest = أنت في غرفة الانتظار — سيُدخلك المضيف على الهواء قريبًا.

# --- Hotkey audit — Phase 7 actions ---
hotkey-audit-action-telestrator-clear = أداة الرسم: مسح العلامات
hotkey-audit-action-teleprompter-toggle = الملقّن: تشغيل / إيقاف مؤقت
hotkey-audit-feature-telestrator = أداة الرسم
hotkey-audit-feature-teleprompter = الملقّن

# V1-C — Starting Soon countdown slate
sources-add-starting-soon = يبدأ قريبًا…
sources-starting-soon-title = يبدأ قريبًا
sources-starting-soon-default = يبدأ قريبًا
sources-starting-soon-message = رسالة
sources-starting-soon-minutes = دقائق
sources-starting-soon-hours = ساعات
sources-starting-soon-start-at = يبدأ في
sources-starting-soon-music = موسيقى خلفية…
sources-starting-soon-music-name = موسيقى خلفية
sources-starting-soon-background = الخلفية
sources-starting-soon-note = عد تنازلي بملء الشاشة يومض بالأحمر ويتوقف عند الصفر — امسحه وانتقل إلى مشهدك المباشر يدويًا عندما تكون جاهزًا.
sources-starting-soon-add = إضافة
sources-slate-solid = لون خالص
sources-slate-gradient = تدرّج
sources-slate-transparent = شفاف
sources-slate-image = صورة
sources-slate-file = صورة / فيديو / GIF
sources-slate-browse = استعراض…
sources-starting-soon-choose-image = اختيار صورة…
sources-slate-media-note = تُدمج الصور الثابتة هنا. لخلفية فيديو أو GIF متكررة، اختر «شفاف» واضبط خلفية المشهد (أيقونة 🖼 في شريط المشاهد) — يظهر العد التنازلي في الأعلى.
properties-timer-slate = شاشة «يبدأ قريبًا»
properties-timer-slate-off = إيقاف (نص مضمّن)
properties-timer-message = رسالة
properties-timer-slate-color = لون الشاشة
properties-timer-slate-from = من
properties-timer-slate-to = إلى
properties-timer-slate-note = الشفافية تُظهر صورة أو فيديو أو خلفية مشهد أسفل الشاشة.
...
sources-badge-browser = متصفح
sources-add-browser = المتصفح (صفحة ويب)
sources-browser-title = إضافة مصدر متصفح
sources-browser-add = إضافة مصدر المتصفح
sources-browser-url = عنوان URL للصفحة (http:// أو https://)
sources-browser-url-invalid = أدخل عنوان URL يبدأ بـ http:// أو https:// — الملفات المحلية تُشغَّل عبر مصدري الوسائط أو الصورة.
sources-browser-width = العرض (px)
sources-browser-height = الارتفاع (px)
