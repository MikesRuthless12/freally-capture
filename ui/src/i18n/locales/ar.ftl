...
hotkeys-timer-toggle-placeholder = مثل Ctrl+Shift+T
hotkeys-timer-reset = تصفير كل المؤقّتات
hotkeys-timer-reset-placeholder = مثل Ctrl+Shift+0
...
controls-rundown = جدول البرنامج
...
hotkeys-split-placeholder = مثال: Numpad1
...
hotkeys-playlist-placeholder = مثال: Ctrl+Alt+Right
...
hotkeys-replay-roll-placeholder = مثال: Ctrl+Shift+I
