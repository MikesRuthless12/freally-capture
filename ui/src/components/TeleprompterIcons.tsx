// Hand-authored inline SVG transport icons for the teleprompter (projector +
// operator modal), replacing the text glyphs. No icon library — each is a tiny
// 24×24 `currentColor` path so it inherits the button's colour and theme. Sized
// by the caller via `className` (e.g. "h-5 w-5"). This file exports only
// components (keeps react-refresh happy) and is self-contained for the standalone
// Freally Teleprompt clone.
